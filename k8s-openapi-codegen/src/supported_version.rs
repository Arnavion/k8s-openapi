...
impl SupportedVersion {
	...
	pub(crate) fn spec_url(self) -> &'static str {
		match self {
			...
			SupportedVersion::V1_25 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.25.11/api/openapi-spec/swagger.json",
			SupportedVersion::V1_26 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.26.6/api/openapi-spec/swagger.json",
			SupportedVersion::V1_27 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.27.3/api/openapi-spec/swagger.json",
		}
	}
