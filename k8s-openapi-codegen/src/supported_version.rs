...
impl SupportedVersion {
	...
	pub(crate) fn spec_url(self) -> &'static str {
		match self {
			...
			SupportedVersion::V1_24 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.24.8/api/openapi-spec/swagger.json",
			SupportedVersion::V1_25 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.25.4/api/openapi-spec/swagger.json",
		}
	}
