...
impl SupportedVersion {
	...
	pub(crate) fn spec_url(self) -> &'static str {
		match self {
			...
			SupportedVersion::V1_22 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.22.12/api/openapi-spec/swagger.json",
			SupportedVersion::V1_23 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.23.9/api/openapi-spec/swagger.json",
			SupportedVersion::V1_24 => "https://raw.githubusercontent.com/kubernetes/kubernetes/v1.24.3/api/openapi-spec/swagger.json",
		}
	}
