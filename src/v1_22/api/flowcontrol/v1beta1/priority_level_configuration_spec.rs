...
impl PriorityLevelConfigurationSpec  {
    /// Set [`Self::limited`]
    pub  fn limited_set(&mut self, limited: impl Into<Option<crate::api::flowcontrol::v1beta1::LimitedPriorityLevelConfiguration>>) -> &mut Self {
        self.limited = limited.into(); self
    }

    pub  fn limited(&mut self) -> &mut crate::api::flowcontrol::v1beta1::LimitedPriorityLevelConfiguration {
    ...
    pub  fn limited_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1beta1::LimitedPriorityLevelConfiguration)) -> &mut Self {
        if self.limited.is_none() { self.limited = Some(Default::default()) };
