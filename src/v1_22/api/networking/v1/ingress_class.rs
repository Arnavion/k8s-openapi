...
impl IngressClass  {
    ...
    /// Set [`Self::spec`]
    pub  fn spec_set(&mut self, spec: impl Into<Option<crate::api::networking::v1::IngressClassSpec>>) -> &mut Self {
        self.spec = spec.into(); self
    }

    pub  fn spec(&mut self) -> &mut crate::api::networking::v1::IngressClassSpec {
    ...
    pub  fn spec_with(&mut self, func: impl FnOnce(&mut crate::api::networking::v1::IngressClassSpec)) -> &mut Self {
        if self.spec.is_none() { self.spec = Some(Default::default()) };
