...
pub struct ControllerRevisionList {
    ...
    pub items: Vec<crate::api::apps::v1beta1::ControllerRevision>,

    /// More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<crate::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for ControllerRevisionList {
    const API_VERSION: &'static str = "apps/v1beta1";
    const GROUP: &'static str = "apps";
    const KIND: &'static str = "ControllerRevisionList";
    const VERSION: &'static str = "v1beta1";
}

impl crate::Metadata for ControllerRevisionList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::apps::v1beta1::ControllerRevision>> = None;
