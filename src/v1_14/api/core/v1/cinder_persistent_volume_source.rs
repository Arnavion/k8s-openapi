...
#[cfg(feature = "schema")]
impl crate::Schema for CinderPersistentVolumeSource {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "secretRef": crate::schema_ref_with_values(crate::api::core::v1::SecretReference::schema(), serde_json::json!({"description": "Optional: points to a secret object containing parameters used to connect to OpenStack."})),
            "volumeID": {
