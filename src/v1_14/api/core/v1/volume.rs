    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "cinder": crate::schema_ref_with_values(crate::api::core::v1::CinderVolumeSource::schema(), serde_json::json!({"description": "Cinder represents a cinder volume attached and mounted on kubelets host machine More info: https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md"})),
            ...
            "csi": crate::schema_ref_with_values(crate::api::core::v1::CSIVolumeSource::schema(), serde_json::json!({"description": "CSI (Container Storage Interface) represents storage that is handled by an external CSI driver (Alpha feature)."})),
            ...
            "glusterfs": crate::schema_ref_with_values(crate::api::core::v1::GlusterfsVolumeSource::schema(), serde_json::json!({"description": "Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md"})),
            ...
            "iscsi": crate::schema_ref_with_values(crate::api::core::v1::ISCSIVolumeSource::schema(), serde_json::json!({"description": "ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md"})),
            "name": {
            ...
            "rbd": crate::schema_ref_with_values(crate::api::core::v1::RBDVolumeSource::schema(), serde_json::json!({"description": "RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md"})),
