...
pub struct EnvVarSource {
    ...
    pub config_map_key_ref: Option<crate::v1_14::api::core::v1::ConfigMapKeySelector>,

    /// Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP.
    pub field_ref: Option<crate::v1_14::api::core::v1::ObjectFieldSelector>,

    /// Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    pub resource_field_ref: Option<crate::v1_14::api::core::v1::ResourceFieldSelector>,

    /// Selects a key of a secret in the pod's namespace
    pub secret_key_ref: Option<crate::v1_14::api::core::v1::SecretKeySelector>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_config_map_key_ref: Option<crate::v1_14::api::core::v1::ConfigMapKeySelector> = None;
                let mut value_field_ref: Option<crate::v1_14::api::core::v1::ObjectFieldSelector> = None;
                let mut value_resource_field_ref: Option<crate::v1_14::api::core::v1::ResourceFieldSelector> = None;
                let mut value_secret_key_ref: Option<crate::v1_14::api::core::v1::SecretKeySelector> = None;
