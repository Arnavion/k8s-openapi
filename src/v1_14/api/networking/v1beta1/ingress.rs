...
impl Ingress {
    ...
    pub fn create_namespaced_ingress(
        ...
        let __url = format!("/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses?", namespace = namespace);
...
impl Ingress {
    ...
    pub fn delete_namespaced_ingress(
        ...
        let __url = format!("/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(dry_run) = dry_run {
            __query_pairs.append_pair("dryRun", dry_run);
        }
...
impl Ingress {
    ...
    pub fn list_ingress_for_all_namespaces(
        ...
        let __url = "/apis/networking.k8s.io/v1beta1/ingresses?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
...
impl Ingress {
    ...
    pub fn patch_namespaced_ingress_status(
        ...
        let __url = format!("/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(dry_run) = dry_run {
            __query_pairs.append_pair("dryRun", dry_run);
        }
