...
impl RuntimeClass {
    ...
    pub fn create_runtime_class(
        ...
        let __url = "/apis/node.k8s.io/v1alpha1/runtimeclasses?".to_string();
...
/// Optional parameters of [`RuntimeClass::delete_collection_runtime_class`]
#[derive(Clone, Copy, Debug, Default)]
pub struct DeleteCollectionRuntimeClassOptional<'a> {
...
impl RuntimeClass {
    ...
    pub fn delete_runtime_class(
        ...
        let __url = format!("/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}?", name = name);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(dry_run) = dry_run {
            __query_pairs.append_pair("dryRun", dry_run);
        }
...
/// Optional parameters of [`RuntimeClass::delete_runtime_class`]
#[derive(Clone, Copy, Debug, Default)]
pub struct DeleteRuntimeClassOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
...
/// Optional parameters of [`RuntimeClass::patch_runtime_class`]
#[derive(Clone, Copy, Debug, Default)]
pub struct PatchRuntimeClassOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
