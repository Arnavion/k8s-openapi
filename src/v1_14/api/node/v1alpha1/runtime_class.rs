    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "metadata": crate::schema_ref_with_values(crate::apimachinery::pkg::apis::meta::v1::ObjectMeta::schema(), serde_json::json!({"description": "More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata"})),
            "spec": crate::schema_ref_with_values(crate::api::node::v1alpha1::RuntimeClassSpec::schema(), serde_json::json!({"description": "Specification of the RuntimeClass More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status"}))
          },
          "required": [
            "metadata",
            "spec"
