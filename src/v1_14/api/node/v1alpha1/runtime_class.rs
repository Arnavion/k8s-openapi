...
pub enum CreateRuntimeClassResponse {
    ...
    Created(crate::api::node::v1alpha1::RuntimeClass),
    Accepted(crate::api::node::v1alpha1::RuntimeClass),
...
pub enum DeleteCollectionRuntimeClassResponse {
    ...
    OkValue(crate::List<crate::api::node::v1alpha1::RuntimeClass>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteRuntimeClassResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::api::node::v1alpha1::RuntimeClass),
...
pub enum ListRuntimeClassResponse {
    Ok(crate::List<crate::api::node::v1alpha1::RuntimeClass>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
