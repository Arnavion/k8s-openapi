...
impl Lease {
    ...
    pub fn create_namespaced_lease(
        ...
        let __url = format!("/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases?", namespace = namespace);
...
impl Lease {
    ...
    pub fn delete_namespaced_lease(
        ...
        let __url = format!("/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(dry_run) = dry_run {
            __query_pairs.append_pair("dryRun", dry_run);
        }
...
impl Lease {
    ...
    pub fn list_lease_for_all_namespaces(
        ...
        let __url = "/apis/coordination.k8s.io/v1/leases?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
