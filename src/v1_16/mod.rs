...
) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<GetDiscoveryV1alpha1APIResourcesResponse>), crate::RequestError> {
    let __url = "/apis/discovery.k8s.io/v1alpha1/".to_owned();
