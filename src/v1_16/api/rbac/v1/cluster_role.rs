...
impl crate::Schema for ClusterRole {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "aggregationRule": crate::schema_ref_with_values(crate::api::rbac::v1::AggregationRule::schema(), serde_json::json!({"description": "AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller."})),
            "apiVersion": {
            ...
            "rules": {
              ...
              "items": crate::api::rbac::v1::PolicyRule::schema(),
              "type": "array"
            }
          },
          "required": [
