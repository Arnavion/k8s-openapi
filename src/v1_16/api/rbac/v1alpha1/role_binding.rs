...
#[cfg(feature = "schema")]
impl crate::Schema for RoleBinding {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "roleRef": crate::schema_ref_with_values(crate::api::rbac::v1alpha1::RoleRef::schema(), serde_json::json!({"description": "RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error."})),
            "subjects": {
              "description": "Subjects holds references to the objects the role applies to.",
              "items": crate::api::rbac::v1alpha1::Subject::schema(),
              "type": "array"
            }
          },
          "required": [
