...
pub struct RoleBinding {
    ...
    pub role_ref: crate::v1_16::api::rbac::v1beta1::RoleRef,

    /// Subjects holds references to the objects the role applies to.
    pub subjects: Option<Vec<crate::v1_16::api::rbac::v1beta1::Subject>>,
}
...
impl RoleBinding {
    ...
    pub fn create_namespaced_role_binding(
        namespace: &str,
        body: &crate::v1_16::api::rbac::v1beta1::RoleBinding,
...
pub enum CreateNamespacedRoleBindingResponse {
    Ok(crate::v1_16::api::rbac::v1beta1::RoleBinding),
    Created(crate::v1_16::api::rbac::v1beta1::RoleBinding),
    Accepted(crate::v1_16::api::rbac::v1beta1::RoleBinding),
...
pub enum DeleteCollectionNamespacedRoleBindingResponse {
    ...
    OkValue(crate::v1_16::api::rbac::v1beta1::RoleBindingList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedRoleBindingResponse {
    OkStatus(crate::v1_16::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_16::api::rbac::v1beta1::RoleBinding),
...
pub enum ListNamespacedRoleBindingResponse {
    Ok(crate::v1_16::api::rbac::v1beta1::RoleBindingList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_role_ref: Option<crate::v1_16::api::rbac::v1beta1::RoleRef> = None;
                let mut value_subjects: Option<Vec<crate::v1_16::api::rbac::v1beta1::Subject>> = None;
