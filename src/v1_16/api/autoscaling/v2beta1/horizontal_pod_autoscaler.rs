    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "metadata": crate::schema_ref_with_description(crate::apimachinery::pkg::apis::meta::v1::ObjectMeta::schema(), "metadata is the standard object metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata"),
            "spec": crate::schema_ref_with_description(crate::api::autoscaling::v2beta1::HorizontalPodAutoscalerSpec::schema(), "spec is the specification for the behaviour of the autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status."),
            "status": crate::schema_ref_with_description(crate::api::autoscaling::v2beta1::HorizontalPodAutoscalerStatus::schema(), "status is the current information about the autoscaler.")
          },
          "required": [
            "metadata"
          ],
