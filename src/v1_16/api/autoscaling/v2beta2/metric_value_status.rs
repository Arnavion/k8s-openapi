...
pub struct MetricValueStatus {
    ...
    pub value: Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity>,
}
...
impl<'de> serde::Deserialize<'de> for MetricValueStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct MetricValueStatus")
            }
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_value: Option<crate::v1_16::apimachinery::pkg::api::resource::Quantity> = None;
