...
pub enum CreateNamespacedLeaseResponse {
    ...
    Created(crate::api::coordination::v1::Lease),
    Accepted(crate::api::coordination::v1::Lease),
...
pub enum DeleteCollectionNamespacedLeaseResponse {
    ...
    OkValue(crate::List<crate::api::coordination::v1::Lease>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedLeaseResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::api::coordination::v1::Lease),
...
pub enum ListLeaseForAllNamespacesResponse {
    Ok(crate::List<crate::api::coordination::v1::Lease>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
