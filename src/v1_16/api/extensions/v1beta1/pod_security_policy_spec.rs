...
pub struct PodSecurityPolicySpec {
    ...
    pub allowed_csi_drivers: Vec<crate::api::extensions::v1beta1::AllowedCSIDriver>,
    ...
    pub runtime_class: Option<crate::api::extensions::v1beta1::RuntimeClassStrategyOptions>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_runtime_class: Option<crate::api::extensions::v1beta1::RuntimeClassStrategyOptions> = None;
        ...
        serde_json::json!({
          ...
          "properties": {
            ...
            "allowedCSIDrivers": {
              ...
              "items": crate::api::extensions::v1beta1::AllowedCSIDriver::schema(),
              "type": "array"
            },
            "allowedCapabilities": {
            ...
            "fsGroup": crate::schema_ref_with_values(crate::api::extensions::v1beta1::FSGroupStrategyOptions::schema(), serde_json::json!({"description": "fsGroup is the strategy that will dictate what fs group is used by the SecurityContext."})),
            "hostIPC": {
            ...
            "runAsGroup": crate::schema_ref_with_values(crate::api::extensions::v1beta1::RunAsGroupStrategyOptions::schema(), serde_json::json!({"description": "RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set. If this field is omitted, the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled."})),
            "runAsUser": crate::schema_ref_with_values(crate::api::extensions::v1beta1::RunAsUserStrategyOptions::schema(), serde_json::json!({"description": "runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set."})),
            "runtimeClass": crate::schema_ref_with_values(crate::api::extensions::v1beta1::RuntimeClassStrategyOptions::schema(), serde_json::json!({"description": "runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled."})),
            "seLinux": crate::schema_ref_with_values(crate::api::extensions::v1beta1::SELinuxStrategyOptions::schema(), serde_json::json!({"description": "seLinux is the strategy that will dictate the allowable labels that may be set."})),
            "supplementalGroups": crate::schema_ref_with_values(crate::api::extensions::v1beta1::SupplementalGroupsStrategyOptions::schema(), serde_json::json!({"description": "supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext."})),
            "volumes": {
