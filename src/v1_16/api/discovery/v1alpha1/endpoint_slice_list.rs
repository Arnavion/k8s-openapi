// Generated from definition io.k8s.api.discovery.v1alpha1.EndpointSliceList
...
impl crate::Resource for EndpointSliceList {
    ...
    const KIND: &'static str = "EndpointSliceList";
...
impl<'de> serde::Deserialize<'de> for EndpointSliceList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = EndpointSliceList;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct EndpointSliceList")
            }
...
impl serde::Serialize for EndpointSliceList {
