// Generated from definition io.k8s.api.scheduling.v1.PriorityClassList

/// PriorityClassList is a collection of priority classes.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct PriorityClassList {
    /// items is the list of PriorityClasses
    pub items: Vec<crate::api::scheduling::v1::PriorityClass>,
...
impl crate::Resource for PriorityClassList {
    ...
    const KIND: &'static str = "PriorityClassList";
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::scheduling::v1::PriorityClass>> = None;
