...
impl CSINodeDriver {
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "allocatable": crate::schema_ref_with_description(crate::api::storage::v1beta1::VolumeNodeResources::schema(), "allocatable represents the volume resources of a node that are available for scheduling."),
            "name": {
