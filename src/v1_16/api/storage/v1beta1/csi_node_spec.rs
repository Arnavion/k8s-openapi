...
pub struct CSINodeSpec {
    ...
    pub drivers: Vec<crate::v1_16::api::storage::v1beta1::CSINodeDriver>,
}
...
impl<'de> serde::Deserialize<'de> for CSINodeSpec {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct CSINodeSpec")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_drivers: Option<Vec<crate::v1_16::api::storage::v1beta1::CSINodeDriver>> = None;
