...
pub struct CSIDriver {
    ...
    pub spec: crate::v1_16::api::storage::v1beta1::CSIDriverSpec,
}
...
impl CSIDriver {
    ...
    pub fn create_csi_driver(
        body: &crate::v1_16::api::storage::v1beta1::CSIDriver,
...
pub enum CreateCSIDriverResponse {
    Ok(crate::v1_16::api::storage::v1beta1::CSIDriver),
    Created(crate::v1_16::api::storage::v1beta1::CSIDriver),
    Accepted(crate::v1_16::api::storage::v1beta1::CSIDriver),
...
pub enum DeleteCSIDriverResponse {
    ...
    OkValue(crate::v1_16::api::storage::v1beta1::CSIDriver),
...
pub enum DeleteCollectionCSIDriverResponse {
    OkStatus(crate::v1_16::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_16::api::storage::v1beta1::CSIDriverList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListCSIDriverResponse {
    Ok(crate::v1_16::api::storage::v1beta1::CSIDriverList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchCSIDriverResponse {
    Ok(crate::v1_16::apimachinery::pkg::apis::meta::v1::WatchEvent<CSIDriver>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_16::api::storage::v1beta1::CSIDriverSpec> = None;
