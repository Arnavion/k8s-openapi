...
pub struct CSINode {
    ...
    pub spec: crate::v1_16::api::storage::v1beta1::CSINodeSpec,
}
...
impl CSINode {
    ...
    pub fn create_csi_node(
        body: &crate::v1_16::api::storage::v1beta1::CSINode,
...
pub enum CreateCSINodeResponse {
    Ok(crate::v1_16::api::storage::v1beta1::CSINode),
    Created(crate::v1_16::api::storage::v1beta1::CSINode),
    Accepted(crate::v1_16::api::storage::v1beta1::CSINode),
...
pub enum DeleteCSINodeResponse {
    ...
    OkValue(crate::v1_16::api::storage::v1beta1::CSINode),
...
pub enum DeleteCollectionCSINodeResponse {
    OkStatus(crate::v1_16::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::v1_16::api::storage::v1beta1::CSINodeList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListCSINodeResponse {
    Ok(crate::v1_16::api::storage::v1beta1::CSINodeList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum WatchCSINodeResponse {
    Ok(crate::v1_16::apimachinery::pkg::apis::meta::v1::WatchEvent<CSINode>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_16::api::storage::v1beta1::CSINodeSpec> = None;
