// Generated from definition io.k8s.api.storage.v1.VolumeAttachmentList

/// VolumeAttachmentList is a collection of VolumeAttachment objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct VolumeAttachmentList {
    /// Items is the list of VolumeAttachments
    pub items: Vec<crate::api::storage::v1::VolumeAttachment>,

    /// Standard list metadata More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    pub metadata: Option<crate::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for VolumeAttachmentList {
    const API_VERSION: &'static str = "storage.k8s.io/v1";
    const GROUP: &'static str = "storage.k8s.io";
    const KIND: &'static str = "VolumeAttachmentList";
    const VERSION: &'static str = "v1";
}

impl crate::Metadata for VolumeAttachmentList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::storage::v1::VolumeAttachment>> = None;
