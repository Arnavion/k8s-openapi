...
pub struct Lifecycle {
    ...
    pub post_start: Option<crate::v1_16::api::core::v1::Handler>,
    ...
    pub pre_stop: Option<crate::v1_16::api::core::v1::Handler>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_post_start: Option<crate::v1_16::api::core::v1::Handler> = None;
                let mut value_pre_stop: Option<crate::v1_16::api::core::v1::Handler> = None;
