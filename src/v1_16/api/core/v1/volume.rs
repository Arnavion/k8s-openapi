...
pub struct Volume {
    ...
    pub azure_file: Option<crate::v1_16::api::core::v1::AzureFileVolumeSource>,

    /// CephFS represents a Ceph FS mount on the host that shares a pod's lifetime
    pub cephfs: Option<crate::v1_16::api::core::v1::CephFSVolumeSource>,

    /// Cinder represents a cinder volume attached and mounted on kubelets host machine. More info: https://examples.k8s.io/mysql-cinder-pd/README.md
    pub cinder: Option<crate::v1_16::api::core::v1::CinderVolumeSource>,

    /// ConfigMap represents a configMap that should populate this volume
    pub config_map: Option<crate::v1_16::api::core::v1::ConfigMapVolumeSource>,

    /// CSI (Container Storage Interface) represents storage that is handled by an external CSI driver (Alpha feature).
    pub csi: Option<crate::v1_16::api::core::v1::CSIVolumeSource>,

    /// DownwardAPI represents downward API about the pod that should populate this volume
    pub downward_api: Option<crate::v1_16::api::core::v1::DownwardAPIVolumeSource>,

    /// EmptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir
    pub empty_dir: Option<crate::v1_16::api::core::v1::EmptyDirVolumeSource>,

    /// FC represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.
    pub fc: Option<crate::v1_16::api::core::v1::FCVolumeSource>,

    /// FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin.
    pub flex_volume: Option<crate::v1_16::api::core::v1::FlexVolumeSource>,
    ...
    pub git_repo: Option<crate::v1_16::api::core::v1::GitRepoVolumeSource>,

    /// Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: https://examples.k8s.io/volumes/glusterfs/README.md
    pub glusterfs: Option<crate::v1_16::api::core::v1::GlusterfsVolumeSource>,
    ...
    pub iscsi: Option<crate::v1_16::api::core::v1::ISCSIVolumeSource>,
    ...
    pub persistent_volume_claim: Option<crate::v1_16::api::core::v1::PersistentVolumeClaimVolumeSource>,
    ...
    pub projected: Option<crate::v1_16::api::core::v1::ProjectedVolumeSource>,

    /// Quobyte represents a Quobyte mount on the host that shares a pod's lifetime
    pub quobyte: Option<crate::v1_16::api::core::v1::QuobyteVolumeSource>,

    /// RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: https://examples.k8s.io/volumes/rbd/README.md
    pub rbd: Option<crate::v1_16::api::core::v1::RBDVolumeSource>,

    /// ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes.
    pub scale_io: Option<crate::v1_16::api::core::v1::ScaleIOVolumeSource>,

    /// Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
    pub secret: Option<crate::v1_16::api::core::v1::SecretVolumeSource>,

    /// StorageOS represents a StorageOS volume attached and mounted on Kubernetes nodes.
    pub storageos: Option<crate::v1_16::api::core::v1::StorageOSVolumeSource>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_azure_file: Option<crate::v1_16::api::core::v1::AzureFileVolumeSource> = None;
                let mut value_cephfs: Option<crate::v1_16::api::core::v1::CephFSVolumeSource> = None;
                let mut value_cinder: Option<crate::v1_16::api::core::v1::CinderVolumeSource> = None;
                let mut value_config_map: Option<crate::v1_16::api::core::v1::ConfigMapVolumeSource> = None;
                let mut value_csi: Option<crate::v1_16::api::core::v1::CSIVolumeSource> = None;
                let mut value_downward_api: Option<crate::v1_16::api::core::v1::DownwardAPIVolumeSource> = None;
                let mut value_empty_dir: Option<crate::v1_16::api::core::v1::EmptyDirVolumeSource> = None;
                let mut value_fc: Option<crate::v1_16::api::core::v1::FCVolumeSource> = None;
                let mut value_flex_volume: Option<crate::v1_16::api::core::v1::FlexVolumeSource> = None;
                ...
                let mut value_git_repo: Option<crate::v1_16::api::core::v1::GitRepoVolumeSource> = None;
                let mut value_glusterfs: Option<crate::v1_16::api::core::v1::GlusterfsVolumeSource> = None;
                let mut value_host_path: Option<crate::v1_16::api::core::v1::HostPathVolumeSource> = None;
                let mut value_iscsi: Option<crate::v1_16::api::core::v1::ISCSIVolumeSource> = None;
                let mut value_name: Option<String> = None;
                let mut value_nfs: Option<crate::v1_16::api::core::v1::NFSVolumeSource> = None;
                let mut value_persistent_volume_claim: Option<crate::v1_16::api::core::v1::PersistentVolumeClaimVolumeSource> = None;
                ...
                let mut value_projected: Option<crate::v1_16::api::core::v1::ProjectedVolumeSource> = None;
                let mut value_quobyte: Option<crate::v1_16::api::core::v1::QuobyteVolumeSource> = None;
                let mut value_rbd: Option<crate::v1_16::api::core::v1::RBDVolumeSource> = None;
                let mut value_scale_io: Option<crate::v1_16::api::core::v1::ScaleIOVolumeSource> = None;
                let mut value_secret: Option<crate::v1_16::api::core::v1::SecretVolumeSource> = None;
                let mut value_storageos: Option<crate::v1_16::api::core::v1::StorageOSVolumeSource> = None;
