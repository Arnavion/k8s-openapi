...
pub struct ContainerStatus {
    ...
    pub last_state: Option<crate::v1_16::api::core::v1::ContainerState>,
    ...
    pub state: Option<crate::v1_16::api::core::v1::ContainerState>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_last_state: Option<crate::v1_16::api::core::v1::ContainerState> = None;
                ...
                let mut value_state: Option<crate::v1_16::api::core::v1::ContainerState> = None;
...
impl serde::Serialize for ContainerStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.started {
            serde::ser::SerializeStruct::serialize_field(&mut state, "started", value)?;
        }
