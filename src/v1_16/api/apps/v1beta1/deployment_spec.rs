...
pub struct DeploymentSpec {
    ...
    pub rollback_to: Option<crate::v1_16::api::apps::v1beta1::RollbackConfig>,

    /// Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment.
    pub selector: Option<crate::v1_16::apimachinery::pkg::apis::meta::v1::LabelSelector>,

    /// The deployment strategy to use to replace existing pods with new ones.
    pub strategy: Option<crate::v1_16::api::apps::v1beta1::DeploymentStrategy>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_strategy: Option<crate::v1_16::api::apps::v1beta1::DeploymentStrategy> = None;
