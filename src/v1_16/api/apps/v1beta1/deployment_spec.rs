...
pub struct DeploymentSpec {
    ...
    pub rollback_to: Option<crate::api::apps::v1beta1::RollbackConfig>,

    /// Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment.
    pub selector: Option<crate::apimachinery::pkg::apis::meta::v1::LabelSelector>,

    /// The deployment strategy to use to replace existing pods with new ones.
    pub strategy: Option<crate::api::apps::v1beta1::DeploymentStrategy>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_strategy: Option<crate::api::apps::v1beta1::DeploymentStrategy> = None;
    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "rollbackTo": crate::schema_ref_with_values(crate::api::apps::v1beta1::RollbackConfig::schema(), serde_json::json!({"description": "DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done."})),
            ...
            "strategy": crate::schema_ref_with_values(crate::api::apps::v1beta1::DeploymentStrategy::schema(), serde_json::json!({"description": "The deployment strategy to use to replace existing pods with new ones.", "x-kubernetes-patch-strategy": "retainKeys"})),
