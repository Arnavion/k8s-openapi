...
pub enum CreateNamespacedStatefulSetResponse {
    ...
    Created(crate::api::apps::v1::StatefulSet),
    Accepted(crate::api::apps::v1::StatefulSet),
...
pub enum DeleteCollectionNamespacedStatefulSetResponse {
    ...
    OkValue(crate::List<crate::api::apps::v1::StatefulSet>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedStatefulSetResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::api::apps::v1::StatefulSet),
...
pub enum ListNamespacedStatefulSetResponse {
    Ok(crate::List<crate::api::apps::v1::StatefulSet>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
