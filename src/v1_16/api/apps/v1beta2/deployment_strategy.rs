...
impl crate::Schema for DeploymentStrategy {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "rollingUpdate": crate::schema_ref_with_description(crate::api::apps::v1beta2::RollingUpdateDeployment::schema(), "Rolling update config params. Present only if DeploymentStrategyType = RollingUpdate."),
            "type": {
