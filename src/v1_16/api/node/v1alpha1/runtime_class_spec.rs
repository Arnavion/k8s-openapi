...
pub struct RuntimeClassSpec {
    ...
    pub overhead: Option<crate::v1_16::api::node::v1alpha1::Overhead>,
    ...
    pub scheduling: Option<crate::v1_16::api::node::v1alpha1::Scheduling>,
}
...
impl<'de> serde::Deserialize<'de> for RuntimeClassSpec {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct RuntimeClassSpec")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_overhead: Option<crate::v1_16::api::node::v1alpha1::Overhead> = None;
                let mut value_runtime_handler: Option<String> = None;
                let mut value_scheduling: Option<crate::v1_16::api::node::v1alpha1::Scheduling> = None;
