// Generated from definition io.k8s.api.node.v1alpha1.RuntimeClassList

/// RuntimeClassList is a list of RuntimeClass objects.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct RuntimeClassList {
    /// Items is a list of schema objects.
    pub items: Vec<crate::api::node::v1alpha1::RuntimeClass>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    pub metadata: Option<crate::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for RuntimeClassList {
    const API_VERSION: &'static str = "node.k8s.io/v1alpha1";
    const GROUP: &'static str = "node.k8s.io";
    const KIND: &'static str = "RuntimeClassList";
    const VERSION: &'static str = "v1alpha1";
}

impl crate::Metadata for RuntimeClassList {
...
impl<'de> serde::Deserialize<'de> for RuntimeClassList {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            type Value = RuntimeClassList;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct RuntimeClassList")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::node::v1alpha1::RuntimeClass>> = None;
...
impl serde::Serialize for RuntimeClassList {
