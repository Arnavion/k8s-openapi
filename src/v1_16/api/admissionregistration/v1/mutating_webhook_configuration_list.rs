// Generated from definition io.k8s.api.admissionregistration.v1.MutatingWebhookConfigurationList

/// MutatingWebhookConfigurationList is a list of MutatingWebhookConfiguration.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct MutatingWebhookConfigurationList {
    /// List of MutatingWebhookConfiguration.
    pub items: Vec<crate::api::admissionregistration::v1::MutatingWebhookConfiguration>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    pub metadata: Option<crate::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for MutatingWebhookConfigurationList {
    const API_VERSION: &'static str = "admissionregistration.k8s.io/v1";
    const GROUP: &'static str = "admissionregistration.k8s.io";
    const KIND: &'static str = "MutatingWebhookConfigurationList";
    const VERSION: &'static str = "v1";
}

impl crate::Metadata for MutatingWebhookConfigurationList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::admissionregistration::v1::MutatingWebhookConfiguration>> = None;
