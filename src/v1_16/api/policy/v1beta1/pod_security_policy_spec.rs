...
pub struct PodSecurityPolicySpec {
    ...
    pub allowed_csi_drivers: Option<Vec<crate::v1_16::api::policy::v1beta1::AllowedCSIDriver>>,

    /// allowedCapabilities is a list of capabilities that can be requested to add to the container. Capabilities in this field may be added at the pod author's discretion. You must not list a capability in both allowedCapabilities and requiredDropCapabilities.
    pub allowed_capabilities: Option<Vec<String>>,

    /// allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the "volumes" field.
    pub allowed_flex_volumes: Option<Vec<crate::v1_16::api::policy::v1beta1::AllowedFlexVolume>>,

    /// allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.
    pub allowed_host_paths: Option<Vec<crate::v1_16::api::policy::v1beta1::AllowedHostPath>>,
    ...
    pub fs_group: crate::v1_16::api::policy::v1beta1::FSGroupStrategyOptions,
    ...
    pub host_ports: Option<Vec<crate::v1_16::api::policy::v1beta1::HostPortRange>>,
    ...
    pub run_as_group: Option<crate::v1_16::api::policy::v1beta1::RunAsGroupStrategyOptions>,

    /// runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
    pub run_as_user: crate::v1_16::api::policy::v1beta1::RunAsUserStrategyOptions,

    /// runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled.
    pub runtime_class: Option<crate::v1_16::api::policy::v1beta1::RuntimeClassStrategyOptions>,

    /// seLinux is the strategy that will dictate the allowable labels that may be set.
    pub se_linux: crate::v1_16::api::policy::v1beta1::SELinuxStrategyOptions,

    /// supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
    pub supplemental_groups: crate::v1_16::api::policy::v1beta1::SupplementalGroupsStrategyOptions,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_allowed_csi_drivers: Option<Vec<crate::v1_16::api::policy::v1beta1::AllowedCSIDriver>> = None;
                let mut value_allowed_capabilities: Option<Vec<String>> = None;
                let mut value_allowed_flex_volumes: Option<Vec<crate::v1_16::api::policy::v1beta1::AllowedFlexVolume>> = None;
                let mut value_allowed_host_paths: Option<Vec<crate::v1_16::api::policy::v1beta1::AllowedHostPath>> = None;
                ...
                let mut value_fs_group: Option<crate::v1_16::api::policy::v1beta1::FSGroupStrategyOptions> = None;
                ...
                let mut value_host_ports: Option<Vec<crate::v1_16::api::policy::v1beta1::HostPortRange>> = None;
                ...
                let mut value_run_as_group: Option<crate::v1_16::api::policy::v1beta1::RunAsGroupStrategyOptions> = None;
                let mut value_run_as_user: Option<crate::v1_16::api::policy::v1beta1::RunAsUserStrategyOptions> = None;
                let mut value_runtime_class: Option<crate::v1_16::api::policy::v1beta1::RuntimeClassStrategyOptions> = None;
                let mut value_se_linux: Option<crate::v1_16::api::policy::v1beta1::SELinuxStrategyOptions> = None;
                let mut value_supplemental_groups: Option<crate::v1_16::api::policy::v1beta1::SupplementalGroupsStrategyOptions> = None;
