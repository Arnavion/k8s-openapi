...
impl CustomResourceValidation {
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "openAPIV3Schema": crate::schema_ref_with_description(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaProps::schema(), "openAPIV3Schema is the OpenAPI v3 schema to use for validation and pruning.")
          },
          "type": "object"
        })
    }
