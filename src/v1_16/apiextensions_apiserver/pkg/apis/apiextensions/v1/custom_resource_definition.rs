...
pub enum DeleteCollectionCustomResourceDefinitionResponse {
    ...
    OkValue(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListCustomResourceDefinitionResponse {
    Ok(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionList),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
