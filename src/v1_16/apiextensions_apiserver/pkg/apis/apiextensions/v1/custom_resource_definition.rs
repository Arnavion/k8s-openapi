...
pub enum CreateCustomResourceDefinitionResponse {
    ...
    Created(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinition),
    Accepted(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinition),
...
pub enum DeleteCollectionCustomResourceDefinitionResponse {
    ...
    OkValue(crate::List<crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinition>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteCustomResourceDefinitionResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinition),
...
pub enum ListCustomResourceDefinitionResponse {
    Ok(crate::List<crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinition>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
