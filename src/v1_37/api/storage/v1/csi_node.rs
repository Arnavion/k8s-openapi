...
pub struct CSINode {
    ...
    pub status: Option<crate::api::storage::v1::CSINodeStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_status: Option<crate::api::storage::v1::CSINodeStatus> = None;
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "metadata is the standard object metadata. metadata.name must be the Kubernetes node name.".into());
                    schema_obj
                }),
                "spec": ({
                ...
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::storage::v1::CSINodeStatus>();
                    schema_obj.ensure_object().insert("description".into(), "status contains health and status information for the node's storage.".into());
                    schema_obj
                }),
            },
            "required": [
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "metadata".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("metadata is the standard object metadata. metadata.name must be the Kubernetes node name.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::storage::v1::CSINodeStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("status contains health and status information for the node's storage.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
