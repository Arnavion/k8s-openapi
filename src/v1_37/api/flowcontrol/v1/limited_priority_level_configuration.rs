...
pub struct LimitedPriorityLevelConfiguration {
    ...
    pub limit_response: crate::api::flowcontrol::v1::LimitResponse,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                Ok(LimitedPriorityLevelConfiguration {
                    ...
                    limit_response: value_limit_response.unwrap_or_default(),
...
impl crate::serde::Serialize for LimitedPriorityLevelConfiguration {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "limitResponse", &self.limit_response)?;
