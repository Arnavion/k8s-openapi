// Generated from definition io.k8s.api.lifecycle.v1alpha1.EvictionRequestPodReference

/// EvictionRequestPodReference contains enough information to locate the referenced pod inside the same namespace.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct EvictionRequestPodReference {
...
impl crate::DeepMerge for EvictionRequestPodReference {
...
impl<'de> crate::serde::Deserialize<'de> for EvictionRequestPodReference {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = EvictionRequestPodReference;

            fn expecting(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                f.write_str("EvictionRequestPodReference")
            }
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                Ok(EvictionRequestPodReference {
...
impl crate::serde::Serialize for EvictionRequestPodReference {
...
impl crate::schemars::JsonSchema for EvictionRequestPodReference {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.lifecycle.v1alpha1.EvictionRequestPodReference".into()
    }
...
impl crate::schemars08::JsonSchema for EvictionRequestPodReference {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("EvictionRequestPodReference contains enough information to locate the referenced pod inside the same namespace.".into()),
                ..Default::default()
            })),
