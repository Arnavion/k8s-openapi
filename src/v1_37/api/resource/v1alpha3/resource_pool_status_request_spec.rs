...
pub struct ResourcePoolStatusRequestSpec {
    ...
    pub default_partition_type_attribute: Option<std::string::String>,
...
impl crate::DeepMerge for ResourcePoolStatusRequestSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.default_partition_type_attribute, other.default_partition_type_attribute);
...
impl<'de> crate::serde::Deserialize<'de> for ResourcePoolStatusRequestSpec {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        enum Field {
            Key_default_partition_type_attribute,
            Key_driver,
            Key_limit,
            Key_pool_name,
            Other,
            ...
            fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            "defaultPartitionTypeAttribute" => Field::Key_default_partition_type_attribute,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_default_partition_type_attribute: Option<std::string::String> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_default_partition_type_attribute => value_default_partition_type_attribute = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(ResourcePoolStatusRequestSpec {
                    default_partition_type_attribute: value_default_partition_type_attribute,
...
impl crate::serde::Serialize for ResourcePoolStatusRequestSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            "ResourcePoolStatusRequestSpec",
            1 +
            self.default_partition_type_attribute.as_ref().map_or(0, |_| 1) +
            self.limit.as_ref().map_or(0, |_| 1) +
            self.pool_name.as_ref().map_or(0, |_| 1),
        )?;
        if let Some(value) = &self.default_partition_type_attribute {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "defaultPartitionTypeAttribute", value)?;
        }
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "defaultPartitionTypeAttribute".into(),
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("DefaultPartitionTypeAttribute optionally names a device attribute (by its fully qualified name, e.g. \"gpu.example.com/profile\") to use as the default grouping attribute for partitionable devices whose slice has not declared one themselves.\n\nA slice's own PartitionTypeAttribute always takes precedence. This default applies only to devices whose slice does not declare one, so that a request can still get an accurate partitionSummary from a driver that has not been updated to declare it. When neither the slice nor this default names an attribute, a partitionable pool reports no partitionSummary.\n\nMust include the domain qualifier.".into()),
                                ..Default::default()
                            })),
