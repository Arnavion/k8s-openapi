...
pub struct PoolStatus {
    ...
    pub partition_summary: Option<std::vec::Vec<crate::api::resource::v1alpha3::PartitionTypeStatus>>,
    ...
    pub shareable_summary: Option<crate::api::resource::v1alpha3::ShareableSummaryStatus>,
...
impl crate::DeepMerge for PoolStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::list::atomic(&mut self.partition_summary, other.partition_summary);
        ...
        crate::DeepMerge::merge_from(&mut self.shareable_summary, other.shareable_summary);
...
impl<'de> crate::serde::Deserialize<'de> for PoolStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        enum Field {
            ...
            Key_generation,
            Key_node_name,
            Key_partition_summary,
            Key_pool_name,
            Key_resource_slice_count,
            Key_shareable_summary,
            Key_total_devices,
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "partitionSummary" => Field::Key_partition_summary,
                            "poolName" => Field::Key_pool_name,
                            "resourceSliceCount" => Field::Key_resource_slice_count,
                            "shareableSummary" => Field::Key_shareable_summary,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_partition_summary: Option<std::vec::Vec<crate::api::resource::v1alpha3::PartitionTypeStatus>> = None;
                let mut value_pool_name: Option<std::string::String> = None;
                let mut value_resource_slice_count: Option<i32> = None;
                let mut value_shareable_summary: Option<crate::api::resource::v1alpha3::ShareableSummaryStatus> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_partition_summary => value_partition_summary = crate::serde::de::MapAccess::next_value(&mut map)?,
                        ...
                        Field::Key_shareable_summary => value_shareable_summary = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for PoolStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.partition_summary.as_ref().map_or(0, |_| 1) +
            self.resource_slice_count.as_ref().map_or(0, |_| 1) +
            self.shareable_summary.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.partition_summary {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "partitionSummary", value)?;
        }
        ...
        if let Some(value) = &self.shareable_summary {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "shareableSummary", value)?;
        }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "partitionSummary": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::resource::v1alpha3::PartitionTypeStatus>()),
                },
                "poolName": {
                ...
                "shareableSummary": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ShareableSummaryStatus>();
                    schema_obj.ensure_object().insert("description".into(), "ShareableSummary reports aggregate capacity for a pool that contains devices with AllowMultipleAllocations. It is populated only when at least one device in the pool is shareable.".into());
                    schema_obj
                }),
                "totalDevices": {
        ...
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "partitionSummary".into(),
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("PartitionSummary reports allocatability per (attribute, partition type) for a partitionable pool that publishes SharedCounters. Each entry names the grouping attribute it was resolved from: the PartitionTypeAttribute declared by a device's own slice, or for devices whose slice declares none, the default named in the request. A pool that mixes partitions declared under different attributes reports each independently. When no slice declares an attribute and the request names no default, the pool reports no partition summary.".into()),
                                ..Default::default()
                            })),
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1alpha3::PartitionTypeStatus>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        "shareableSummary".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha3::ShareableSummaryStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("ShareableSummary reports aggregate capacity for a pool that contains devices with AllowMultipleAllocations. It is populated only when at least one device in the pool is shareable.".into()),
                                ..Default::default()
                            }));
