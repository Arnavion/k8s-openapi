...
pub struct Device {
    ...
    pub node_allocatable_resources: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::NodeAllocatableResource>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_node_allocatable_resources: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1::NodeAllocatableResource>> = None;
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "nodeAllocatableResources": {
                    ...
                    "type": "object",
                    "additionalProperties": (__gen.subschema_for::<crate::api::resource::v1::NodeAllocatableResource>()),
                },
                "nodeName": {
                ...
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Object))),
                            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                                additional_properties: Some(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1::NodeAllocatableResource>())),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
