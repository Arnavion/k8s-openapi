// Generated from definition io.k8s.api.resource.v1.NodeAllocatableResource
...
pub struct NodeAllocatableResource {
    ...
    pub mapping: Option<crate::api::resource::v1::NodeAllocatableMapping>,
    ...
    pub overhead: Option<crate::api::resource::v1::NodeAllocatableOverhead>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_mapping: Option<crate::api::resource::v1::NodeAllocatableMapping> = None;
                let mut value_overhead: Option<crate::api::resource::v1::NodeAllocatableOverhead> = None;
...
impl crate::schemars::JsonSchema for NodeAllocatableResource {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.resource.v1.NodeAllocatableResource".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "mapping": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::NodeAllocatableMapping>();
                ...
                "overhead": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::NodeAllocatableOverhead>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "mapping".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::NodeAllocatableMapping>().into_object();
                    ...
                    (
                        "overhead".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1::NodeAllocatableOverhead>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
