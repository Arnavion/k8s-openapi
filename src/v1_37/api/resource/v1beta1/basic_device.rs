...
pub struct BasicDevice {
    ...
    pub node_allocatable_resources: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1beta1::NodeAllocatableResource>>,
...
impl crate::DeepMerge for BasicDevice {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::map::granular(&mut self.node_allocatable_resources, other.node_allocatable_resources, |current_item, other_item| {
            crate::DeepMerge::merge_from(current_item, other_item);
        });
...
impl<'de> crate::serde::Deserialize<'de> for BasicDevice {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        enum Field {
            ...
            Key_node_allocatable_resources,
            Key_node_name,
            Key_node_selector,
            Key_taints,
            Other,
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "nodeAllocatableResources" => Field::Key_node_allocatable_resources,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_node_allocatable_resources: Option<std::collections::BTreeMap<std::string::String, crate::api::resource::v1beta1::NodeAllocatableResource>> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_node_allocatable_resources => value_node_allocatable_resources = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(BasicDevice {
                    ...
                    node_allocatable_resources: value_node_allocatable_resources,
...
impl crate::serde::Serialize for BasicDevice {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.node_allocatable_resources.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.node_allocatable_resources {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nodeAllocatableResources", value)?;
        }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "nodeAllocatableResources": {
                    ...
                    "type": "object",
                    "additionalProperties": (__gen.subschema_for::<crate::api::resource::v1beta1::NodeAllocatableResource>()),
                },
                "nodeName": {
        ...
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "nodeAllocatableResources".into(),
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("NodeAllocatableResources defines the mapping of node resources that are managed by the DRA driver exposing this device. This includes resources currently reported in v1.Node `status.allocatable` that are not extended resources (see https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#extended-resources). Examples include \"cpu\", \"memory\", \"ephemeral-storage\", and hugepages. In addition to standard requests made through the Pod `spec`, these resources can also be requested through claims and allocated by the DRA driver. For example, a CPU DRA driver might allocate exclusive CPUs or auxiliary node memory dependencies of an accelerator device. The keys of this map are the node-allocatable resource names (e.g., \"cpu\", \"memory\"). Extended resource names are not permitted as keys.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Object))),
                            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                                additional_properties: Some(std::boxed::Box::new(__gen.subschema_for::<crate::api::resource::v1beta1::NodeAllocatableResource>())),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
