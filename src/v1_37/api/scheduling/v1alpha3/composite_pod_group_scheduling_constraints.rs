// Generated from definition io.k8s.api.scheduling.v1alpha3.CompositePodGroupSchedulingConstraints
...
impl crate::schemars::JsonSchema for CompositePodGroupSchedulingConstraints {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.CompositePodGroupSchedulingConstraints".into()
    }
