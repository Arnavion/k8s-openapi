// Generated from definition io.k8s.api.scheduling.v1alpha3.PodGroupTemplate
...
pub struct PodGroupTemplate {
    ...
    pub disruption_mode: Option<crate::api::scheduling::v1alpha3::DisruptionMode>,
    ...
    pub resource_claims: Option<std::vec::Vec<crate::api::scheduling::v1alpha3::PodGroupResourceClaim>>,
    ...
    pub scheduling_constraints: Option<crate::api::scheduling::v1alpha3::PodGroupSchedulingConstraints>,

    /// schedulingPolicy defines the scheduling policy for this PodGroupTemplate.
    pub scheduling_policy: crate::api::scheduling::v1alpha3::PodGroupSchedulingPolicy,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_disruption_mode: Option<crate::api::scheduling::v1alpha3::DisruptionMode> = None;
                ...
                let mut value_resource_claims: Option<std::vec::Vec<crate::api::scheduling::v1alpha3::PodGroupResourceClaim>> = None;
                let mut value_scheduling_constraints: Option<crate::api::scheduling::v1alpha3::PodGroupSchedulingConstraints> = None;
                let mut value_scheduling_policy: Option<crate::api::scheduling::v1alpha3::PodGroupSchedulingPolicy> = None;
...
impl crate::schemars::JsonSchema for PodGroupTemplate {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.PodGroupTemplate".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "disruptionMode": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::DisruptionMode>();
                    schema_obj.ensure_object().insert("description".into(), "disruptionMode defines the mode in which a given PodGroup can be disrupted. One of Single, All. This field is immutable.".into());
                    schema_obj
                }),
                "name": {
                ...
                "resourceClaims": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupResourceClaim>()),
                },
                "schedulingConstraints": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupSchedulingConstraints>();
                    schema_obj.ensure_object().insert("description".into(), "schedulingConstraints defines optional scheduling constraints (e.g. topology) for this PodGroupTemplate. This field is only available when the TopologyAwareWorkloadScheduling feature gate is enabled. This field is immutable.".into());
                    schema_obj
                }),
                "schedulingPolicy": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupSchedulingPolicy>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "disruptionMode".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::DisruptionMode>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("disruptionMode defines the mode in which a given PodGroup can be disrupted. One of Single, All. This field is immutable.".into()),
                                ..Default::default()
                            }));
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("priority is the value of priority of pod groups created from this template. Various system components use this field to find the priority of the pod group. The higher the value, the higher the priority. This field is immutable.".into()),
                                ..Default::default()
                            })),
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("priorityClassName indicates the priority that should be considered when scheduling a pod group created from this template. This field is immutable.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::String))),
                            ..Default::default()
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupResourceClaim>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
                    ...
                    (
                        ...
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupSchedulingConstraints>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("schedulingConstraints defines optional scheduling constraints (e.g. topology) for this PodGroupTemplate. This field is only available when the TopologyAwareWorkloadScheduling feature gate is enabled. This field is immutable.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        ...
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupSchedulingPolicy>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
