// Generated from definition io.k8s.api.scheduling.v1alpha3.CompositePodGroupSchedulingPolicy
...
pub struct CompositePodGroupSchedulingPolicy {
    ...
    pub basic: Option<crate::api::scheduling::v1alpha3::CompositeBasicSchedulingPolicy>,

    /// gang specifies that the groups of this composite group should be scheduled using all-or-nothing semantics.
    pub gang: Option<crate::api::scheduling::v1alpha3::CompositeGangSchedulingPolicy>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_basic: Option<crate::api::scheduling::v1alpha3::CompositeBasicSchedulingPolicy> = None;
                let mut value_gang: Option<crate::api::scheduling::v1alpha3::CompositeGangSchedulingPolicy> = None;
...
impl crate::schemars::JsonSchema for CompositePodGroupSchedulingPolicy {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.CompositePodGroupSchedulingPolicy".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "basic": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositeBasicSchedulingPolicy>();
                ...
                "gang": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositeGangSchedulingPolicy>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "basic".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositeBasicSchedulingPolicy>().into_object();
                    ...
                    (
                        "gang".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositeGangSchedulingPolicy>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
