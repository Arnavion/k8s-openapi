// Generated from definition io.k8s.api.scheduling.v1alpha3.PodGroupSpec
...
pub struct PodGroupSpec {
    ...
    pub workload_ref: Option<crate::api::scheduling::v1alpha3::WorkloadReference>,
}
...
impl crate::schemars::JsonSchema for PodGroupSpec {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.PodGroupSpec".into()
    }
