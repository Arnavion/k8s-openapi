// Generated from definition io.k8s.api.scheduling.v1alpha3.PodGroup
...
pub struct PodGroup {
    ...
    pub spec: crate::api::scheduling::v1alpha3::PodGroupSpec,

    /// status represents the current observed state of the PodGroup.
    pub status: Option<crate::api::scheduling::v1alpha3::PodGroupStatus>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::scheduling::v1alpha3::PodGroupSpec> = None;
                let mut value_status: Option<crate::api::scheduling::v1alpha3::PodGroupStatus> = None;
...
impl crate::schemars::JsonSchema for PodGroup {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.PodGroup".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupSpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec defines the desired state of the PodGroup.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupStatus>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::PodGroupStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
