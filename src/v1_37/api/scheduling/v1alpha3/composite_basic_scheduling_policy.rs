// Generated from definition io.k8s.api.scheduling.v1alpha3.CompositeBasicSchedulingPolicy
...
impl crate::schemars::JsonSchema for CompositeBasicSchedulingPolicy {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.CompositeBasicSchedulingPolicy".into()
    }
