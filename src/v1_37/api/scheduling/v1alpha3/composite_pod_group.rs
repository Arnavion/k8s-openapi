// Generated from definition io.k8s.api.scheduling.v1alpha3.CompositePodGroup
...
pub struct CompositePodGroup {
    /// metadata is the standard object metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    pub metadata: crate::apimachinery::pkg::apis::meta::v1::ObjectMeta,

    /// spec defines the desired state of the CompositePodGroup.
    pub spec: crate::api::scheduling::v1alpha3::CompositePodGroupSpec,

    /// status represents the current observed state of the CompositePodGroup.
    pub status: Option<crate::api::scheduling::v1alpha3::CompositePodGroupStatus>,
}

impl crate::Resource for CompositePodGroup {
    const API_VERSION: &'static str = "scheduling.k8s.io/v1alpha3";
    const GROUP: &'static str = "scheduling.k8s.io";
    const KIND: &'static str = "CompositePodGroup";
    const VERSION: &'static str = "v1alpha3";
    const URL_PATH_SEGMENT: &'static str = "compositepodgroups";
    type Scope = crate::NamespaceResourceScope;
}

impl crate::ListableResource for CompositePodGroup {
    const LIST_KIND: &'static str = "CompositePodGroupList";
}

impl crate::Metadata for CompositePodGroup {
...
impl crate::DeepMerge for CompositePodGroup {
...
impl<'de> crate::serde::Deserialize<'de> for CompositePodGroup {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::scheduling::v1alpha3::CompositePodGroupSpec> = None;
                let mut value_status: Option<crate::api::scheduling::v1alpha3::CompositePodGroupStatus> = None;
...
impl crate::serde::Serialize for CompositePodGroup {
...
impl crate::schemars::JsonSchema for CompositePodGroup {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.CompositePodGroup".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "spec": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositePodGroupSpec>();
                    schema_obj.ensure_object().insert("description".into(), "spec defines the desired state of the CompositePodGroup.".into());
                    schema_obj
                }),
                "status": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositePodGroupStatus>();
                    schema_obj.ensure_object().insert("description".into(), "status represents the current observed state of the CompositePodGroup.".into());
                    schema_obj
                }),
            },
            "required": [
...
impl crate::schemars08::JsonSchema for CompositePodGroup {
    ...
    fn json_schema(__gen: &mut crate::schemars08::gen::SchemaGenerator) -> crate::schemars08::schema::Schema {
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                description: Some("CompositePodGroup represents a runtime instance of pod groups grouped together. CompositePodGroups are created by workload controllers (LWS, JobSet, etc...) from Workload.compositePodGroupTemplates. CompositePodGroup API enablement is toggled by the CompositePodGroup feature gate.".into()),
                ..Default::default()
            })),
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositePodGroupSpec>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("spec defines the desired state of the CompositePodGroup.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1alpha3::CompositePodGroupStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("status represents the current observed state of the CompositePodGroup.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
