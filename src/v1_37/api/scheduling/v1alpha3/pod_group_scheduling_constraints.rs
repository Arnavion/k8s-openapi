// Generated from definition io.k8s.api.scheduling.v1alpha3.PodGroupSchedulingConstraints
...
impl crate::schemars::JsonSchema for PodGroupSchedulingConstraints {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1alpha3.PodGroupSchedulingConstraints".into()
    }
