// Generated from definition io.k8s.api.scheduling.v1beta1.PodGroupSchedulingPolicy
...
pub struct PodGroupSchedulingPolicy {
    ...
    pub basic: Option<crate::api::scheduling::v1beta1::BasicSchedulingPolicy>,
    ...
    pub gang: Option<crate::api::scheduling::v1beta1::GangSchedulingPolicy>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_basic: Option<crate::api::scheduling::v1beta1::BasicSchedulingPolicy> = None;
                let mut value_gang: Option<crate::api::scheduling::v1beta1::GangSchedulingPolicy> = None;
...
impl crate::schemars::JsonSchema for PodGroupSchedulingPolicy {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1beta1.PodGroupSchedulingPolicy".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "basic": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::BasicSchedulingPolicy>();
                ...
                "gang": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::GangSchedulingPolicy>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "basic".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::BasicSchedulingPolicy>().into_object();
                    ...
                    (
                        "gang".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::GangSchedulingPolicy>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
