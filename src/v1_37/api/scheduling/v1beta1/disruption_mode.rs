// Generated from definition io.k8s.api.scheduling.v1beta1.DisruptionMode
...
pub struct DisruptionMode {
    ...
    pub all: Option<crate::api::scheduling::v1beta1::AllDisruptionMode>,

    /// single specifies that children can be disrupted independently from each other.
    pub single: Option<crate::api::scheduling::v1beta1::SingleDisruptionMode>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_all: Option<crate::api::scheduling::v1beta1::AllDisruptionMode> = None;
                let mut value_single: Option<crate::api::scheduling::v1beta1::SingleDisruptionMode> = None;
...
impl crate::schemars::JsonSchema for DisruptionMode {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1beta1.DisruptionMode".into()
    }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                "all": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::AllDisruptionMode>();
                    schema_obj.ensure_object().insert("description".into(), "all specifies that all children can only be disrupted together.".into());
                    schema_obj
                }),
                "single": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::SingleDisruptionMode>();
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    (
                        "all".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::AllDisruptionMode>().into_object();
                    ...
                    (
                        "single".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::scheduling::v1beta1::SingleDisruptionMode>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
