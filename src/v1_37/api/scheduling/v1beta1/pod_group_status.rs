// Generated from definition io.k8s.api.scheduling.v1beta1.PodGroupStatus
...
pub struct PodGroupStatus {
    ...
    pub resource_claim_statuses: Option<std::vec::Vec<crate::api::scheduling::v1beta1::PodGroupResourceClaimStatus>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_resource_claim_statuses: Option<std::vec::Vec<crate::api::scheduling::v1beta1::PodGroupResourceClaimStatus>> = None;
...
impl crate::schemars::JsonSchema for PodGroupStatus {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "io.k8s.api.scheduling.v1beta1.PodGroupStatus".into()
    }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "resourceClaimStatuses": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::scheduling::v1beta1::PodGroupResourceClaimStatus>()),
                },
            },
        })
    }
                ...
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            ...
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::scheduling::v1beta1::PodGroupResourceClaimStatus>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
