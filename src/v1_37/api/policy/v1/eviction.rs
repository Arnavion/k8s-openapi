        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "metadata": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "metadata describes the pod that is being evicted.".into());
                    schema_obj
                }),
            },
            "required": [
                ...
                properties: [
                    ...
                    (
                        "metadata".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("metadata describes the pod that is being evicted.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
