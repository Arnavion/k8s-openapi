    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "http": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::HTTPIngressRuleValue>();
                    schema_obj.ensure_object().insert("description".into(), "http is a HTTP IngressRuleValue, which contains a list of http selectors".into());
                    schema_obj
                }),
            },
        })
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "http".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::HTTPIngressRuleValue>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("http is a HTTP IngressRuleValue, which contains a list of http selectors".into()),
                                ..Default::default()
                            }));
