...
pub struct PodStatus {
    ...
    pub volume_health: Option<std::vec::Vec<crate::api::core::v1::PodVolumeHealth>>,
}
...
impl crate::DeepMerge for PodStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::list::map(
            &mut self.node_allocatable_resource_claim_statuses,
            other.node_allocatable_resource_claim_statuses,
            &[|lhs, rhs| lhs.resource_claim_name == rhs.resource_claim_name],
            |current_item, other_item| {
                crate::DeepMerge::merge_from(current_item, other_item);
            },
        );
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "volumeHealth" => Field::Key_volume_health,
                            _ => Field::Other,
                        })
                    }
                }
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_volume_health: Option<std::vec::Vec<crate::api::core::v1::PodVolumeHealth>> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_volume_health => value_volume_health = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(PodStatus {
                    ...
                    volume_health: value_volume_health,
                })
            }
        }
...
impl crate::serde::Serialize for PodStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.volume_health.as_ref().map_or(0, |_| 1),
        )?;
        ...
        if let Some(value) = &self.volume_health {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "volumeHealth", value)?;
        }
        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "volumeHealth": {
                    ...
                    "type": "array",
                    "items": (__gen.subschema_for::<crate::api::core::v1::PodVolumeHealth>()),
                },
            },
        })
    }
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("volumeHealth contains node-reported health for each volume the pod is using. Populated by the kubelet on the pod's node.".into()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(crate::schemars08::schema::InstanceType::Array))),
                            array: Some(std::boxed::Box::new(crate::schemars08::schema::ArrayValidation {
                                items: Some(crate::schemars08::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::core::v1::PodVolumeHealth>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
