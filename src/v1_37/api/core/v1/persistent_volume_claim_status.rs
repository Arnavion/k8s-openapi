...
pub struct PersistentVolumeClaimStatus {
    ...
    pub health_status: Option<crate::api::core::v1::VolumeHealthStatus>,
...
impl crate::DeepMerge for PersistentVolumeClaimStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.health_status, other.health_status);
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "healthStatus" => Field::Key_health_status,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_health_status: Option<crate::api::core::v1::VolumeHealthStatus> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_health_status => value_health_status = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(PersistentVolumeClaimStatus {
                    ...
                    health_status: value_health_status,
...
impl crate::serde::Serialize for PersistentVolumeClaimStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.health_status.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.health_status {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "healthStatus", value)?;
        }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "healthStatus": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::VolumeHealthStatus>();
                    schema_obj.ensure_object().insert("description".into(), "healthStatus contains the latest controller-reported health information for the volume bound to this claim.".into());
                    schema_obj
                }),
                "modifyVolumeStatus": ({
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "healthStatus".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::VolumeHealthStatus>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("healthStatus contains the latest controller-reported health information for the volume bound to this claim.".into()),
                                ..Default::default()
                            }));
