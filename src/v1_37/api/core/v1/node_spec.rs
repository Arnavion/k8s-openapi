...
pub struct NodeSpec {
    ...
    pub pod_preemption_policy: Option<crate::api::core::v1::NodePodPreemptionPolicy>,
...
impl crate::DeepMerge for NodeSpec {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.pod_preemption_policy, other.pod_preemption_policy);
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "podPreemptionPolicy" => Field::Key_pod_preemption_policy,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_pod_preemption_policy: Option<crate::api::core::v1::NodePodPreemptionPolicy> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_pod_preemption_policy => value_pod_preemption_policy = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(NodeSpec {
                    ...
                    pod_preemption_policy: value_pod_preemption_policy,
...
impl crate::serde::Serialize for NodeSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            self.pod_preemption_policy.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.pod_preemption_policy {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "podPreemptionPolicy", value)?;
        }
    ...
    fn json_schema(__gen: &mut crate::schemars::SchemaGenerator) -> crate::schemars::Schema {
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "podPreemptionPolicy": ({
                    let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::NodePodPreemptionPolicy>();
                    schema_obj.ensure_object().insert("description".into(), "PodPreemptionPolicy controls the node-level preemption behaviors for pods on this node. This is an alpha field and requires enabling the InPlacePodVerticalScalingSchedulerPreemption feature gate.".into());
                    schema_obj
                }),
                "providerID": {
        ...
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "podPreemptionPolicy".into(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::core::v1::NodePodPreemptionPolicy>().into_object();
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("PodPreemptionPolicy controls the node-level preemption behaviors for pods on this node. This is an alpha field and requires enabling the InPlacePodVerticalScalingSchedulerPreemption feature gate.".into()),
                                ..Default::default()
                            }));
                            crate::schemars08::schema::Schema::Object(schema_obj)
                        },
