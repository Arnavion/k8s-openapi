...
impl crate::DeepMerge for NodeSystemInfo {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.running_in_user_namespace, other.running_in_user_namespace);
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
                ...
                impl crate::serde::de::Visitor<'_> for Visitor {
                    ...
                    fn visit_str<E>(self, v: &str) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                        Ok(match v {
                            ...
                            "runningInUserNamespace" => Field::Key_running_in_user_namespace,
                            "swap" => Field::Key_swap,
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_running_in_user_namespace: Option<bool> = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_running_in_user_namespace => value_running_in_user_namespace = crate::serde::de::MapAccess::next_value(&mut map)?,
                ...
                Ok(NodeSystemInfo {
                    ...
                    running_in_user_namespace: value_running_in_user_namespace,
                    swap: value_swap,
...
impl crate::serde::Serialize for NodeSystemInfo {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            "NodeSystemInfo",
            10 +
            self.running_in_user_namespace.as_ref().map_or(0, |_| 1) +
        ...
        if let Some(value) = &self.running_in_user_namespace {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "runningInUserNamespace", value)?;
        }
        ...
        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
            ...
            object: Some(std::boxed::Box::new(crate::schemars08::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "runningInUserNamespace".into(),
                        crate::schemars08::schema::Schema::Object(crate::schemars08::schema::SchemaObject {
                            metadata: Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("Whether the node is running in a user namespace.".into()),
                                ..Default::default()
                            })),
