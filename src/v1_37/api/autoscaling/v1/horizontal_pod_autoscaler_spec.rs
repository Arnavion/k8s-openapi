        ...
        crate::schemars::json_schema!({
            ...
            "properties": {
                ...
                "scaleTargetRef": ({
                    ...
                    schema_obj.ensure_object().insert("description".into(), "scaleTargetRef is the reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.".into());
                    schema_obj
                }),
                "targetCPUUtilizationPercentage": {
                    ...
                    (
                        "scaleTargetRef".into(),
                        {
                            ...
                            schema_obj.metadata = Some(std::boxed::Box::new(crate::schemars08::schema::Metadata {
                                description: Some("scaleTargetRef is the reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.".into()),
                                ..Default::default()
                            }));
