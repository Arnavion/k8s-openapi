...
pub struct PolicyRulesWithSubjects {
    ...
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::flowcontrol::v1alpha1::NonResourcePolicyRule>::new"))]
    pub non_resource_rules: Vec<crate::api::flowcontrol::v1alpha1::NonResourcePolicyRule>,

    /// `resourceRules` is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty.
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::flowcontrol::v1alpha1::ResourcePolicyRule>::new"))]
    ...
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::flowcontrol::v1alpha1::Subject>::new"))]
