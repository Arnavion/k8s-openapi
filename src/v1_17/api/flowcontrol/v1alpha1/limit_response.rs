...
impl crate::Schema for LimitResponse {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "queuing": crate::schema_ref_with_values(crate::api::flowcontrol::v1alpha1::QueuingConfiguration::schema(), serde_json::json!({"description": "`queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `\"Queue\"`."})),
            "type": {
