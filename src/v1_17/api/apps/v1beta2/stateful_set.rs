    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::api::apps::v1beta2::StatefulSetSpec::schema(), "Spec defines the desired identities of pods in this set."),
            "status": crate::schema_ref_with_description(crate::api::apps::v1beta2::StatefulSetStatus::schema(), "Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.")
          },
          "required": [
            "metadata"
          ],
