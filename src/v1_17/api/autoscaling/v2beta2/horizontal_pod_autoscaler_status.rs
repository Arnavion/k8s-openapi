...
pub struct HorizontalPodAutoscalerStatus {
    ...
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::autoscaling::v2beta2::HorizontalPodAutoscalerCondition>::new"))]
    pub conditions: Vec<crate::api::autoscaling::v2beta2::HorizontalPodAutoscalerCondition>,

    /// currentMetrics is the last read state of the metrics used by this autoscaler.
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::autoscaling::v2beta2::MetricStatus>::new"))]
    pub current_metrics: Vec<crate::api::autoscaling::v2beta2::MetricStatus>,
