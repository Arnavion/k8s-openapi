        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_seq<A>(self, mut seq: A) -> Result<Self::Value, A::Error> where A: serde::de::SeqAccess<'de> {
                Ok(PodStatus {
                    ...
                    ephemeral_container_statuses: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("ephemeral_container_statuses"))?,
                    ...
                    pod_ips: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("pod_ips"))?,
...
impl serde::Serialize for PodStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.ephemeral_container_statuses {
            serde::ser::SerializeStruct::serialize_field(&mut state, "ephemeralContainerStatuses", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "ephemeralContainerStatuses")?;
        }
        ...
        if let Some(value) = &self.pod_ips {
            serde::ser::SerializeStruct::serialize_field(&mut state, "podIPs", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "podIPs")?;
        }
