        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_seq<A>(self, mut seq: A) -> Result<Self::Value, A::Error> where A: serde::de::SeqAccess<'de> {
                Ok(EphemeralContainer {
                    ...
                    startup_probe: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("startup_probe"))?,
                    ...
                    target_container_name: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("target_container_name"))?,
...
impl serde::Serialize for EphemeralContainer {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.startup_probe {
            serde::ser::SerializeStruct::serialize_field(&mut state, "startupProbe", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "startupProbe")?;
        }
        ...
        if let Some(value) = &self.target_container_name {
            serde::ser::SerializeStruct::serialize_field(&mut state, "targetContainerName", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "targetContainerName")?;
        }
