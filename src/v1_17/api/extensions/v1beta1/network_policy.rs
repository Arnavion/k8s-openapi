    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::extensions::v1beta1::NetworkPolicySpec::schema(), serde_json::json!({"description": "Specification of the desired behavior for this NetworkPolicy."}))
          },
          "required": [
            "metadata"
          ],
