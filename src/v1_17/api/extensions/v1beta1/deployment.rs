    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::extensions::v1beta1::DeploymentSpec::schema(), serde_json::json!({"description": "Specification of the desired behavior of the Deployment."})),
            "status": crate::schema_ref_with_values(crate::api::extensions::v1beta1::DeploymentStatus::schema(), serde_json::json!({"description": "Most recently observed status of the Deployment."}))
          },
          "required": [
            "metadata"
          ],
