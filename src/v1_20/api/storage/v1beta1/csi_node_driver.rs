...
impl crate::Schema for CSINodeDriver {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "allocatable": crate::schema_ref_with_values(crate::api::storage::v1beta1::VolumeNodeResources::schema(), serde_json::json!({"description": "allocatable represents the volume resources of a node that are available for scheduling."})),
            "name": {
