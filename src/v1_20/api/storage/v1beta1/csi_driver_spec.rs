...
impl CSIDriverSpec  {
    ...
    pub  fn token_requests_set(&mut self, token_requests: impl Into<Option<Vec<crate::api::storage::v1beta1::TokenRequest>>>) -> &mut Self {
        self.token_requests = token_requests.into(); self
    }

    pub  fn token_requests(&mut self) -> &mut Vec<crate::api::storage::v1beta1::TokenRequest> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn token_requests_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::storage::v1beta1::TokenRequest>)) -> &mut Self {
        if self.token_requests.is_none() { self.token_requests = Some(Default::default()) };
    ...
    pub  fn token_requests_push_with(&mut self, func: impl FnOnce(&mut crate::api::storage::v1beta1::TokenRequest)) -> &mut Self {
    ...
    pub  fn token_requests_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::storage::v1beta1::TokenRequest]>) -> &mut Self {
