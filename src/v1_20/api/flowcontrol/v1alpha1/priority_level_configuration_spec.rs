...
impl crate::Schema for PriorityLevelConfigurationSpec {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "limited": crate::schema_ref_with_values(crate::api::flowcontrol::v1alpha1::LimitedPriorityLevelConfiguration::schema(), serde_json::json!({"description": "`limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `\"Limited\"`."})),
            "type": {
