...
impl FlowSchema  {
    ...
    /// Set [`Self::spec`]
    pub  fn spec_set(&mut self, spec: impl Into<Option<crate::api::flowcontrol::v1beta1::FlowSchemaSpec>>) -> &mut Self {
        self.spec = spec.into(); self
    }

    pub  fn spec(&mut self) -> &mut crate::api::flowcontrol::v1beta1::FlowSchemaSpec {
    ...
    pub  fn spec_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1beta1::FlowSchemaSpec)) -> &mut Self {
        if self.spec.is_none() { self.spec = Some(Default::default()) };
    ...
    /// Set [`Self::status`]
    pub  fn status_set(&mut self, status: impl Into<Option<crate::api::flowcontrol::v1beta1::FlowSchemaStatus>>) -> &mut Self {
        self.status = status.into(); self
    }

    pub  fn status(&mut self) -> &mut crate::api::flowcontrol::v1beta1::FlowSchemaStatus {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn status_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1beta1::FlowSchemaStatus)) -> &mut Self {
        if self.status.is_none() { self.status = Some(Default::default()) };
