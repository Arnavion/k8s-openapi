...
pub struct PolicyRulesWithSubjects {
    ...
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::flowcontrol::v1beta1::NonResourcePolicyRule>::new"))]
    pub non_resource_rules: Vec<crate::api::flowcontrol::v1beta1::NonResourcePolicyRule>,

    /// `resourceRules` is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty.
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::flowcontrol::v1beta1::ResourcePolicyRule>::new"))]
    pub resource_rules: Vec<crate::api::flowcontrol::v1beta1::ResourcePolicyRule>,

    /// subjects is the list of normal user, serviceaccount, or group that this rule cares about. There must be at least one member in this slice. A slice that includes both the system:authenticated and system:unauthenticated user groups matches every request. Required.
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::flowcontrol::v1beta1::Subject>::new"))]
