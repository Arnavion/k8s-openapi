        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_seq<A>(self, mut seq: A) -> Result<Self::Value, A::Error> where A: serde::de::SeqAccess<'de> {
                Ok(PodSpec {
                    ...
                    ephemeral_containers: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("ephemeral_containers"))?,
                    ...
                    preemption_policy: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("preemption_policy"))?,
                    ...
                    set_hostname_as_fqdn: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("set_hostname_as_fqdn"))?,
                    ...
                    topology_spread_constraints: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("topology_spread_constraints"))?,
...
impl serde::Serialize for PodSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.ephemeral_containers {
            serde::ser::SerializeStruct::serialize_field(&mut state, "ephemeralContainers", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "ephemeralContainers")?;
        }
        ...
        if let Some(value) = &self.preemption_policy {
            serde::ser::SerializeStruct::serialize_field(&mut state, "preemptionPolicy", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "preemptionPolicy")?;
        }
        ...
        if let Some(value) = &self.set_hostname_as_fqdn {
            serde::ser::SerializeStruct::serialize_field(&mut state, "setHostnameAsFQDN", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "setHostnameAsFQDN")?;
        }
        ...
        if let Some(value) = &self.topology_spread_constraints {
            serde::ser::SerializeStruct::serialize_field(&mut state, "topologySpreadConstraints", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "topologySpreadConstraints")?;
        }
