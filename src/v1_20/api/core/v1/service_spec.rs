    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_seq<A>(self, mut seq: A) -> Result<Self::Value, A::Error> where A: serde::de::SeqAccess<'de> {
                Ok(ServiceSpec {
                    allocate_load_balancer_node_ports: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("allocate_load_balancer_node_ports"))?,
                    cluster_ip: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("cluster_ip"))?,
                    cluster_i_ps: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("cluster_i_ps"))?,
                    ...
                    ip_families: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("ip_families"))?,
                    ip_family_policy: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("ip_family_policy"))?,
...
impl serde::Serialize for ServiceSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.allocate_load_balancer_node_ports {
            serde::ser::SerializeStruct::serialize_field(&mut state, "allocateLoadBalancerNodePorts", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "allocateLoadBalancerNodePorts")?;
        }
        ...
        if let Some(value) = &self.cluster_i_ps {
            serde::ser::SerializeStruct::serialize_field(&mut state, "clusterIPs", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "clusterIPs")?;
        }
        ...
        if let Some(value) = &self.ip_families {
            serde::ser::SerializeStruct::serialize_field(&mut state, "ipFamilies", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "ipFamilies")?;
        }
        if let Some(value) = &self.ip_family_policy {
            serde::ser::SerializeStruct::serialize_field(&mut state, "ipFamilyPolicy", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "ipFamilyPolicy")?;
        }
