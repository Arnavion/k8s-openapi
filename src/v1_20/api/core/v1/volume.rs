...
impl crate::Schema for Volume {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "awsElasticBlockStore": crate::schema_ref_with_values(crate::api::core::v1::AWSElasticBlockStoreVolumeSource::schema(), serde_json::json!({"description": "AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore"})),
            "azureDisk": crate::schema_ref_with_values(crate::api::core::v1::AzureDiskVolumeSource::schema(), serde_json::json!({"description": "AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod."})),
            "azureFile": crate::schema_ref_with_values(crate::api::core::v1::AzureFileVolumeSource::schema(), serde_json::json!({"description": "AzureFile represents an Azure File Service mount on the host and bind mount to the pod."})),
            "cephfs": crate::schema_ref_with_values(crate::api::core::v1::CephFSVolumeSource::schema(), serde_json::json!({"description": "CephFS represents a Ceph FS mount on the host that shares a pod's lifetime"})),
            "cinder": crate::schema_ref_with_values(crate::api::core::v1::CinderVolumeSource::schema(), serde_json::json!({"description": "Cinder represents a cinder volume attached and mounted on kubelets host machine. More info: https://examples.k8s.io/mysql-cinder-pd/README.md"})),
            "configMap": crate::schema_ref_with_values(crate::api::core::v1::ConfigMapVolumeSource::schema(), serde_json::json!({"description": "ConfigMap represents a configMap that should populate this volume"})),
            "csi": crate::schema_ref_with_values(crate::api::core::v1::CSIVolumeSource::schema(), serde_json::json!({"description": "CSI (Container Storage Interface) represents ephemeral storage that is handled by certain external CSI drivers (Beta feature)."})),
            "downwardAPI": crate::schema_ref_with_values(crate::api::core::v1::DownwardAPIVolumeSource::schema(), serde_json::json!({"description": "DownwardAPI represents downward API about the pod that should populate this volume"})),
            "emptyDir": crate::schema_ref_with_values(crate::api::core::v1::EmptyDirVolumeSource::schema(), serde_json::json!({"description": "EmptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir"})),
            "ephemeral": crate::schema_ref_with_values(crate::api::core::v1::EphemeralVolumeSource::schema(), serde_json::json!({"description": "Ephemeral represents a volume that is handled by a cluster storage driver (Alpha feature). The volume's lifecycle is tied to the pod that defines it - it will be created before the pod starts, and deleted when the pod is removed.\n\nUse this if: a) the volume is only needed while the pod runs, b) features of normal volumes like restoring from snapshot or capacity\n   tracking are needed,\nc) the storage driver is specified through a storage class, and d) the storage driver supports dynamic volume provisioning through\n   a PersistentVolumeClaim (see EphemeralVolumeSource for more\n   information on the connection between this volume type\n   and PersistentVolumeClaim).\n\nUse PersistentVolumeClaim or one of the vendor-specific APIs for volumes that persist for longer than the lifecycle of an individual pod.\n\nUse CSI for light-weight local ephemeral volumes if the CSI driver is meant to be used that way - see the documentation of the driver for more information.\n\nA pod can use both types of ephemeral volumes and persistent volumes at the same time."})),
            "fc": crate::schema_ref_with_values(crate::api::core::v1::FCVolumeSource::schema(), serde_json::json!({"description": "FC represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod."})),
            "flexVolume": crate::schema_ref_with_values(crate::api::core::v1::FlexVolumeSource::schema(), serde_json::json!({"description": "FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin."})),
            "flocker": crate::schema_ref_with_values(crate::api::core::v1::FlockerVolumeSource::schema(), serde_json::json!({"description": "Flocker represents a Flocker volume attached to a kubelet's host machine. This depends on the Flocker control service being running"})),
            "gcePersistentDisk": crate::schema_ref_with_values(crate::api::core::v1::GCEPersistentDiskVolumeSource::schema(), serde_json::json!({"description": "GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk"})),
            "gitRepo": crate::schema_ref_with_values(crate::api::core::v1::GitRepoVolumeSource::schema(), serde_json::json!({"description": "GitRepo represents a git repository at a particular revision. DEPRECATED: GitRepo is deprecated. To provision a container with a git repo, mount an EmptyDir into an InitContainer that clones the repo using git, then mount the EmptyDir into the Pod's container."})),
            "glusterfs": crate::schema_ref_with_values(crate::api::core::v1::GlusterfsVolumeSource::schema(), serde_json::json!({"description": "Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: https://examples.k8s.io/volumes/glusterfs/README.md"})),
            "hostPath": crate::schema_ref_with_values(crate::api::core::v1::HostPathVolumeSource::schema(), serde_json::json!({"description": "HostPath represents a pre-existing file or directory on the host machine that is directly exposed to the container. This is generally used for system agents or other privileged things that are allowed to see the host machine. Most containers will NOT need this. More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath"})),
            "iscsi": crate::schema_ref_with_values(crate::api::core::v1::ISCSIVolumeSource::schema(), serde_json::json!({"description": "ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://examples.k8s.io/volumes/iscsi/README.md"})),
            "name": {
              "description": "Volume's name. Must be a DNS_LABEL and unique within the pod. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
              "type": "string"
            },
            "nfs": crate::schema_ref_with_values(crate::api::core::v1::NFSVolumeSource::schema(), serde_json::json!({"description": "NFS represents an NFS mount on the host that shares a pod's lifetime More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs"})),
            "persistentVolumeClaim": crate::schema_ref_with_values(crate::api::core::v1::PersistentVolumeClaimVolumeSource::schema(), serde_json::json!({"description": "PersistentVolumeClaimVolumeSource represents a reference to a PersistentVolumeClaim in the same namespace. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims"})),
            "photonPersistentDisk": crate::schema_ref_with_values(crate::api::core::v1::PhotonPersistentDiskVolumeSource::schema(), serde_json::json!({"description": "PhotonPersistentDisk represents a PhotonController persistent disk attached and mounted on kubelets host machine"})),
            "portworxVolume": crate::schema_ref_with_values(crate::api::core::v1::PortworxVolumeSource::schema(), serde_json::json!({"description": "PortworxVolume represents a portworx volume attached and mounted on kubelets host machine"})),
            "projected": crate::schema_ref_with_values(crate::api::core::v1::ProjectedVolumeSource::schema(), serde_json::json!({"description": "Items for all in one resources secrets, configmaps, and downward API"})),
            "quobyte": crate::schema_ref_with_values(crate::api::core::v1::QuobyteVolumeSource::schema(), serde_json::json!({"description": "Quobyte represents a Quobyte mount on the host that shares a pod's lifetime"})),
            "rbd": crate::schema_ref_with_values(crate::api::core::v1::RBDVolumeSource::schema(), serde_json::json!({"description": "RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: https://examples.k8s.io/volumes/rbd/README.md"})),
            "scaleIO": crate::schema_ref_with_values(crate::api::core::v1::ScaleIOVolumeSource::schema(), serde_json::json!({"description": "ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes."})),
            "secret": crate::schema_ref_with_values(crate::api::core::v1::SecretVolumeSource::schema(), serde_json::json!({"description": "Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret"})),
            "storageos": crate::schema_ref_with_values(crate::api::core::v1::StorageOSVolumeSource::schema(), serde_json::json!({"description": "StorageOS represents a StorageOS volume attached and mounted on Kubernetes nodes."})),
            "vsphereVolume": crate::schema_ref_with_values(crate::api::core::v1::VsphereVirtualDiskVolumeSource::schema(), serde_json::json!({"description": "VsphereVolume represents a vSphere volume attached and mounted on kubelets host machine"}))
          },
          "required": [
            "name"
          ],
