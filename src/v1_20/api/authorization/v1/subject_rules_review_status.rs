...
impl SubjectRulesReviewStatus  {
    ...
    pub  fn non_resource_rules_set(&mut self, non_resource_rules: impl Into<Vec<crate::api::authorization::v1::NonResourceRule>>) -> &mut Self {
        self.non_resource_rules = non_resource_rules.into(); self
    }

    pub  fn non_resource_rules(&mut self) -> &mut Vec<crate::api::authorization::v1::NonResourceRule> {
        &mut self.non_resource_rules
    }

    /// Modify [`Self::non_resource_rules`] with a `func`
    pub  fn non_resource_rules_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::authorization::v1::NonResourceRule>)) -> &mut Self {
    ...
    pub  fn non_resource_rules_push_with(&mut self, func: impl FnOnce(&mut crate::api::authorization::v1::NonResourceRule)) -> &mut Self {
    ...
    pub  fn non_resource_rules_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::authorization::v1::NonResourceRule]>) -> &mut Self {
    ...
    pub  fn resource_rules_set(&mut self, resource_rules: impl Into<Vec<crate::api::authorization::v1::ResourceRule>>) -> &mut Self {
        self.resource_rules = resource_rules.into(); self
    }

    pub  fn resource_rules(&mut self) -> &mut Vec<crate::api::authorization::v1::ResourceRule> {
        &mut self.resource_rules
    }

    /// Modify [`Self::resource_rules`] with a `func`
    pub  fn resource_rules_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::authorization::v1::ResourceRule>)) -> &mut Self {
    ...
    ///
    /// The field will initially set to `Default::default()`
    pub  fn resource_rules_push_with(&mut self, func: impl FnOnce(&mut crate::api::authorization::v1::ResourceRule)) -> &mut Self {
      let mut new = Default::default();
      func(&mut new);
    ...
    pub  fn resource_rules_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::authorization::v1::ResourceRule]>) -> &mut Self {
         for item in other.borrow() {
