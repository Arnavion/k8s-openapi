...
impl IngressClassSpec  {
    ...
    /// Set [`Self::parameters`]
    pub  fn parameters_set(&mut self, parameters: impl Into<Option<crate::api::core::v1::TypedLocalObjectReference>>) -> &mut Self {
        self.parameters = parameters.into(); self
    }

    pub  fn parameters(&mut self) -> &mut crate::api::core::v1::TypedLocalObjectReference {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn parameters_with(&mut self, func: impl FnOnce(&mut crate::api::core::v1::TypedLocalObjectReference)) -> &mut Self {
        if self.parameters.is_none() { self.parameters = Some(Default::default()) };
