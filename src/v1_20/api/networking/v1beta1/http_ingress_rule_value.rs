...
impl HTTPIngressRuleValue  {
    /// Set [`Self::paths`]
    pub  fn paths_set(&mut self, paths: impl Into<Vec<crate::api::networking::v1beta1::HTTPIngressPath>>) -> &mut Self {
        self.paths = paths.into(); self
    }

    pub  fn paths(&mut self) -> &mut Vec<crate::api::networking::v1beta1::HTTPIngressPath> {
        &mut self.paths
    }

    /// Modify [`Self::paths`] with a `func`
    pub  fn paths_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::networking::v1beta1::HTTPIngressPath>)) -> &mut Self {
    ...
    pub  fn paths_push_with(&mut self, func: impl FnOnce(&mut crate::api::networking::v1beta1::HTTPIngressPath)) -> &mut Self {
    ...
    pub  fn paths_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::networking::v1beta1::HTTPIngressPath]>) -> &mut Self {
