    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "strategy": crate::schema_ref_with_description(crate::api::apps::v1::DeploymentStrategy::schema(), "The deployment strategy to use to replace existing pods with new ones."),
