...
// Begin authentication.k8s.io/v1beta1/SelfSubjectReview

// Generated from operation createAuthenticationV1beta1SelfSubjectReview
...
impl SelfSubjectReview {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::authentication::v1beta1::SelfSubjectReview,
        ...
        let __url = "/apis/authentication.k8s.io/v1beta1/selfsubjectreviews?".to_owned();
...
// End authentication.k8s.io/v1beta1/SelfSubjectReview
...
impl crate::schemars::JsonSchema for SelfSubjectReview {
    fn schema_name() -> String {
        "io.k8s.api.authentication.v1beta1.SelfSubjectReview".to_owned()
    }
