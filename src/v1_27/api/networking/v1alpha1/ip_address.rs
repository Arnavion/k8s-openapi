...
// Begin networking.k8s.io/v1alpha1/IPAddress
...
impl IPAddress {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::networking::v1alpha1::IPAddress,
        ...
        let __url = "/apis/networking.k8s.io/v1alpha1/ipaddresses?".to_owned();
...
// Generated from operation deleteNetworkingV1alpha1CollectionIPAddress
...
// Generated from operation deleteNetworkingV1alpha1IPAddress
...
impl IPAddress {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}",
...
// Generated from operation listNetworkingV1alpha1IPAddress
...
// Generated from operation patchNetworkingV1alpha1IPAddress
...
// Generated from operation readNetworkingV1alpha1IPAddress

impl IPAddress {
    /// read the specified IPAddress
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`ReadIPAddressResponse`]`>` constructor, or [`ReadIPAddressResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    pub fn read(
        name: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadIPAddressResponse>), crate::RequestError> {
        let __url = format!("/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadIPAddressResponse as Response>::try_from_parts` to parse the HTTP response body of [`IPAddress::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadIPAddressResponse {
    Ok(crate::api::networking::v1alpha1::IPAddress),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadIPAddressResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadIPAddressResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadIPAddressResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceNetworkingV1alpha1IPAddress
...
// Generated from operation watchNetworkingV1alpha1IPAddress
...
// End networking.k8s.io/v1alpha1/IPAddress
