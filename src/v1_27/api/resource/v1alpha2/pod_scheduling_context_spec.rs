...
impl crate::schemars::JsonSchema for PodSchedulingContextSpec {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha2.PodSchedulingContextSpec".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("PodSchedulingContextSpec describes where resources for the Pod are needed.".to_owned()),
                ..Default::default()
            })),
