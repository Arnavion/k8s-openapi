...
pub struct DeploymentStrategy {
    ...
    pub rolling_update: Option<crate::api::apps::v1beta2::RollingUpdateDeployment>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_rolling_update: Option<crate::api::apps::v1beta2::RollingUpdateDeployment> = None;
...
impl crate::Schema for DeploymentStrategy {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "rollingUpdate": crate::schema_ref_with_values(crate::api::apps::v1beta2::RollingUpdateDeployment::schema(), serde_json::json!({"description": "Rolling update config params. Present only if DeploymentStrategyType = RollingUpdate."})),
            "type": {
