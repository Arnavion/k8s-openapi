...
impl crate::Schema for DaemonSetUpdateStrategy {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "rollingUpdate": crate::schema_ref_with_values(crate::api::apps::v1beta2::RollingUpdateDaemonSet::schema(), serde_json::json!({"description": "Rolling update config params. Present only if type = \"RollingUpdate\"."})),
            "type": {
