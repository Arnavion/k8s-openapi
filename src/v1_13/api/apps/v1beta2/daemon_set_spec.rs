    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "updateStrategy": crate::schema_ref_with_description(crate::api::apps::v1beta2::DaemonSetUpdateStrategy::schema(), "An update strategy to replace existing DaemonSet pods with new pods.")
          },
          "required": [
            "selector",
            "template"
