// Generated from definition io.k8s.api.apps.v1beta1.StatefulSetCondition
...
impl<'de> serde::Deserialize<'de> for StatefulSetCondition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct StatefulSetCondition")
            }
...
impl serde::Serialize for StatefulSetCondition {
