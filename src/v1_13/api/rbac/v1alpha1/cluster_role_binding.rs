...
#[cfg(feature = "schema")]
impl crate::Schema for ClusterRoleBinding {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "roleRef": crate::schema_ref_with_values(crate::api::rbac::v1alpha1::RoleRef::schema(), serde_json::json!({"description": "RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error."})),
            "subjects": {
