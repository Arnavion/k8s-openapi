    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "jobTemplate": crate::schema_ref_with_values(crate::api::batch::v2alpha1::JobTemplateSpec::schema(), serde_json::json!({"description": "Specifies the job that will be created when executing a CronJob."})),
            "schedule": {
