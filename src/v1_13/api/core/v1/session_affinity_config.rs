...
pub struct SessionAffinityConfig {
    ...
    pub client_ip: Option<crate::v1_13::api::core::v1::ClientIPConfig>,
}
...
impl<'de> serde::Deserialize<'de> for SessionAffinityConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct SessionAffinityConfig")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_client_ip: Option<crate::v1_13::api::core::v1::ClientIPConfig> = None;
