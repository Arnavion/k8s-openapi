    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "csi": crate::schema_ref_with_values(crate::api::core::v1::CSIPersistentVolumeSource::schema(), serde_json::json!({"description": "CSI represents storage that handled by an external CSI driver (Beta feature)."})),
