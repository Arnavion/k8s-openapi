    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "scaleTargetRef": crate::schema_ref_with_description(crate::api::autoscaling::v2beta1::CrossVersionObjectReference::schema(), "scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.")
          },
          "required": [
            "maxReplicas",
            "scaleTargetRef"
