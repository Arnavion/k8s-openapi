...
#[cfg(feature = "schema")]
impl crate::Schema for SelfSubjectRulesReview {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::authorization::v1beta1::SelfSubjectRulesReviewSpec::schema(), serde_json::json!({"description": "Spec holds information about the request being evaluated."})),
            "status": crate::schema_ref_with_values(crate::api::authorization::v1beta1::SubjectRulesReviewStatus::schema(), serde_json::json!({"description": "Status is filled in by the server and indicates the set of actions a user can perform."}))
          },
          "required": [
            "metadata",
            "spec"
