...
pub enum JSONSchemaPropsOrArray {
    Schema(Box<crate::v1_13::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>),
    Schemas(Vec<crate::v1_13::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>),
}
