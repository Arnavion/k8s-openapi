...
pub struct NetworkPolicyEgressRule {
    ...
    pub to: Option<Vec<crate::api::extensions::v1beta1::NetworkPolicyPeer>>,
}
...
impl crate::schemars::JsonSchema for NetworkPolicyEgressRule {
    fn schema_name() -> String {
        "io.k8s.api.extensions.v1beta1.NetworkPolicyEgressRule".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("DEPRECATED 1.9 - This group version of NetworkPolicyEgressRule is deprecated by networking/v1/NetworkPolicyEgressRule. NetworkPolicyEgressRule describes a particular set of traffic that is allowed out of pods matched by a NetworkPolicySpec's podSelector. The traffic must match both ports and to. This type is beta-level in 1.8".to_owned()),
                ..Default::default()
            })),
