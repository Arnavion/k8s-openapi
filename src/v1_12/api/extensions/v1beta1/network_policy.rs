    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::api::extensions::v1beta1::NetworkPolicySpec::schema(), "Specification of the desired behavior for this NetworkPolicy.")
          },
          "required": [
            "metadata"
          ],
