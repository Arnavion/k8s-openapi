    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "rollbackTo": crate::schema_ref_with_description(crate::api::apps::v1beta1::RollbackConfig::schema(), "DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done."),
            ...
            "strategy": crate::schema_ref_with_description(crate::api::apps::v1beta1::DeploymentStrategy::schema(), "The deployment strategy to use to replace existing pods with new ones."),
