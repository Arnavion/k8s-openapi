// Generated from definition io.k8s.api.apps.v1beta1.StatefulSetStatus
...
pub struct StatefulSetStatus {
    ...
    pub conditions: Vec<crate::api::apps::v1beta1::StatefulSetCondition>,
...
impl crate::schemars::JsonSchema for StatefulSetStatus {
    fn schema_name() -> String {
        "io.k8s.api.apps.v1beta1.StatefulSetStatus".to_owned()
    }
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            ...
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(__gen.subschema_for::<crate::api::apps::v1beta1::StatefulSetCondition>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
