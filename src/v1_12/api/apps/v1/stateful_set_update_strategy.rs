...
impl crate::Schema for StatefulSetUpdateStrategy {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "rollingUpdate": crate::schema_ref_with_values(crate::api::apps::v1::RollingUpdateStatefulSetStrategy::schema(), serde_json::json!({"description": "RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType."})),
            "type": {
