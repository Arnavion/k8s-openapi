...
impl crate::Schema for NetworkPolicyPeer {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "ipBlock": crate::schema_ref_with_values(crate::api::networking::v1::IPBlock::schema(), serde_json::json!({"description": "IPBlock defines policy on a particular IPBlock. If this field is set then neither of the other fields can be."})),
