...
#[cfg(feature = "schema")]
impl crate::Schema for ISCSIVolumeSource {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "secretRef": crate::schema_ref_with_values(crate::api::core::v1::LocalObjectReference::schema(), serde_json::json!({"description": "CHAP Secret for iSCSI target and initiator authentication"})),
            "targetPortal": {
