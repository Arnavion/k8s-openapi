...
pub enum CreateSelfSubjectAccessReviewResponse {
    Ok(crate::api::authorization::v1::SelfSubjectAccessReview),
    Created(crate::api::authorization::v1::SelfSubjectAccessReview),
    Accepted(crate::api::authorization::v1::SelfSubjectAccessReview),
