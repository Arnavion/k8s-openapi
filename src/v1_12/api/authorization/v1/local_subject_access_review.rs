    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::authorization::v1::SubjectAccessReviewSpec::schema(), serde_json::json!({"description": "Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted."})),
            "status": crate::schema_ref_with_values(crate::api::authorization::v1::SubjectAccessReviewStatus::schema(), serde_json::json!({"description": "Status is filled in by the server and indicates whether the request is allowed or not"}))
          },
          "required": [
            "metadata",
            "spec"
