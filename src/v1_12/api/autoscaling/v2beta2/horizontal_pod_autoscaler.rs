...
pub enum CreateNamespacedHorizontalPodAutoscalerResponse {
    ...
    Created(crate::api::autoscaling::v2beta2::HorizontalPodAutoscaler),
    Accepted(crate::api::autoscaling::v2beta2::HorizontalPodAutoscaler),
...
pub enum DeleteCollectionNamespacedHorizontalPodAutoscalerResponse {
    ...
    OkValue(crate::List<crate::api::autoscaling::v2beta2::HorizontalPodAutoscaler>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedHorizontalPodAutoscalerResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::api::autoscaling::v2beta2::HorizontalPodAutoscaler),
...
pub enum ListHorizontalPodAutoscalerForAllNamespacesResponse {
    Ok(crate::List<crate::api::autoscaling::v2beta2::HorizontalPodAutoscaler>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
