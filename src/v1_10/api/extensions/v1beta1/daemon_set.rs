...
pub enum CreateNamespacedDaemonSetResponse {
    ...
    Created(crate::api::extensions::v1beta1::DaemonSet),
    Accepted(crate::api::extensions::v1beta1::DaemonSet),
...
pub enum DeleteCollectionNamespacedDaemonSetResponse {
    ...
    OkValue(crate::List<crate::api::extensions::v1beta1::DaemonSet>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedDaemonSetResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::api::extensions::v1beta1::DaemonSet),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListDaemonSetForAllNamespacesResponse {
    Ok(crate::List<crate::api::extensions::v1beta1::DaemonSet>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
