...
pub struct DaemonSetList {
    ...
    pub items: Vec<crate::api::extensions::v1beta1::DaemonSet>,
...
impl crate::Resource for DaemonSetList {
    ...
    const KIND: &'static str = "DaemonSetList";
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::extensions::v1beta1::DaemonSet>> = None;
