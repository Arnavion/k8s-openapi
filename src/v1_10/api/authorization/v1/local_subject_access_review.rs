...
pub enum CreateNamespacedLocalSubjectAccessReviewResponse {
    Ok(crate::api::authorization::v1::LocalSubjectAccessReview),
    Created(crate::api::authorization::v1::LocalSubjectAccessReview),
    Accepted(crate::api::authorization::v1::LocalSubjectAccessReview),
