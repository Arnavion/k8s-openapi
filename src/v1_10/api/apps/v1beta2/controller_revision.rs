...
pub enum CreateNamespacedControllerRevisionResponse {
    ...
    Created(crate::api::apps::v1beta2::ControllerRevision),
    Accepted(crate::api::apps::v1beta2::ControllerRevision),
...
pub enum DeleteCollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(crate::List<crate::api::apps::v1beta2::ControllerRevision>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedControllerRevisionResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::api::apps::v1beta2::ControllerRevision),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum ListControllerRevisionForAllNamespacesResponse {
    Ok(crate::List<crate::api::apps::v1beta2::ControllerRevision>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
