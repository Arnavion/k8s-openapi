...
#![cfg_attr(k8s_openapi_enabled_version="1.37", doc = "v1_37")]
...
#[cfg(k8s_openapi_enabled_version="1.37")] mod v1_37;
#[cfg(k8s_openapi_enabled_version="1.37")] pub use self::v1_37::*;
