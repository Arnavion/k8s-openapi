...
pub struct ExternalAdmissionHookConfigurationList {
    ...
    pub items: Vec<crate::api::admissionregistration::v1alpha1::ExternalAdmissionHookConfiguration>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<crate::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for ExternalAdmissionHookConfigurationList {
    const API_VERSION: &'static str = "admissionregistration.k8s.io/v1alpha1";
    const GROUP: &'static str = "admissionregistration.k8s.io";
    const KIND: &'static str = "ExternalAdmissionHookConfigurationList";
    const VERSION: &'static str = "v1alpha1";
}

impl crate::Metadata for ExternalAdmissionHookConfigurationList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::admissionregistration::v1alpha1::ExternalAdmissionHookConfiguration>> = None;
