...
pub struct RoleBindingList {
    ...
    pub items: Vec<crate::api::rbac::v1alpha1::RoleBinding>,
...
impl crate::Resource for RoleBindingList {
    ...
    const KIND: &'static str = "RoleBindingList";
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::rbac::v1alpha1::RoleBinding>> = None;
