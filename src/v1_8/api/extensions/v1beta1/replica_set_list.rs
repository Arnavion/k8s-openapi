...
pub struct ReplicaSetList {
    ...
    pub items: Vec<crate::api::extensions::v1beta1::ReplicaSet>,
...
impl crate::Resource for ReplicaSetList {
    ...
    const KIND: &'static str = "ReplicaSetList";
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::extensions::v1beta1::ReplicaSet>> = None;
