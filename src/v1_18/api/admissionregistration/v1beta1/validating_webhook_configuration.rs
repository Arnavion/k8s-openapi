...
impl ValidatingWebhookConfiguration  {
    ...
    /// Set [`Self::webhooks`]
    pub  fn webhooks_set(&mut self, webhooks: impl Into<Option<Vec<crate::api::admissionregistration::v1beta1::ValidatingWebhook>>>) -> &mut Self {
        self.webhooks = webhooks.into(); self
    }

    pub  fn webhooks(&mut self) -> &mut Vec<crate::api::admissionregistration::v1beta1::ValidatingWebhook> {
    ...
    pub  fn webhooks_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::admissionregistration::v1beta1::ValidatingWebhook>)) -> &mut Self {
        if self.webhooks.is_none() { self.webhooks = Some(Default::default()) };
    ...
    pub  fn webhooks_push_with(&mut self, func: impl FnOnce(&mut crate::api::admissionregistration::v1beta1::ValidatingWebhook)) -> &mut Self {
    ...
    pub  fn webhooks_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::admissionregistration::v1beta1::ValidatingWebhook]>) -> &mut Self {
