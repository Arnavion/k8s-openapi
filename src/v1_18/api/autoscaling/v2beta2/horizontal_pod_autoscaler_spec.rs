...
impl HorizontalPodAutoscalerSpec  {
    /// Set [`Self::behavior`]
    pub  fn behavior_set(&mut self, behavior: impl Into<Option<crate::api::autoscaling::v2beta2::HorizontalPodAutoscalerBehavior>>) -> &mut Self {
        self.behavior = behavior.into(); self
    }

    pub  fn behavior(&mut self) -> &mut crate::api::autoscaling::v2beta2::HorizontalPodAutoscalerBehavior {
        if self.behavior.is_none() { self.behavior = Some(Default::default()) }
        self.behavior.as_mut().unwrap()
    }

    /// Modify [`Self::behavior`] with a `func`
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn behavior_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2beta2::HorizontalPodAutoscalerBehavior)) -> &mut Self {
        if self.behavior.is_none() { self.behavior = Some(Default::default()) };
        func(self.behavior.as_mut().unwrap()); self
    }
    ...
    /// Set [`Self::metrics`]
    pub  fn metrics_set(&mut self, metrics: impl Into<Option<Vec<crate::api::autoscaling::v2beta2::MetricSpec>>>) -> &mut Self {
        self.metrics = metrics.into(); self
    }

    pub  fn metrics(&mut self) -> &mut Vec<crate::api::autoscaling::v2beta2::MetricSpec> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn metrics_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::autoscaling::v2beta2::MetricSpec>)) -> &mut Self {
        if self.metrics.is_none() { self.metrics = Some(Default::default()) };
    ...
    pub  fn metrics_push_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2beta2::MetricSpec)) -> &mut Self {
    ...
    pub  fn metrics_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::autoscaling::v2beta2::MetricSpec]>) -> &mut Self {
    ...
    pub  fn scale_target_ref_set(&mut self, scale_target_ref: impl Into<crate::api::autoscaling::v2beta2::CrossVersionObjectReference>) -> &mut Self {
        self.scale_target_ref = scale_target_ref.into(); self
    }

    pub  fn scale_target_ref(&mut self) -> &mut crate::api::autoscaling::v2beta2::CrossVersionObjectReference {
        &mut self.scale_target_ref
    }

    /// Modify [`Self::scale_target_ref`] with a `func`
    pub  fn scale_target_ref_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2beta2::CrossVersionObjectReference)) -> &mut Self {
