...
impl HorizontalPodAutoscalerBehavior  {
    /// Set [`Self::scale_down`]
    pub  fn scale_down_set(&mut self, scale_down: impl Into<Option<crate::api::autoscaling::v2beta2::HPAScalingRules>>) -> &mut Self {
        self.scale_down = scale_down.into(); self
    }

    pub  fn scale_down(&mut self) -> &mut crate::api::autoscaling::v2beta2::HPAScalingRules {
    ...
    pub  fn scale_down_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2beta2::HPAScalingRules)) -> &mut Self {
        if self.scale_down.is_none() { self.scale_down = Some(Default::default()) };
    ...
    /// Set [`Self::scale_up`]
    pub  fn scale_up_set(&mut self, scale_up: impl Into<Option<crate::api::autoscaling::v2beta2::HPAScalingRules>>) -> &mut Self {
        self.scale_up = scale_up.into(); self
    }

    pub  fn scale_up(&mut self) -> &mut crate::api::autoscaling::v2beta2::HPAScalingRules {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn scale_up_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2beta2::HPAScalingRules)) -> &mut Self {
        if self.scale_up.is_none() { self.scale_up = Some(Default::default()) };
