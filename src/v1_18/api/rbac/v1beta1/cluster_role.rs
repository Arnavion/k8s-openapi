...
impl ClusterRole  {
    ...
    pub  fn aggregation_rule_set(&mut self, aggregation_rule: impl Into<Option<crate::api::rbac::v1beta1::AggregationRule>>) -> &mut Self {
        self.aggregation_rule = aggregation_rule.into(); self
    }

    pub  fn aggregation_rule(&mut self) -> &mut crate::api::rbac::v1beta1::AggregationRule {
    ...
    pub  fn aggregation_rule_with(&mut self, func: impl FnOnce(&mut crate::api::rbac::v1beta1::AggregationRule)) -> &mut Self {
        if self.aggregation_rule.is_none() { self.aggregation_rule = Some(Default::default()) };
