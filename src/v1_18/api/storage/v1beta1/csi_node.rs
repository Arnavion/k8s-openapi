    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::storage::v1beta1::CSINodeSpec::schema(), serde_json::json!({"description": "spec is the specification of CSINode"}))
          },
          "required": [
            "metadata",
            "spec"
