...
impl VolumeAttachmentSpec  {
    ...
    /// Set [`Self::source`]
    pub  fn source_set(&mut self, source: impl Into<crate::api::storage::v1alpha1::VolumeAttachmentSource>) -> &mut Self {
        self.source = source.into(); self
    }

    pub  fn source(&mut self) -> &mut crate::api::storage::v1alpha1::VolumeAttachmentSource {
        &mut self.source
    }

    /// Modify [`Self::source`] with a `func`
    pub  fn source_with(&mut self, func: impl FnOnce(&mut crate::api::storage::v1alpha1::VolumeAttachmentSource)) -> &mut Self {
