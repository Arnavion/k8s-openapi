...
impl crate::Schema for VolumeAttachmentStatus {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "attachError": crate::schema_ref_with_description(crate::api::storage::v1::VolumeError::schema(), "The last error encountered during attach operation, if any. This field must only be set by the entity completing the attach operation, i.e. the external-attacher."),
            "attached": {
            ...
            "detachError": crate::schema_ref_with_description(crate::api::storage::v1::VolumeError::schema(), "The last error encountered during detach operation, if any. This field must only be set by the entity completing the detach operation, i.e. the external-attacher.")
          },
          "required": [
            "attached"
          ],
