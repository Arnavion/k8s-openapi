...
impl crate::Schema for DeploymentStrategy {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "rollingUpdate": crate::schema_ref_with_values(crate::api::apps::v1::RollingUpdateDeployment::schema(), serde_json::json!({"description": "Rolling update config params. Present only if DeploymentStrategyType = RollingUpdate."})),
            "type": {
