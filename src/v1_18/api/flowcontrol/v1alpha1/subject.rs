...
impl Subject  {
    /// Set [`Self::group`]
    pub  fn group_set(&mut self, group: impl Into<Option<crate::api::flowcontrol::v1alpha1::GroupSubject>>) -> &mut Self {
        self.group = group.into(); self
    }

    pub  fn group(&mut self) -> &mut crate::api::flowcontrol::v1alpha1::GroupSubject {
    ...
    pub  fn group_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::GroupSubject)) -> &mut Self {
        if self.group.is_none() { self.group = Some(Default::default()) };
    ...
    pub  fn service_account_set(&mut self, service_account: impl Into<Option<crate::api::flowcontrol::v1alpha1::ServiceAccountSubject>>) -> &mut Self {
        self.service_account = service_account.into(); self
    }

    pub  fn service_account(&mut self) -> &mut crate::api::flowcontrol::v1alpha1::ServiceAccountSubject {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn service_account_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::ServiceAccountSubject)) -> &mut Self {
        if self.service_account.is_none() { self.service_account = Some(Default::default()) };
    ...
    /// Set [`Self::user`]
    pub  fn user_set(&mut self, user: impl Into<Option<crate::api::flowcontrol::v1alpha1::UserSubject>>) -> &mut Self {
        self.user = user.into(); self
    }

    pub  fn user(&mut self) -> &mut crate::api::flowcontrol::v1alpha1::UserSubject {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn user_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::UserSubject)) -> &mut Self {
        if self.user.is_none() { self.user = Some(Default::default()) };
