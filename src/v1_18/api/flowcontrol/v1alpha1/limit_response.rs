...
impl LimitResponse  {
    /// Set [`Self::queuing`]
    pub  fn queuing_set(&mut self, queuing: impl Into<Option<crate::api::flowcontrol::v1alpha1::QueuingConfiguration>>) -> &mut Self {
        self.queuing = queuing.into(); self
    }

    pub  fn queuing(&mut self) -> &mut crate::api::flowcontrol::v1alpha1::QueuingConfiguration {
    ...
    pub  fn queuing_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::QueuingConfiguration)) -> &mut Self {
        if self.queuing.is_none() { self.queuing = Some(Default::default()) };
