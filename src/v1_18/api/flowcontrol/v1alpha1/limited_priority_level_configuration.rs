...
impl LimitedPriorityLevelConfiguration  {
    ...
    pub  fn limit_response_set(&mut self, limit_response: impl Into<Option<crate::api::flowcontrol::v1alpha1::LimitResponse>>) -> &mut Self {
        self.limit_response = limit_response.into(); self
    }

    pub  fn limit_response(&mut self) -> &mut crate::api::flowcontrol::v1alpha1::LimitResponse {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn limit_response_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::LimitResponse)) -> &mut Self {
        if self.limit_response.is_none() { self.limit_response = Some(Default::default()) };
