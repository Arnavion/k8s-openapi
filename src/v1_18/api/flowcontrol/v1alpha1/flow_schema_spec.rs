...
impl FlowSchemaSpec  {
    ...
    pub  fn distinguisher_method_set(&mut self, distinguisher_method: impl Into<Option<crate::api::flowcontrol::v1alpha1::FlowDistinguisherMethod>>) -> &mut Self {
        self.distinguisher_method = distinguisher_method.into(); self
    }

    pub  fn distinguisher_method(&mut self) -> &mut crate::api::flowcontrol::v1alpha1::FlowDistinguisherMethod {
    ...
    pub  fn distinguisher_method_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::FlowDistinguisherMethod)) -> &mut Self {
        if self.distinguisher_method.is_none() { self.distinguisher_method = Some(Default::default()) };
    ...
    pub  fn priority_level_configuration_set(&mut self, priority_level_configuration: impl Into<crate::api::flowcontrol::v1alpha1::PriorityLevelConfigurationReference>) -> &mut Self {
        self.priority_level_configuration = priority_level_configuration.into(); self
    }

    pub  fn priority_level_configuration(&mut self) -> &mut crate::api::flowcontrol::v1alpha1::PriorityLevelConfigurationReference {
        &mut self.priority_level_configuration
    }

    /// Modify [`Self::priority_level_configuration`] with a `func`
    pub  fn priority_level_configuration_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::PriorityLevelConfigurationReference)) -> &mut Self {
        func(&mut self.priority_level_configuration); self
    }


    /// Set [`Self::rules`]
    pub  fn rules_set(&mut self, rules: impl Into<Option<Vec<crate::api::flowcontrol::v1alpha1::PolicyRulesWithSubjects>>>) -> &mut Self {
        self.rules = rules.into(); self
    }

    pub  fn rules(&mut self) -> &mut Vec<crate::api::flowcontrol::v1alpha1::PolicyRulesWithSubjects> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn rules_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::flowcontrol::v1alpha1::PolicyRulesWithSubjects>)) -> &mut Self {
        if self.rules.is_none() { self.rules = Some(Default::default()) };
    ...
    pub  fn rules_push_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::PolicyRulesWithSubjects)) -> &mut Self {
    ...
    pub  fn rules_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::flowcontrol::v1alpha1::PolicyRulesWithSubjects]>) -> &mut Self {
