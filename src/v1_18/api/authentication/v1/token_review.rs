    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::api::authentication::v1::TokenReviewSpec::schema(), "Spec holds information about the request being evaluated"),
            "status": crate::schema_ref_with_description(crate::api::authentication::v1::TokenReviewStatus::schema(), "Status is filled in by the server and indicates whether the request can be authenticated.")
          },
          "required": [
            "metadata",
            "spec"
