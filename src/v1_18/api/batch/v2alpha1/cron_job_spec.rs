...
impl CronJobSpec  {
    ...
    pub  fn job_template_set(&mut self, job_template: impl Into<crate::api::batch::v2alpha1::JobTemplateSpec>) -> &mut Self {
        self.job_template = job_template.into(); self
    }

    pub  fn job_template(&mut self) -> &mut crate::api::batch::v2alpha1::JobTemplateSpec {
        &mut self.job_template
    }

    /// Modify [`Self::job_template`] with a `func`
    pub  fn job_template_with(&mut self, func: impl FnOnce(&mut crate::api::batch::v2alpha1::JobTemplateSpec)) -> &mut Self {
