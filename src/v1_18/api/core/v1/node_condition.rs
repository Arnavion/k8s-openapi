...
impl NodeCondition  {
    ...
    pub  fn last_heartbeat_time_set(&mut self, last_heartbeat_time: impl Into<Option<crate::apimachinery::pkg::apis::meta::v1::Time>>) -> &mut Self {
        self.last_heartbeat_time = last_heartbeat_time.into(); self
    }
