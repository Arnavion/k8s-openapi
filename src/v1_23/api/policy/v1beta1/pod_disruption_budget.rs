...
impl PodDisruptionBudget  {
    ...
    /// Set [`Self::spec`]
    pub  fn spec_set(&mut self, spec: impl Into<Option<crate::api::policy::v1beta1::PodDisruptionBudgetSpec>>) -> &mut Self {
        self.spec = spec.into(); self
    }

    pub  fn spec(&mut self) -> &mut crate::api::policy::v1beta1::PodDisruptionBudgetSpec {
    ...
    pub  fn spec_with(&mut self, func: impl FnOnce(&mut crate::api::policy::v1beta1::PodDisruptionBudgetSpec)) -> &mut Self {
        if self.spec.is_none() { self.spec = Some(Default::default()) };
    ...
    /// Set [`Self::status`]
    pub  fn status_set(&mut self, status: impl Into<Option<crate::api::policy::v1beta1::PodDisruptionBudgetStatus>>) -> &mut Self {
        self.status = status.into(); self
    }

    pub  fn status(&mut self) -> &mut crate::api::policy::v1beta1::PodDisruptionBudgetStatus {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn status_with(&mut self, func: impl FnOnce(&mut crate::api::policy::v1beta1::PodDisruptionBudgetStatus)) -> &mut Self {
        if self.status.is_none() { self.status = Some(Default::default()) };
