...
impl DeploymentStrategy  {
    ...
    pub  fn rolling_update_set(&mut self, rolling_update: impl Into<Option<crate::api::apps::v1::RollingUpdateDeployment>>) -> &mut Self {
        self.rolling_update = rolling_update.into(); self
    }

    pub  fn rolling_update(&mut self) -> &mut crate::api::apps::v1::RollingUpdateDeployment {
    ...
    pub  fn rolling_update_with(&mut self, func: impl FnOnce(&mut crate::api::apps::v1::RollingUpdateDeployment)) -> &mut Self {
        if self.rolling_update.is_none() { self.rolling_update = Some(Default::default()) };
