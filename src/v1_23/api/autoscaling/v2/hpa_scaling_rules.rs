...
impl HPAScalingRules  {
    /// Set [`Self::policies`]
    pub  fn policies_set(&mut self, policies: impl Into<Option<Vec<crate::api::autoscaling::v2::HPAScalingPolicy>>>) -> &mut Self {
        self.policies = policies.into(); self
    }

    pub  fn policies(&mut self) -> &mut Vec<crate::api::autoscaling::v2::HPAScalingPolicy> {
    ...
    pub  fn policies_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::autoscaling::v2::HPAScalingPolicy>)) -> &mut Self {
        if self.policies.is_none() { self.policies = Some(Default::default()) };
    ...
    pub  fn policies_push_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::HPAScalingPolicy)) -> &mut Self {
    ...
    pub  fn policies_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::autoscaling::v2::HPAScalingPolicy]>) -> &mut Self {
