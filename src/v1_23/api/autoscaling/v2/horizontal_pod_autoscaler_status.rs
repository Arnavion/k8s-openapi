...
impl HorizontalPodAutoscalerStatus  {
    /// Set [`Self::conditions`]
    pub  fn conditions_set(&mut self, conditions: impl Into<Option<Vec<crate::api::autoscaling::v2::HorizontalPodAutoscalerCondition>>>) -> &mut Self {
        self.conditions = conditions.into(); self
    }

    pub  fn conditions(&mut self) -> &mut Vec<crate::api::autoscaling::v2::HorizontalPodAutoscalerCondition> {
    ...
    pub  fn conditions_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::autoscaling::v2::HorizontalPodAutoscalerCondition>)) -> &mut Self {
        if self.conditions.is_none() { self.conditions = Some(Default::default()) };
    ...
    pub  fn conditions_push_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::HorizontalPodAutoscalerCondition)) -> &mut Self {
    ...
    pub  fn conditions_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::autoscaling::v2::HorizontalPodAutoscalerCondition]>) -> &mut Self {
    ...
    pub  fn current_metrics_set(&mut self, current_metrics: impl Into<Option<Vec<crate::api::autoscaling::v2::MetricStatus>>>) -> &mut Self {
        self.current_metrics = current_metrics.into(); self
    }

    pub  fn current_metrics(&mut self) -> &mut Vec<crate::api::autoscaling::v2::MetricStatus> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn current_metrics_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::autoscaling::v2::MetricStatus>)) -> &mut Self {
        if self.current_metrics.is_none() { self.current_metrics = Some(Default::default()) };
    ...
    ///
    /// The field will initially set to `Default::default()`
    pub  fn current_metrics_push_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::MetricStatus)) -> &mut Self {
    ...
    pub  fn current_metrics_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::autoscaling::v2::MetricStatus]>) -> &mut Self {
