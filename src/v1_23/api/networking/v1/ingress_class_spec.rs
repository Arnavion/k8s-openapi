...
impl IngressClassSpec  {
    ...
    /// Set [`Self::parameters`]
    pub  fn parameters_set(&mut self, parameters: impl Into<Option<crate::api::networking::v1::IngressClassParametersReference>>) -> &mut Self {
        self.parameters = parameters.into(); self
    }

    pub  fn parameters(&mut self) -> &mut crate::api::networking::v1::IngressClassParametersReference {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn parameters_with(&mut self, func: impl FnOnce(&mut crate::api::networking::v1::IngressClassParametersReference)) -> &mut Self {
        if self.parameters.is_none() { self.parameters = Some(Default::default()) };
