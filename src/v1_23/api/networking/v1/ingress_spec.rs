...
#[cfg(feature = "dsl")]
impl IngressSpec  {
    /// Set [`Self::default_backend`]
    pub  fn default_backend_set(&mut self, default_backend: impl Into<Option<crate::api::networking::v1::IngressBackend>>) -> &mut Self {
        self.default_backend = default_backend.into(); self
    }

    pub  fn default_backend(&mut self) -> &mut crate::api::networking::v1::IngressBackend {
        if self.default_backend.is_none() { self.default_backend = Some(Default::default()) }
        self.default_backend.as_mut().unwrap()
    }

    /// Modify [`Self::default_backend`] with a `func`
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn default_backend_with(&mut self, func: impl FnOnce(&mut crate::api::networking::v1::IngressBackend)) -> &mut Self {
        if self.default_backend.is_none() { self.default_backend = Some(Default::default()) };
        func(self.default_backend.as_mut().unwrap()); self
    }
    ...
    /// Set [`Self::rules`]
    pub  fn rules_set(&mut self, rules: impl Into<Option<Vec<crate::api::networking::v1::IngressRule>>>) -> &mut Self {
        self.rules = rules.into(); self
    }

    pub  fn rules(&mut self) -> &mut Vec<crate::api::networking::v1::IngressRule> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn rules_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::networking::v1::IngressRule>)) -> &mut Self {
        if self.rules.is_none() { self.rules = Some(Default::default()) };
    ...
    pub  fn rules_push_with(&mut self, func: impl FnOnce(&mut crate::api::networking::v1::IngressRule)) -> &mut Self {
    ...
    pub  fn rules_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::networking::v1::IngressRule]>) -> &mut Self {
    ...
    /// Set [`Self::tls`]
    pub  fn tls_set(&mut self, tls: impl Into<Option<Vec<crate::api::networking::v1::IngressTLS>>>) -> &mut Self {
        self.tls = tls.into(); self
    }

    pub  fn tls(&mut self) -> &mut Vec<crate::api::networking::v1::IngressTLS> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn tls_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::networking::v1::IngressTLS>)) -> &mut Self {
        if self.tls.is_none() { self.tls = Some(Default::default()) };
    ...
    ///
    /// The field will initially set to `Default::default()`
    pub  fn tls_push_with(&mut self, func: impl FnOnce(&mut crate::api::networking::v1::IngressTLS)) -> &mut Self {
        if self.tls.is_none() {
            self.tls = Some(vec![]);
        }
        let mut new = Default::default();
    ...
    pub  fn tls_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::networking::v1::IngressTLS]>) -> &mut Self {
