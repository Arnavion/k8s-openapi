...
impl Service  {
    ...
    /// Set [`Self::spec`]
    pub  fn spec_set(&mut self, spec: impl Into<Option<crate::api::core::v1::ServiceSpec>>) -> &mut Self {
        self.spec = spec.into(); self
    }

    pub  fn spec(&mut self) -> &mut crate::api::core::v1::ServiceSpec {
    ...
    pub  fn spec_with(&mut self, func: impl FnOnce(&mut crate::api::core::v1::ServiceSpec)) -> &mut Self {
        if self.spec.is_none() { self.spec = Some(Default::default()) };
    ...
    /// Set [`Self::status`]
    pub  fn status_set(&mut self, status: impl Into<Option<crate::api::core::v1::ServiceStatus>>) -> &mut Self {
        self.status = status.into(); self
    }

    pub  fn status(&mut self) -> &mut crate::api::core::v1::ServiceStatus {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn status_with(&mut self, func: impl FnOnce(&mut crate::api::core::v1::ServiceStatus)) -> &mut Self {
        if self.status.is_none() { self.status = Some(Default::default()) };
