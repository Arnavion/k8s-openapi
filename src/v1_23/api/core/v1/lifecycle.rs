...
impl Lifecycle  {
    /// Set [`Self::post_start`]
    pub  fn post_start_set(&mut self, post_start: impl Into<Option<crate::api::core::v1::LifecycleHandler>>) -> &mut Self {
        self.post_start = post_start.into(); self
    }

    pub  fn post_start(&mut self) -> &mut crate::api::core::v1::LifecycleHandler {
    ...
    pub  fn post_start_with(&mut self, func: impl FnOnce(&mut crate::api::core::v1::LifecycleHandler)) -> &mut Self {
        if self.post_start.is_none() { self.post_start = Some(Default::default()) };
    ...
    /// Set [`Self::pre_stop`]
    pub  fn pre_stop_set(&mut self, pre_stop: impl Into<Option<crate::api::core::v1::LifecycleHandler>>) -> &mut Self {
        self.pre_stop = pre_stop.into(); self
    }

    pub  fn pre_stop(&mut self) -> &mut crate::api::core::v1::LifecycleHandler {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn pre_stop_with(&mut self, func: impl FnOnce(&mut crate::api::core::v1::LifecycleHandler)) -> &mut Self {
        if self.pre_stop.is_none() { self.pre_stop = Some(Default::default()) };
