...
pub struct LabelSelectorAttributes {
    ...
    pub requirements: Option<Vec<crate::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_requirements: Option<Vec<crate::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement>> = None;
...
impl crate::schemars::JsonSchema for LabelSelectorAttributes {
    fn schema_name() -> String {
        "io.k8s.api.authorization.v1.LabelSelectorAttributes".to_owned()
    }
