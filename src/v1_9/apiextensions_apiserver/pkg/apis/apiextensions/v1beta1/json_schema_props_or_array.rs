...
pub enum JSONSchemaPropsOrArray {
    Schema(Box<crate::v1_9::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>),
    Schemas(Vec<crate::v1_9::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>),
}
