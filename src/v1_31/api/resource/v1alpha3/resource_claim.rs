...
impl crate::schemars::JsonSchema for ResourceClaim {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha3.ResourceClaim".to_owned()
    }
                ...
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Spec describes what is being requested and how to configure it. The spec is immutable.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Status describes whether the claim is ready to use and what has been allocated.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
