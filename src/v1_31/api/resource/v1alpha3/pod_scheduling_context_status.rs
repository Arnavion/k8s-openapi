...
pub struct PodSchedulingContextStatus {
    ...
    pub resource_claims: Option<Vec<crate::api::resource::v1alpha3::ResourceClaimSchedulingStatus>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_resource_claims: Option<Vec<crate::api::resource::v1alpha3::ResourceClaimSchedulingStatus>> = None;
...
impl crate::schemars::JsonSchema for PodSchedulingContextStatus {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha3.PodSchedulingContextStatus".to_owned()
    }
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            ...
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(__gen.subschema_for::<crate::api::resource::v1alpha3::ResourceClaimSchedulingStatus>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
