...
impl crate::DeepMerge for ServiceAccount {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::list::map(&mut self.secrets, other.secrets, &[|lhs, rhs| lhs.name == rhs.name], |inner_self, inner_other| {crate::DeepMerge::merge_from(inner_self, inner_other)});
    }
}
