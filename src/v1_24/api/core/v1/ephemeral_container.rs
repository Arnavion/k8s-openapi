...
impl crate::DeepMerge for EphemeralContainer {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::list::map(&mut self.env, other.env, &[|lhs, rhs| lhs.name == rhs.name], |inner_self, inner_other| {crate::DeepMerge::merge_from(inner_self, inner_other)});
        ...
        crate::merge_strategies::list::map(&mut self.ports, other.ports, &[|lhs, rhs| lhs.container_port == rhs.container_port], |inner_self, inner_other| {crate::DeepMerge::merge_from(inner_self, inner_other)});
        ...
        crate::merge_strategies::list::map(&mut self.volume_devices, other.volume_devices, &[|lhs, rhs| lhs.device_path == rhs.device_path], |inner_self, inner_other| {crate::DeepMerge::merge_from(inner_self, inner_other)});
        crate::merge_strategies::list::map(&mut self.volume_mounts, other.volume_mounts, &[|lhs, rhs| lhs.mount_path == rhs.mount_path], |inner_self, inner_other| {crate::DeepMerge::merge_from(inner_self, inner_other)});
