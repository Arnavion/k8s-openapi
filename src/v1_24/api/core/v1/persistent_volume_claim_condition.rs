...
impl PersistentVolumeClaimCondition  {
    /// Set [`Self::last_probe_time`]
    pub  fn last_probe_time_set(&mut self, last_probe_time: impl Into<Option<crate::apimachinery::pkg::apis::meta::v1::Time>>) -> &mut Self {
        self.last_probe_time = last_probe_time.into(); self
    }
