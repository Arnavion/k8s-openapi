...
impl crate::DeepMerge for PersistentVolumeClaimStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::map::granular(&mut self.allocated_resources, other.allocated_resources, |inner_self, inner_other| crate::DeepMerge::merge_from(inner_self, inner_other));
