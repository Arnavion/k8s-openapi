...
impl crate::DeepMerge for Endpoint {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::map::granular(&mut self.deprecated_topology, other.deprecated_topology, |inner_self, inner_other| crate::DeepMerge::merge_from(inner_self, inner_other));
