...
impl MetricStatus  {
    ...
    pub  fn container_resource_set(&mut self, container_resource: impl Into<Option<crate::api::autoscaling::v2::ContainerResourceMetricStatus>>) -> &mut Self {
        self.container_resource = container_resource.into(); self
    }

    pub  fn container_resource(&mut self) -> &mut crate::api::autoscaling::v2::ContainerResourceMetricStatus {
    ...
    pub  fn container_resource_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::ContainerResourceMetricStatus)) -> &mut Self {
        if self.container_resource.is_none() { self.container_resource = Some(Default::default()) };
    ...
    /// Set [`Self::external`]
    pub  fn external_set(&mut self, external: impl Into<Option<crate::api::autoscaling::v2::ExternalMetricStatus>>) -> &mut Self {
        self.external = external.into(); self
    }

    pub  fn external(&mut self) -> &mut crate::api::autoscaling::v2::ExternalMetricStatus {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn external_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::ExternalMetricStatus)) -> &mut Self {
        if self.external.is_none() { self.external = Some(Default::default()) };
    ...
    /// Set [`Self::object`]
    pub  fn object_set(&mut self, object: impl Into<Option<crate::api::autoscaling::v2::ObjectMetricStatus>>) -> &mut Self {
        self.object = object.into(); self
    }

    pub  fn object(&mut self) -> &mut crate::api::autoscaling::v2::ObjectMetricStatus {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn object_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::ObjectMetricStatus)) -> &mut Self {
        if self.object.is_none() { self.object = Some(Default::default()) };
    ...
    /// Set [`Self::pods`]
    pub  fn pods_set(&mut self, pods: impl Into<Option<crate::api::autoscaling::v2::PodsMetricStatus>>) -> &mut Self {
        self.pods = pods.into(); self
    }

    pub  fn pods(&mut self) -> &mut crate::api::autoscaling::v2::PodsMetricStatus {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn pods_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::PodsMetricStatus)) -> &mut Self {
        if self.pods.is_none() { self.pods = Some(Default::default()) };
    ...
    /// Set [`Self::resource`]
    pub  fn resource_set(&mut self, resource: impl Into<Option<crate::api::autoscaling::v2::ResourceMetricStatus>>) -> &mut Self {
        self.resource = resource.into(); self
    }

    pub  fn resource(&mut self) -> &mut crate::api::autoscaling::v2::ResourceMetricStatus {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn resource_with(&mut self, func: impl FnOnce(&mut crate::api::autoscaling::v2::ResourceMetricStatus)) -> &mut Self {
        if self.resource.is_none() { self.resource = Some(Default::default()) };
