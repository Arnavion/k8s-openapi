// Generated from definition io.k8s.apimachinery.pkg.apis.meta.v1.SubObjectMeta

/// ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct SubObjectMeta {
...
impl crate::DeepMerge for SubObjectMeta {
...
impl<'de> crate::serde::Deserialize<'de> for SubObjectMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = SubObjectMeta;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("SubObjectMeta")
            }
...
impl crate::serde::Serialize for SubObjectMeta {
...
impl crate::schemars::JsonSchema for SubObjectMeta {
    fn schema_name() -> String {
        "io.k8s.apimachinery.pkg.apis.meta.v1.SubObjectMeta".to_owned()
    }
