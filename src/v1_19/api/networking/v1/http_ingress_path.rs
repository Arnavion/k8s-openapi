...
impl crate::Schema for HTTPIngressPath {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "backend": crate::schema_ref_with_values(crate::api::networking::v1::IngressBackend::schema(), serde_json::json!({"description": "Backend defines the referenced service endpoint to which the traffic will be forwarded to."})),
            "path": {
