...
impl crate::Schema for HTTPIngressPath {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "backend": crate::schema_ref_with_description(crate::api::networking::v1::IngressBackend::schema(), "Backend defines the referenced service endpoint to which the traffic will be forwarded to."),
            "path": {
