...
impl CSINode  {
    ...
    /// Set [`Self::spec`]
    pub  fn spec_set(&mut self, spec: impl Into<crate::api::storage::v1beta1::CSINodeSpec>) -> &mut Self {
        self.spec = spec.into(); self
    }

    pub  fn spec(&mut self) -> &mut crate::api::storage::v1beta1::CSINodeSpec {
        &mut self.spec
    }

    /// Modify [`Self::spec`] with a `func`
    pub  fn spec_with(&mut self, func: impl FnOnce(&mut crate::api::storage::v1beta1::CSINodeSpec)) -> &mut Self {
