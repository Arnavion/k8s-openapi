...
impl SubjectAccessReview  {
    ...
    /// Set [`Self::spec`]
    pub  fn spec_set(&mut self, spec: impl Into<crate::api::authorization::v1::SubjectAccessReviewSpec>) -> &mut Self {
        self.spec = spec.into(); self
    }

    pub  fn spec(&mut self) -> &mut crate::api::authorization::v1::SubjectAccessReviewSpec {
        &mut self.spec
    }

    /// Modify [`Self::spec`] with a `func`
    pub  fn spec_with(&mut self, func: impl FnOnce(&mut crate::api::authorization::v1::SubjectAccessReviewSpec)) -> &mut Self {
