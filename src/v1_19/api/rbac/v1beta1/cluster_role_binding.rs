...
impl ClusterRoleBinding  {
    ...
    /// Set [`Self::role_ref`]
    pub  fn role_ref_set(&mut self, role_ref: impl Into<crate::api::rbac::v1beta1::RoleRef>) -> &mut Self {
        self.role_ref = role_ref.into(); self
    }

    pub  fn role_ref(&mut self) -> &mut crate::api::rbac::v1beta1::RoleRef {
        &mut self.role_ref
    }

    /// Modify [`Self::role_ref`] with a `func`
    pub  fn role_ref_with(&mut self, func: impl FnOnce(&mut crate::api::rbac::v1beta1::RoleRef)) -> &mut Self {
        func(&mut self.role_ref); self
    }


    /// Set [`Self::subjects`]
    pub  fn subjects_set(&mut self, subjects: impl Into<Option<Vec<crate::api::rbac::v1beta1::Subject>>>) -> &mut Self {
        self.subjects = subjects.into(); self
    }

    pub  fn subjects(&mut self) -> &mut Vec<crate::api::rbac::v1beta1::Subject> {
    ...
    pub  fn subjects_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::rbac::v1beta1::Subject>)) -> &mut Self {
        if self.subjects.is_none() { self.subjects = Some(Default::default()) };
    ...
    pub  fn subjects_push_with(&mut self, func: impl FnOnce(&mut crate::api::rbac::v1beta1::Subject)) -> &mut Self {
    ...
    pub  fn subjects_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::rbac::v1beta1::Subject]>) -> &mut Self {
