    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "jobTemplate": crate::schema_ref_with_description(crate::api::batch::v2alpha1::JobTemplateSpec::schema(), "Specifies the job that will be created when executing a CronJob."),
            "schedule": {
