    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::api::extensions::v1beta1::IngressSpec::schema(), "Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"),
            "status": crate::schema_ref_with_description(crate::api::extensions::v1beta1::IngressStatus::schema(), "Status is the current state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")
          },
          "required": [
            "metadata"
          ],
