...
impl crate::Schema for CSIPersistentVolumeSource {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "controllerExpandSecretRef": crate::schema_ref_with_values(crate::api::core::v1::SecretReference::schema(), serde_json::json!({"description": "ControllerExpandSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI ControllerExpandVolume call. This is an alpha field and requires enabling ExpandCSIVolumes feature gate. This field is optional, and may be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed."})),
