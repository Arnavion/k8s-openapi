        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_seq<A>(self, mut seq: A) -> Result<Self::Value, A::Error> where A: serde::de::SeqAccess<'de> {
                Ok(PodSecurityContext {
                    ...
                    fs_group_change_policy: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("fs_group_change_policy"))?,
                    ...
                    seccomp_profile: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("seccomp_profile"))?,
...
impl serde::Serialize for PodSecurityContext {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.fs_group_change_policy {
            serde::ser::SerializeStruct::serialize_field(&mut state, "fsGroupChangePolicy", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "fsGroupChangePolicy")?;
        }
        ...
        if let Some(value) = &self.seccomp_profile {
            serde::ser::SerializeStruct::serialize_field(&mut state, "seccompProfile", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "seccompProfile")?;
        }
