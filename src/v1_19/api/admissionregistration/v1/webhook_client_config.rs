...
impl WebhookClientConfig  {
    ...
    /// Set [`Self::service`]
    pub  fn service_set(&mut self, service: impl Into<Option<crate::api::admissionregistration::v1::ServiceReference>>) -> &mut Self {
        self.service = service.into(); self
    }

    pub  fn service(&mut self) -> &mut crate::api::admissionregistration::v1::ServiceReference {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn service_with(&mut self, func: impl FnOnce(&mut crate::api::admissionregistration::v1::ServiceReference)) -> &mut Self {
        if self.service.is_none() { self.service = Some(Default::default()) };
