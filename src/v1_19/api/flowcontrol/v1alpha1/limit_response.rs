...
impl crate::Schema for LimitResponse {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "queuing": crate::schema_ref_with_description(crate::api::flowcontrol::v1alpha1::QueuingConfiguration::schema(), "`queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `\"Queue\"`."),
            "type": {
