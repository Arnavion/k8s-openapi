...
impl PolicyRulesWithSubjects  {
    ...
    pub  fn non_resource_rules_set(&mut self, non_resource_rules: impl Into<Option<Vec<crate::api::flowcontrol::v1alpha1::NonResourcePolicyRule>>>) -> &mut Self {
        self.non_resource_rules = non_resource_rules.into(); self
    }

    pub  fn non_resource_rules(&mut self) -> &mut Vec<crate::api::flowcontrol::v1alpha1::NonResourcePolicyRule> {
    ...
    pub  fn non_resource_rules_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::flowcontrol::v1alpha1::NonResourcePolicyRule>)) -> &mut Self {
        if self.non_resource_rules.is_none() { self.non_resource_rules = Some(Default::default()) };
    ...
    pub  fn non_resource_rules_push_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::NonResourcePolicyRule)) -> &mut Self {
    ...
    pub  fn non_resource_rules_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::flowcontrol::v1alpha1::NonResourcePolicyRule]>) -> &mut Self {
    ...
    pub  fn resource_rules_set(&mut self, resource_rules: impl Into<Option<Vec<crate::api::flowcontrol::v1alpha1::ResourcePolicyRule>>>) -> &mut Self {
        self.resource_rules = resource_rules.into(); self
    }

    pub  fn resource_rules(&mut self) -> &mut Vec<crate::api::flowcontrol::v1alpha1::ResourcePolicyRule> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn resource_rules_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::flowcontrol::v1alpha1::ResourcePolicyRule>)) -> &mut Self {
        if self.resource_rules.is_none() { self.resource_rules = Some(Default::default()) };
    ...
    ///
    /// The field will initially set to `Default::default()`
    pub  fn resource_rules_push_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::ResourcePolicyRule)) -> &mut Self {
    ...
    pub  fn resource_rules_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::flowcontrol::v1alpha1::ResourcePolicyRule]>) -> &mut Self {
    ...
    /// Set [`Self::subjects`]
    pub  fn subjects_set(&mut self, subjects: impl Into<Vec<crate::api::flowcontrol::v1alpha1::Subject>>) -> &mut Self {
        self.subjects = subjects.into(); self
    }

    pub  fn subjects(&mut self) -> &mut Vec<crate::api::flowcontrol::v1alpha1::Subject> {
        &mut self.subjects
    }

    /// Modify [`Self::subjects`] with a `func`
    pub  fn subjects_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::flowcontrol::v1alpha1::Subject>)) -> &mut Self {
    ...
    ///
    /// The field will initially set to `Default::default()`
    pub  fn subjects_push_with(&mut self, func: impl FnOnce(&mut crate::api::flowcontrol::v1alpha1::Subject)) -> &mut Self {
      let mut new = Default::default();
      func(&mut new);
    ...
    pub  fn subjects_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::flowcontrol::v1alpha1::Subject]>) -> &mut Self {
         for item in other.borrow() {
