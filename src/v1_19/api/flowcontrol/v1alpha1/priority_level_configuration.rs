    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::flowcontrol::v1alpha1::PriorityLevelConfigurationSpec::schema(), serde_json::json!({"description": "`spec` is the specification of the desired behavior of a \"request-priority\". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"})),
            "status": crate::schema_ref_with_values(crate::api::flowcontrol::v1alpha1::PriorityLevelConfigurationStatus::schema(), serde_json::json!({"description": "`status` is the current status of a \"request-priority\". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"}))
          },
          "required": [
            "metadata"
          ],
