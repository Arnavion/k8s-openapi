...
impl CustomResourceValidation  {
    ...
    pub  fn open_api_v3_schema_set(&mut self, open_api_v3_schema: impl Into<Option<crate::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>>) -> &mut Self {
        self.open_api_v3_schema = open_api_v3_schema.into(); self
    }

    pub  fn open_api_v3_schema(&mut self) -> &mut crate::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps {
    ...
    pub  fn open_api_v3_schema_with(&mut self, func: impl FnOnce(&mut crate::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps)) -> &mut Self {
        if self.open_api_v3_schema.is_none() { self.open_api_v3_schema = Some(Default::default()) };
