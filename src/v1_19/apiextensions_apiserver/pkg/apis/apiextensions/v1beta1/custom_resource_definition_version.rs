        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_seq<A>(self, mut seq: A) -> Result<Self::Value, A::Error> where A: serde::de::SeqAccess<'de> {
                Ok(CustomResourceDefinitionVersion {
                    ...
                    deprecated: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("deprecated"))?,
                    deprecation_warning: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("deprecation_warning"))?,
...
impl serde::Serialize for CustomResourceDefinitionVersion {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.deprecated {
            serde::ser::SerializeStruct::serialize_field(&mut state, "deprecated", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "deprecated")?;
        }
        if let Some(value) = &self.deprecation_warning {
            serde::ser::SerializeStruct::serialize_field(&mut state, "deprecationWarning", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "deprecationWarning")?;
        }
