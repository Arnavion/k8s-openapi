    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec::schema(), "spec describes how the user wants the resources to appear"),
            "status": crate::schema_ref_with_description(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionStatus::schema(), "status indicates the actual state of the CustomResourceDefinition")
          },
          "required": [
            "metadata",
            "spec"
