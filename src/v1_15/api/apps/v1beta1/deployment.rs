    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::api::apps::v1beta1::DeploymentSpec::schema(), "Specification of the desired behavior of the Deployment."),
            "status": crate::schema_ref_with_description(crate::api::apps::v1beta1::DeploymentStatus::schema(), "Most recently observed status of the Deployment.")
          },
          "required": [
            "metadata"
          ],
