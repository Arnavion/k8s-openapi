    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "status": crate::schema_ref_with_description(crate::api::core::v1::PodStatus::schema(), "Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status")
          },
          "required": [
            "metadata"
          ],
