...
pub struct HorizontalPodAutoscalerSpec {
    ...
    pub metrics: Vec<crate::api::autoscaling::v2beta1::MetricSpec>,
        ...
        serde_json::json!({
          ...
          "properties": {
            ...
            "metrics": {
              ...
              "items": crate::api::autoscaling::v2beta1::MetricSpec::schema(),
              "type": "array"
            },
            "minReplicas": {
            ...
            "scaleTargetRef": crate::schema_ref_with_values(crate::api::autoscaling::v2beta1::CrossVersionObjectReference::schema(), serde_json::json!({"description": "scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count."}))
          },
          "required": [
            "maxReplicas",
            "scaleTargetRef"
