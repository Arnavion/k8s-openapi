...
pub struct ObjectMetricStatus {
    ...
    pub current: crate::v1_15::api::autoscaling::v2beta2::MetricValueStatus,

    pub described_object: crate::v1_15::api::autoscaling::v2beta2::CrossVersionObjectReference,

    /// metric identifies the target metric by name and selector
    pub metric: crate::v1_15::api::autoscaling::v2beta2::MetricIdentifier,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_current: Option<crate::v1_15::api::autoscaling::v2beta2::MetricValueStatus> = None;
                let mut value_described_object: Option<crate::v1_15::api::autoscaling::v2beta2::CrossVersionObjectReference> = None;
                let mut value_metric: Option<crate::v1_15::api::autoscaling::v2beta2::MetricIdentifier> = None;
