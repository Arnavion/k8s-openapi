    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::api::authorization::v1::SubjectAccessReviewSpec::schema(), "Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted."),
            "status": crate::schema_ref_with_description(crate::api::authorization::v1::SubjectAccessReviewStatus::schema(), "Status is filled in by the server and indicates whether the request is allowed or not")
          },
          "required": [
            "metadata",
            "spec"
