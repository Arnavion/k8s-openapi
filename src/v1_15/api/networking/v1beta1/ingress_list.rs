// Generated from definition io.k8s.api.networking.v1beta1.IngressList

/// IngressList is a collection of Ingress.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct IngressList {
    /// Items is the list of Ingress.
    pub items: Vec<crate::v1_15::api::networking::v1beta1::Ingress>,

    /// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<crate::v1_15::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for IngressList {
...
impl crate::Metadata for IngressList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::v1_15::api::networking::v1beta1::Ingress>> = None;
