...
pub enum CreateNamespacedIngressResponse {
    ...
    Created(crate::api::networking::v1beta1::Ingress),
    Accepted(crate::api::networking::v1beta1::Ingress),
...
pub enum DeleteCollectionNamespacedIngressResponse {
    ...
    OkValue(crate::List<crate::api::networking::v1beta1::Ingress>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
...
pub enum DeleteNamespacedIngressResponse {
    OkStatus(crate::apimachinery::pkg::apis::meta::v1::Status),
    OkValue(crate::api::networking::v1beta1::Ingress),
...
pub enum ListIngressForAllNamespacesResponse {
    Ok(crate::List<crate::api::networking::v1beta1::Ingress>),
    Other(Result<Option<serde_json::Value>, serde_json::Error>),
}
