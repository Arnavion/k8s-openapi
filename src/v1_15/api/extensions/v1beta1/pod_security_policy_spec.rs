        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_seq<A>(self, mut seq: A) -> Result<Self::Value, A::Error> where A: serde::de::SeqAccess<'de> {
                Ok(PodSecurityPolicySpec {
                    ...
                    allowed_csi_drivers: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("allowed_csi_drivers"))?,
                    ...
                    runtime_class: serde::de::SeqAccess::next_element(&mut seq)?.ok_or_else(|| serde::de::Error::missing_field("runtime_class"))?,
...
impl serde::Serialize for PodSecurityPolicySpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.allowed_csi_drivers {
            serde::ser::SerializeStruct::serialize_field(&mut state, "allowedCSIDrivers", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "allowedCSIDrivers")?;
        }
        ...
        if let Some(value) = &self.runtime_class {
            serde::ser::SerializeStruct::serialize_field(&mut state, "runtimeClass", &Some(value))?;
        }
        else {
            serde::ser::SerializeStruct::skip_field(&mut state, "runtimeClass")?;
        }
