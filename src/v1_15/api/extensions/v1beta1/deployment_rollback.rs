    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "rollbackTo": crate::schema_ref_with_values(crate::api::extensions::v1beta1::RollbackConfig::schema(), serde_json::json!({"description": "The config of this deployment rollback."})),
            "updatedAnnotations": {
