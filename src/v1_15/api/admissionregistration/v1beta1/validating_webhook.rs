    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "clientConfig": crate::schema_ref_with_values(crate::api::admissionregistration::v1beta1::WebhookClientConfig::schema(), serde_json::json!({"description": "ClientConfig defines how to communicate with the hook. Required"})),
            "failurePolicy": {
