    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceSpec::schema(), serde_json::json!({"description": "Spec contains information for locating and communicating with a server"})),
            "status": crate::schema_ref_with_values(crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceStatus::schema(), serde_json::json!({"description": "Status contains derived information about an API server"}))
          },
          "required": [
            "metadata"
          ],
