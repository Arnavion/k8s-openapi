...
pub enum WatchEvent<T> {
    ...
    Modified(T),
    Bookmark(T),
    ErrorStatus(crate::v1_15::apimachinery::pkg::apis::meta::v1::Status),
    ErrorOther(crate::v1_15::apimachinery::pkg::runtime::RawExtension),
}
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                Ok(match value_type {
                    ...
                    WatchEventType::Bookmark => {
                        let value_object = serde_value::ValueDeserializer::new(value_object);
                        WatchEvent::Bookmark(serde::Deserialize::deserialize(value_object)?)
                    },
