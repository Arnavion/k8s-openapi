...
pub struct APIServiceList {
    pub items: Vec<crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIService>,
...
impl crate::Resource for APIServiceList {
    ...
    const KIND: &'static str = "APIServiceList";
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIService>> = None;
