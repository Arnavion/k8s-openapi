...
pub struct APIServiceSpec {
    ...
    pub service: crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::ServiceReference,
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: std::array::IntoIter::new([
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate.".to_owned()),
                                ..Default::default()
                            })),
