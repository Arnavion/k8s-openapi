    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "source": crate::schema_ref_with_values(crate::api::storage::v1alpha1::VolumeAttachmentSource::schema(), serde_json::json!({"description": "Source represents the volume that should be attached."}))
          },
          "required": [
            "attacher",
            "nodeName",
