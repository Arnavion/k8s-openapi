    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_description(crate::api::extensions::v1beta1::ScaleSpec::schema(), "defines the behavior of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status."),
            "status": crate::schema_ref_with_description(crate::api::extensions::v1beta1::ScaleStatus::schema(), "current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.")
          },
          "required": [
            "metadata"
          ],
