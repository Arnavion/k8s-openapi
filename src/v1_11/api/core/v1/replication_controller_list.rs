...
pub struct ReplicationControllerList {
    ...
    pub items: Vec<crate::api::core::v1::ReplicationController>,
...
impl crate::Resource for ReplicationControllerList {
    ...
    const KIND: &'static str = "ReplicationControllerList";
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::core::v1::ReplicationController>> = None;
