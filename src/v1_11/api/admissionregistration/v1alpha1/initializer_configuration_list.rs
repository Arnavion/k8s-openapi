...
pub struct InitializerConfigurationList {
    ...
    pub items: Vec<crate::api::admissionregistration::v1alpha1::InitializerConfiguration>,
...
impl crate::Resource for InitializerConfigurationList {
    ...
    const KIND: &'static str = "InitializerConfigurationList";
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::api::admissionregistration::v1alpha1::InitializerConfiguration>> = None;
