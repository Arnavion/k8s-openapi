...
pub struct SubjectRulesReviewStatus {
    ...
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::authorization::v1::NonResourceRule>::new"))]
    pub non_resource_rules: Vec<crate::api::authorization::v1::NonResourceRule>,

    /// ResourceRules is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
    #[cfg_attr(feature = "schema", schemars(default = "Vec::<crate::api::authorization::v1::ResourceRule>::new"))]
