...
pub struct DaemonSetSpec {
    ...
    pub update_strategy: Option<crate::api::apps::v1beta2::DaemonSetUpdateStrategy>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_update_strategy: Option<crate::api::apps::v1beta2::DaemonSetUpdateStrategy> = None;
    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "updateStrategy": crate::schema_ref_with_values(crate::api::apps::v1beta2::DaemonSetUpdateStrategy::schema(), serde_json::json!({"description": "An update strategy to replace existing DaemonSet pods with new pods."}))
          },
          "required": [
            "selector",
            "template"
