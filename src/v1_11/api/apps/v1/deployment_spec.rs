    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "strategy": crate::schema_ref_with_values(crate::api::apps::v1::DeploymentStrategy::schema(), serde_json::json!({"description": "The deployment strategy to use to replace existing pods with new ones."})),
