// Generated from definition io.k8s.apimachinery.pkg.apis.meta.v1.ClusterObjectMeta
...
impl crate::DeepMerge for ClusterObjectMeta {
...
impl<'de> crate::serde::Deserialize<'de> for ClusterObjectMeta {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = ClusterObjectMeta;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("ClusterObjectMeta")
            }
...
impl crate::serde::Serialize for ClusterObjectMeta {
...
impl crate::schemars::JsonSchema for ClusterObjectMeta {
    fn schema_name() -> String {
        "io.k8s.apimachinery.pkg.apis.meta.v1.ClusterObjectMeta".to_owned()
    }
