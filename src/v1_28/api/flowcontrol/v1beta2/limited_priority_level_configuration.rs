...
impl crate::schemars::JsonSchema for LimitedPriorityLevelConfiguration {
    fn schema_name() -> std::string::String {
        "io.k8s.api.flowcontrol.v1beta2.LimitedPriorityLevelConfiguration".into()
    }
