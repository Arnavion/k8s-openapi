...
pub struct FlowSchemaSpec {
    ...
    pub rules: Option<std::vec::Vec<crate::api::flowcontrol::v1beta2::PolicyRulesWithSubjects>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_rules: Option<std::vec::Vec<crate::api::flowcontrol::v1beta2::PolicyRulesWithSubjects>> = None;
...
impl crate::schemars::JsonSchema for FlowSchemaSpec {
    fn schema_name() -> std::string::String {
        "io.k8s.api.flowcontrol.v1beta2.FlowSchemaSpec".into()
    }
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            ...
                            array: Some(std::boxed::Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(std::boxed::Box::new(__gen.subschema_for::<crate::api::flowcontrol::v1beta2::PolicyRulesWithSubjects>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
