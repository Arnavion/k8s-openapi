    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec::schema(), serde_json::json!({"description": "spec describes how the user wants the resources to appear"})),
            "status": crate::schema_ref_with_values(crate::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionStatus::schema(), serde_json::json!({"description": "status indicates the actual state of the CustomResourceDefinition"}))
          },
          "required": [
            "metadata",
            "spec"
