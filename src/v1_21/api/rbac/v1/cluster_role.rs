...
impl ClusterRole  {
    ...
    pub  fn aggregation_rule_set(&mut self, aggregation_rule: impl Into<Option<crate::api::rbac::v1::AggregationRule>>) -> &mut Self {
        self.aggregation_rule = aggregation_rule.into(); self
    }

    pub  fn aggregation_rule(&mut self) -> &mut crate::api::rbac::v1::AggregationRule {
    ...
    pub  fn aggregation_rule_with(&mut self, func: impl FnOnce(&mut crate::api::rbac::v1::AggregationRule)) -> &mut Self {
        if self.aggregation_rule.is_none() { self.aggregation_rule = Some(Default::default()) };
    ...
    /// Set [`Self::rules`]
    pub  fn rules_set(&mut self, rules: impl Into<Option<Vec<crate::api::rbac::v1::PolicyRule>>>) -> &mut Self {
        self.rules = rules.into(); self
    }

    pub  fn rules(&mut self) -> &mut Vec<crate::api::rbac::v1::PolicyRule> {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn rules_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::rbac::v1::PolicyRule>)) -> &mut Self {
        if self.rules.is_none() { self.rules = Some(Default::default()) };
    ...
    pub  fn rules_push_with(&mut self, func: impl FnOnce(&mut crate::api::rbac::v1::PolicyRule)) -> &mut Self {
    ...
    pub  fn rules_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::rbac::v1::PolicyRule]>) -> &mut Self {
