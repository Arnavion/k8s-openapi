...
impl crate::DeepMerge for PodDisruptionBudgetStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::map::granular(&mut self.disrupted_pods, other.disrupted_pods, |inner_self, inner_other| crate::DeepMerge::merge_from(inner_self, inner_other));
