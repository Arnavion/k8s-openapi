        ...
        serde_json::json!({
          ...
          "properties": {
            ...
            "allowedCSIDrivers": {
              ...
              "items": crate::api::policy::v1beta1::AllowedCSIDriver::schema(),
              "type": "array"
            },
            "allowedCapabilities": {
            ...
            "runtimeClass": crate::schema_ref_with_values(crate::api::policy::v1beta1::RuntimeClassStrategyOptions::schema(), serde_json::json!({"description": "runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled."})),
