...
impl crate::Schema for PersistentVolumeClaimTemplate {
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            "metadata": crate::schema_ref_with_values(crate::apimachinery::pkg::apis::meta::v1::ObjectMeta::schema(), serde_json::json!({"description": "May contain labels and annotations that will be copied into the PVC when creating it. No other fields are allowed and will be rejected during validation."})),
            "spec": crate::schema_ref_with_values(crate::api::core::v1::PersistentVolumeClaimSpec::schema(), serde_json::json!({"description": "The specification for the PersistentVolumeClaim. The entire content is copied unchanged into the PVC that gets created from this template. The same fields as in a PersistentVolumeClaim are also valid here."}))
          },
          "required": [
            "spec"
          ],
