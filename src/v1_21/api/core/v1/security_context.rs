    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "seccompProfile": crate::schema_ref_with_description(crate::api::core::v1::SeccompProfile::schema(), "The seccomp options to use by this container. If seccomp options are provided at both the pod & container level, the container options override the pod options."),
