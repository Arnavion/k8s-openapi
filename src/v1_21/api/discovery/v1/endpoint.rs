    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "conditions": crate::schema_ref_with_values(crate::api::discovery::v1::EndpointConditions::schema(), serde_json::json!({"description": "conditions contains information about the current status of the endpoint."})),
            "deprecatedTopology": {
            ...
            "hints": crate::schema_ref_with_values(crate::api::discovery::v1::EndpointHints::schema(), serde_json::json!({"description": "hints contains information associated with how an endpoint should be consumed."})),
            "hostname": {
