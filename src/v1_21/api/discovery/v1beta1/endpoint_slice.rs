...
impl EndpointSlice  {
    ...
    /// Set [`Self::endpoints`]
    pub  fn endpoints_set(&mut self, endpoints: impl Into<Vec<crate::api::discovery::v1beta1::Endpoint>>) -> &mut Self {
        self.endpoints = endpoints.into(); self
    }

    pub  fn endpoints(&mut self) -> &mut Vec<crate::api::discovery::v1beta1::Endpoint> {
        &mut self.endpoints
    }

    /// Modify [`Self::endpoints`] with a `func`
    pub  fn endpoints_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::discovery::v1beta1::Endpoint>)) -> &mut Self {
    ...
    pub  fn endpoints_push_with(&mut self, func: impl FnOnce(&mut crate::api::discovery::v1beta1::Endpoint)) -> &mut Self {
    ...
    pub  fn endpoints_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::discovery::v1beta1::Endpoint]>) -> &mut Self {
    ...
    /// Set [`Self::ports`]
    pub  fn ports_set(&mut self, ports: impl Into<Option<Vec<crate::api::discovery::v1beta1::EndpointPort>>>) -> &mut Self {
        self.ports = ports.into(); self
    }

    pub  fn ports(&mut self) -> &mut Vec<crate::api::discovery::v1beta1::EndpointPort> {
    ...
    pub  fn ports_with(&mut self, func: impl FnOnce(&mut Vec<crate::api::discovery::v1beta1::EndpointPort>)) -> &mut Self {
        if self.ports.is_none() { self.ports = Some(Default::default()) };
    ...
    ///
    /// The field will initially set to `Default::default()`
    pub  fn ports_push_with(&mut self, func: impl FnOnce(&mut crate::api::discovery::v1beta1::EndpointPort)) -> &mut Self {
    ...
    pub  fn ports_append_from(&mut self, other: impl std::borrow::Borrow<[crate::api::discovery::v1beta1::EndpointPort]>) -> &mut Self {
