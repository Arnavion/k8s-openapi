    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "parameters": crate::schema_ref_with_values(crate::api::networking::v1::IngressClassParametersReference::schema(), serde_json::json!({"description": "Parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters."}))
          },
          "type": "object"
        })
    }
