    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::networking::v1beta1::IngressSpec::schema(), serde_json::json!({"description": "Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"})),
            "status": crate::schema_ref_with_values(crate::api::networking::v1beta1::IngressStatus::schema(), serde_json::json!({"description": "Status is the current state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"}))
          },
          "required": [
            "metadata"
          ],
