    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "clientConfig": crate::schema_ref_with_description(crate::api::admissionregistration::v1::WebhookClientConfig::schema(), "ClientConfig defines how to communicate with the hook. Required"),
            "failurePolicy": {
