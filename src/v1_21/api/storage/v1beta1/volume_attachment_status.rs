...
impl VolumeAttachmentStatus  {
    ...
    pub  fn attach_error_set(&mut self, attach_error: impl Into<Option<crate::api::storage::v1beta1::VolumeError>>) -> &mut Self {
        self.attach_error = attach_error.into(); self
    }

    pub  fn attach_error(&mut self) -> &mut crate::api::storage::v1beta1::VolumeError {
    ...
    pub  fn attach_error_with(&mut self, func: impl FnOnce(&mut crate::api::storage::v1beta1::VolumeError)) -> &mut Self {
        if self.attach_error.is_none() { self.attach_error = Some(Default::default()) };
    ...
    pub  fn detach_error_set(&mut self, detach_error: impl Into<Option<crate::api::storage::v1beta1::VolumeError>>) -> &mut Self {
        self.detach_error = detach_error.into(); self
    }

    pub  fn detach_error(&mut self) -> &mut crate::api::storage::v1beta1::VolumeError {
    ...
    ///
    /// The field will be set to `Default::default()` if not set before
    pub  fn detach_error_with(&mut self, func: impl FnOnce(&mut crate::api::storage::v1beta1::VolumeError)) -> &mut Self {
        if self.detach_error.is_none() { self.detach_error = Some(Default::default()) };
