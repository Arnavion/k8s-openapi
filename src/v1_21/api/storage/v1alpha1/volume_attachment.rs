    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "spec": crate::schema_ref_with_values(crate::api::storage::v1alpha1::VolumeAttachmentSpec::schema(), serde_json::json!({"description": "Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system."})),
            "status": crate::schema_ref_with_values(crate::api::storage::v1alpha1::VolumeAttachmentStatus::schema(), serde_json::json!({"description": "Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher."}))
          },
          "required": [
            "metadata",
            "spec"
