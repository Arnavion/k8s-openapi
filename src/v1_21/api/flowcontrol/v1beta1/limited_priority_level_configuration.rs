    ...
    pub fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "limitResponse": crate::schema_ref_with_description(crate::api::flowcontrol::v1beta1::LimitResponse::schema(), "`limitResponse` indicates what to do with requests that can not be executed right now")
          },
          "type": "object"
        })
    }
