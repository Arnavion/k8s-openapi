    ...
    fn schema() -> serde_json::Value {
        serde_json::json!({
          ...
          "properties": {
            ...
            "limitResponse": crate::schema_ref_with_values(crate::api::flowcontrol::v1beta1::LimitResponse::schema(), serde_json::json!({"description": "`limitResponse` indicates what to do with requests that can not be executed right now"}))
          },
          "type": "object"
        })
    }
