...
impl APIServiceStatus  {
    /// Set [`Self::conditions`]
    pub  fn conditions_set(&mut self, conditions: impl Into<Option<Vec<crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceCondition>>>) -> &mut Self {
        self.conditions = conditions.into(); self
    }

    pub  fn conditions(&mut self) -> &mut Vec<crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceCondition> {
    ...
    pub  fn conditions_with(&mut self, func: impl FnOnce(&mut Vec<crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceCondition>)) -> &mut Self {
        if self.conditions.is_none() { self.conditions = Some(Default::default()) };
    ...
    pub  fn conditions_push_with(&mut self, func: impl FnOnce(&mut crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceCondition)) -> &mut Self {
    ...
    pub  fn conditions_append_from(&mut self, other: impl std::borrow::Borrow<[crate::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceCondition]>) -> &mut Self {
