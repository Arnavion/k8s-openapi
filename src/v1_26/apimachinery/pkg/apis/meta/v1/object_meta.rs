...
impl crate::DeepMerge for ObjectMeta {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::map::granular(&mut self.annotations, other.annotations, |inner_self, inner_other| crate::DeepMerge::merge_from(inner_self, inner_other));
        ...
        crate::merge_strategies::map::granular(&mut self.labels, other.labels, |inner_self, inner_other| crate::DeepMerge::merge_from(inner_self, inner_other));
        ...
        crate::merge_strategies::list::map(&mut self.owner_references, other.owner_references, &[|lhs, rhs| lhs.uid == rhs.uid], |inner_self, inner_other| {crate::DeepMerge::merge_from(inner_self, inner_other)});
