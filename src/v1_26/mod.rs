...
// Generated from operation getResourceV1alpha1APIResources

/// get available resources
///
/// Use the returned [`crate::ResponseBody`]`<`[`GetResourceV1alpha1APIResourcesResponse`]`>` constructor, or [`GetResourceV1alpha1APIResourcesResponse`] directly, to parse the HTTP response.
#[cfg(feature = "api")]
pub fn get_resource_v1alpha1_api_resources(
) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<GetResourceV1alpha1APIResourcesResponse>), crate::RequestError> {
    let __url = "/apis/resource.k8s.io/v1alpha1/".to_owned();
...
/// Use `<GetResourceV1alpha1APIResourcesResponse as Response>::try_from_parts` to parse the HTTP response body of [`get_resource_v1alpha1_api_resources`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum GetResourceV1alpha1APIResourcesResponse {
    Ok(crate::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for GetResourceV1alpha1APIResourcesResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                let result = match crate::serde_json::from_slice(buf) {
                ...
                Ok((GetResourceV1alpha1APIResourcesResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((GetResourceV1alpha1APIResourcesResponse::Other(result), read))
            },
        }
    }
}
...
) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<GetStorageV1beta1APIResourcesResponse>), crate::RequestError> {
