...
impl crate::DeepMerge for PodSpec {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::list::atomic(&mut self.containers, other.containers);
        ...
        crate::merge_strategies::list::atomic(&mut self.ephemeral_containers, other.ephemeral_containers);
        crate::merge_strategies::list::atomic(&mut self.host_aliases, other.host_aliases);
        ...
        crate::merge_strategies::list::atomic(&mut self.init_containers, other.init_containers);
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("SchedulingGates is an opaque list of values that if specified will block scheduling the pod. More info:  https://git.k8s.io/enhancements/keps/sig-scheduling/3521-pod-scheduling-readiness.\n\nThis is an alpha-level feature enabled by PodSchedulingReadiness feature gate.".to_owned()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(crate::schemars::schema::InstanceType::Array))),
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
