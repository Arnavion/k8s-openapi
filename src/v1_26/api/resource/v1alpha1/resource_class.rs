// Generated from definition io.k8s.api.resource.v1alpha1.ResourceClass
...
pub struct ResourceClass {
    ...
    pub parameters_ref: Option<crate::api::resource::v1alpha1::ResourceClassParametersReference>,
...
// Begin resource.k8s.io/v1alpha1/ResourceClass

// Generated from operation createResourceV1alpha1ResourceClass
...
impl ResourceClass {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::resource::v1alpha1::ResourceClass,
        ...
        let __url = "/apis/resource.k8s.io/v1alpha1/resourceclasses?".to_owned();
...
// Generated from operation deleteResourceV1alpha1CollectionResourceClass
...
// Generated from operation deleteResourceV1alpha1ResourceClass
...
impl ResourceClass {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}",
...
// Generated from operation listResourceV1alpha1ResourceClass
...
// Generated from operation patchResourceV1alpha1ResourceClass
...
// Generated from operation readResourceV1alpha1ResourceClass

impl ResourceClass {
    /// read the specified ResourceClass
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`ReadResourceClassResponse`]`>` constructor, or [`ReadResourceClassResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    pub fn read(
        name: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadResourceClassResponse>), crate::RequestError> {
        let __url = format!("/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadResourceClassResponse as Response>::try_from_parts` to parse the HTTP response body of [`ResourceClass::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadResourceClassResponse {
    Ok(crate::api::resource::v1alpha1::ResourceClass),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadResourceClassResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadResourceClassResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadResourceClassResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceResourceV1alpha1ResourceClass
...
// Generated from operation watchResourceV1alpha1ResourceClass
...
// End resource.k8s.io/v1alpha1/ResourceClass
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_parameters_ref: Option<crate::api::resource::v1alpha1::ResourceClassParametersReference> = None;
...
impl crate::schemars::JsonSchema for ResourceClass {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha1.ResourceClass".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha1::ResourceClassParametersReference>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
