// Generated from definition io.k8s.api.resource.v1alpha1.ResourceClaim
...
pub struct ResourceClaim {
    ...
    pub spec: crate::api::resource::v1alpha1::ResourceClaimSpec,

    /// Status describes whether the resource is available and with which attributes.
    pub status: Option<crate::api::resource::v1alpha1::ResourceClaimStatus>,
}

// Begin resource.k8s.io/v1alpha1/ResourceClaim

// Generated from operation createResourceV1alpha1NamespacedResourceClaim
...
impl ResourceClaim {
    ...
    pub fn create(
        namespace: &str,
        body: &crate::api::resource::v1alpha1::ResourceClaim,
        ...
        let __url = format!("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims?",
...
// Generated from operation deleteResourceV1alpha1CollectionNamespacedResourceClaim
...
// Generated from operation deleteResourceV1alpha1NamespacedResourceClaim
...
impl ResourceClaim {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}",
...
// Generated from operation listResourceV1alpha1NamespacedResourceClaim
...
// Generated from operation listResourceV1alpha1ResourceClaimForAllNamespaces
...
impl ResourceClaim {
    ...
    pub fn list_for_all_namespaces(
        ...
        let __url = "/apis/resource.k8s.io/v1alpha1/resourceclaims?".to_owned();
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
// Generated from operation patchResourceV1alpha1NamespacedResourceClaim
...
// Generated from operation patchResourceV1alpha1NamespacedResourceClaimStatus
...
impl ResourceClaim {
    ...
    pub fn patch_status(
        ...
        let __url = format!("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status?",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
...
// Generated from operation readResourceV1alpha1NamespacedResourceClaim
...
impl ResourceClaim {
    ...
    pub fn read(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadResourceClaimResponse>), crate::RequestError> {
        let __url = format!("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadResourceClaimResponse as Response>::try_from_parts` to parse the HTTP response body of [`ResourceClaim::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadResourceClaimResponse {
    Ok(crate::api::resource::v1alpha1::ResourceClaim),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadResourceClaimResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadResourceClaimResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadResourceClaimResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation readResourceV1alpha1NamespacedResourceClaimStatus
...
impl ResourceClaim {
    ...
    pub fn read_status(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadResourceClaimStatusResponse>), crate::RequestError> {
        let __url = format!("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadResourceClaimStatusResponse as Response>::try_from_parts` to parse the HTTP response body of [`ResourceClaim::read_status`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadResourceClaimStatusResponse {
    Ok(crate::api::resource::v1alpha1::ResourceClaim),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadResourceClaimStatusResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                let result = match crate::serde_json::from_slice(buf) {
                ...
                Ok((ReadResourceClaimStatusResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadResourceClaimStatusResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceResourceV1alpha1NamespacedResourceClaim
...
// Generated from operation replaceResourceV1alpha1NamespacedResourceClaimStatus
...
// Generated from operation watchResourceV1alpha1NamespacedResourceClaim
...
// Generated from operation watchResourceV1alpha1ResourceClaimForAllNamespaces
...
// End resource.k8s.io/v1alpha1/ResourceClaim
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::resource::v1alpha1::ResourceClaimSpec> = None;
                let mut value_status: Option<crate::api::resource::v1alpha1::ResourceClaimStatus> = None;
...
impl crate::schemars::JsonSchema for ResourceClaim {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha1.ResourceClaim".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("ResourceClaim describes which resources are needed by a resource consumer. Its status tracks whether the resource has been allocated and what the resulting attributes are.\n\nThis is an alpha type and requires enabling the DynamicResourceAllocation feature gate.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha1::ResourceClaimSpec>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Spec describes the desired attributes of a resource that then needs to be allocated. It can only be set once when creating the ResourceClaim.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::resource::v1alpha1::ResourceClaimStatus>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Status describes whether the resource is available and with which attributes.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
