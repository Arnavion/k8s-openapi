...
impl crate::DeepMerge for ResourceClaimStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::list::map(&mut self.reserved_for, other.reserved_for, &[|lhs, rhs| lhs.uid == rhs.uid], |inner_self, inner_other| {crate::DeepMerge::merge_from(inner_self, inner_other)});
    }
}
