...
impl crate::schemars::JsonSchema for NamedResourcesAllocationResult {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha2.NamedResourcesAllocationResult".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("NamedResourcesAllocationResult is used in AllocationResultModel.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Name is the name of the selected resource instance.".to_owned()),
                                ..Default::default()
                            })),
