...
impl crate::schemars::JsonSchema for ResourceRequest {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha2.ResourceRequest".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("ResourceRequest is a request for resources from one particular driver.".to_owned()),
                ..Default::default()
            })),
                ...
                properties: [
                    (
                        "namedResources".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("NamedResources describes a request for resources with the named resources model.".to_owned()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "vendorParameters".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("VendorParameters are arbitrary setup parameters for the requested resource. They are ignored while allocating a claim.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
