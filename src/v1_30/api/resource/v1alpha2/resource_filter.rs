...
impl crate::schemars::JsonSchema for ResourceFilter {
    fn schema_name() -> String {
        "io.k8s.api.resource.v1alpha2.ResourceFilter".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("ResourceFilter is a filter for resources from one particular driver.".to_owned()),
                ..Default::default()
            })),
                    ...
                    (
                        "namedResources".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("NamedResources describes a resource filter using the named resources model.".to_owned()),
                                ..Default::default()
                            }));
