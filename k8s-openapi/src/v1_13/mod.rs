...
pub enum GetAPIVersionsResponse {
    Ok(::v1_13::apimachinery::pkg::apis::meta::v1::APIGroupList),
    Unauthorized,
    Other,
}
...
pub enum GetAdmissionregistrationAPIGroupResponse {
    Ok(::v1_13::apimachinery::pkg::apis::meta::v1::APIGroup),
    Unauthorized,
    Other,
}
...
pub enum GetAdmissionregistrationV1alpha1APIResourcesResponse {
    Ok(::v1_13::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Unauthorized,
    Other,
}
...
/// get information of a group
///
/// Use [`GetAuditregistrationAPIGroupResponse`](./enum.GetAuditregistrationAPIGroupResponse.html) to parse the HTTP response.
pub fn get_auditregistration_api_group(
) -> Result<::http::Request<Vec<u8>>, ::RequestError> {
    let __url = format!("/apis/auditregistration.k8s.io/");
...
/// Parses the HTTP response of [`get_auditregistration_api_group`](./fn.get_auditregistration_api_group.html)
#[derive(Debug)]
...
impl ::Response for GetAuditregistrationAPIGroupResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
/// get available resources
///
/// Use [`GetAuditregistrationV1alpha1APIResourcesResponse`](./enum.GetAuditregistrationV1alpha1APIResourcesResponse.html) to parse the HTTP response.
pub fn get_auditregistration_v1alpha1_api_resources(
) -> Result<::http::Request<Vec<u8>>, ::RequestError> {
    let __url = format!("/apis/auditregistration.k8s.io/v1alpha1/");
...
/// Parses the HTTP response of [`get_auditregistration_v1alpha1_api_resources`](./fn.get_auditregistration_v1alpha1_api_resources.html)
#[derive(Debug)]
...
impl ::Response for GetAuditregistrationV1alpha1APIResourcesResponse {
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                let result = match ::serde_json::from_slice(buf) {
...
pub enum GetCodeVersionResponse {
    Ok(::v1_13::apimachinery::pkg::version::Info),
    Unauthorized,
    Other,
}
...
pub enum GetCoreAPIVersionsResponse {
    Ok(::v1_13::apimachinery::pkg::apis::meta::v1::APIVersions),
    Unauthorized,
    Other,
}
