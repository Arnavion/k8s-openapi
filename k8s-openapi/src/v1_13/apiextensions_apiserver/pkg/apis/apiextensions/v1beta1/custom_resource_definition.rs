...
impl CustomResourceDefinition {
    ...
    pub fn patch_apiextensions_v1beta1_custom_resource_definition_status(
        name: &str,
        body: &crate::v1_13::apimachinery::pkg::apis::meta::v1::Patch,
        optional: PatchApiextensionsV1beta1CustomResourceDefinitionStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchApiextensionsV1beta1CustomResourceDefinitionStatusOptional {
            dry_run,
            pretty,
        } = optional;
...
/// Optional parameters of [`CustomResourceDefinition::patch_apiextensions_v1beta1_custom_resource_definition_status`](./struct.CustomResourceDefinition.html#method.patch_apiextensions_v1beta1_custom_resource_definition_status)
#[derive(Debug, Default)]
pub struct PatchApiextensionsV1beta1CustomResourceDefinitionStatusOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl CustomResourceDefinition {
    ...
    pub fn read_apiextensions_v1beta1_custom_resource_definition_status(
        name: &str,
        optional: ReadApiextensionsV1beta1CustomResourceDefinitionStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadApiextensionsV1beta1CustomResourceDefinitionStatusOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}/status?", name = name);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`CustomResourceDefinition::read_apiextensions_v1beta1_custom_resource_definition_status`](./struct.CustomResourceDefinition.html#method.read_apiextensions_v1beta1_custom_resource_definition_status)
#[derive(Debug, Default)]
pub struct ReadApiextensionsV1beta1CustomResourceDefinitionStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
