...
pub enum JSONSchemaPropsOrArray {
    Schema(Box<::v1_13::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>),
    Schemas(Vec<::v1_13::apiextensions_apiserver::pkg::apis::apiextensions::v1beta1::JSONSchemaProps>),
}
