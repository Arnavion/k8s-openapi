...
pub struct DeploymentRollback {
    ...
    pub rollback_to: ::v1_13::api::extensions::v1beta1::RollbackConfig,
...
impl DeploymentRollback {
    ...
    pub fn create_extensions_v1beta1_namespaced_deployment_rollback(
        name: &str,
        namespace: &str,
        body: &::v1_13::api::extensions::v1beta1::DeploymentRollback,
        dry_run: Option<&str>,
...
pub enum CreateExtensionsV1beta1NamespacedDeploymentRollbackResponse {
    Ok(::v1_13::apimachinery::pkg::apis::meta::v1::Status),
    Created(::v1_13::apimachinery::pkg::apis::meta::v1::Status),
