...
pub struct Ingress {
    ...
    pub spec: Option<::v1_13::api::extensions::v1beta1::IngressSpec>,

    /// Status is the current state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<::v1_13::api::extensions::v1beta1::IngressStatus>,
}
...
impl Ingress {
    ...
    pub fn create_extensions_v1beta1_namespaced_ingress(
        namespace: &str,
        body: &::v1_13::api::extensions::v1beta1::Ingress,
        dry_run: Option<&str>,
...
pub enum CreateExtensionsV1beta1NamespacedIngressResponse {
    Ok(::v1_13::api::extensions::v1beta1::Ingress),
    Created(::v1_13::api::extensions::v1beta1::Ingress),
    Accepted(::v1_13::api::extensions::v1beta1::Ingress),
    Unauthorized,
    Other,
}
...
pub enum DeleteExtensionsV1beta1CollectionNamespacedIngressResponse {
    ...
    OkValue(::v1_13::api::extensions::v1beta1::Ingress),
    Unauthorized,
    Other,
}
...
pub enum ListExtensionsV1beta1IngressForAllNamespacesResponse {
    Ok(::v1_13::api::extensions::v1beta1::IngressList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_13::api::extensions::v1beta1::IngressSpec> = None;
                let mut value_status: Option<::v1_13::api::extensions::v1beta1::IngressStatus> = None;
