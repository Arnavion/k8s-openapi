...
pub struct Lease {
    ...
    pub spec: Option<::v1_13::api::coordination::v1beta1::LeaseSpec>,
}
...
impl Lease {
    ...
    pub fn create_coordination_v1beta1_namespaced_lease(
        namespace: &str,
        body: &::v1_13::api::coordination::v1beta1::Lease,
        dry_run: Option<&str>,
...
pub enum CreateCoordinationV1beta1NamespacedLeaseResponse {
    Ok(::v1_13::api::coordination::v1beta1::Lease),
    Created(::v1_13::api::coordination::v1beta1::Lease),
    Accepted(::v1_13::api::coordination::v1beta1::Lease),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoordinationV1beta1CollectionNamespacedLeaseResponse {
    ...
    OkValue(::v1_13::api::coordination::v1beta1::Lease),
    Unauthorized,
    Other,
}
...
pub enum ListCoordinationV1beta1LeaseForAllNamespacesResponse {
    Ok(::v1_13::api::coordination::v1beta1::LeaseList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_13::api::coordination::v1beta1::LeaseSpec> = None;
