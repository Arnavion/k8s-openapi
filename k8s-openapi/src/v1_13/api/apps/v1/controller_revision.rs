...
impl ControllerRevision {
    ...
    pub fn create_apps_v1_namespaced_controller_revision(
        namespace: &str,
        body: &::v1_13::api::apps::v1::ControllerRevision,
        dry_run: Option<&str>,
...
pub enum CreateAppsV1NamespacedControllerRevisionResponse {
    Ok(::v1_13::api::apps::v1::ControllerRevision),
    Created(::v1_13::api::apps::v1::ControllerRevision),
    Accepted(::v1_13::api::apps::v1::ControllerRevision),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1CollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(::v1_13::api::apps::v1::ControllerRevision),
    Unauthorized,
    Other,
}
...
pub enum ListAppsV1ControllerRevisionForAllNamespacesResponse {
    Ok(::v1_13::api::apps::v1::ControllerRevisionList),
    Unauthorized,
    Other,
}
