...
pub struct ControllerRevision {
    ...
    pub data: Option<::v1_13::apimachinery::pkg::runtime::RawExtension>,
...
impl ControllerRevision {
    ...
    pub fn create_apps_v1beta2_namespaced_controller_revision(
        namespace: &str,
        body: &::v1_13::api::apps::v1beta2::ControllerRevision,
        dry_run: Option<&str>,
...
pub enum CreateAppsV1beta2NamespacedControllerRevisionResponse {
    Ok(::v1_13::api::apps::v1beta2::ControllerRevision),
    Created(::v1_13::api::apps::v1beta2::ControllerRevision),
    Accepted(::v1_13::api::apps::v1beta2::ControllerRevision),
    Unauthorized,
    Other,
}
...
pub enum DeleteAppsV1beta2CollectionNamespacedControllerRevisionResponse {
    ...
    OkValue(::v1_13::api::apps::v1beta2::ControllerRevision),
    Unauthorized,
    Other,
}
...
pub enum ListAppsV1beta2ControllerRevisionForAllNamespacesResponse {
    Ok(::v1_13::api::apps::v1beta2::ControllerRevisionList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_data: Option<::v1_13::apimachinery::pkg::runtime::RawExtension> = None;
