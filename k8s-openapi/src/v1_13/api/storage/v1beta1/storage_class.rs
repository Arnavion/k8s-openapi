...
pub struct StorageClass {
    ...
    pub allowed_topologies: Option<Vec<::v1_13::api::core::v1::TopologySelectorTerm>>,
...
impl StorageClass {
    ...
    pub fn create_storage_v1beta1_storage_class(
        body: &::v1_13::api::storage::v1beta1::StorageClass,
        dry_run: Option<&str>,
...
pub enum CreateStorageV1beta1StorageClassResponse {
    Ok(::v1_13::api::storage::v1beta1::StorageClass),
    Created(::v1_13::api::storage::v1beta1::StorageClass),
    Accepted(::v1_13::api::storage::v1beta1::StorageClass),
    Unauthorized,
    Other,
}
...
pub enum DeleteStorageV1beta1CollectionStorageClassResponse {
    ...
    OkValue(::v1_13::api::storage::v1beta1::StorageClass),
    Unauthorized,
    Other,
}
...
pub enum ListStorageV1beta1StorageClassResponse {
    Ok(::v1_13::api::storage::v1beta1::StorageClassList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_allowed_topologies: Option<Vec<::v1_13::api::core::v1::TopologySelectorTerm>> = None;
