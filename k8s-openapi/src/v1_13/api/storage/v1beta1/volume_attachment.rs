...
impl VolumeAttachment {
    ...
    pub fn create_storage_v1beta1_volume_attachment(
        ...
        optional: CreateStorageV1beta1VolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let CreateStorageV1beta1VolumeAttachmentOptional {
            dry_run,
...
/// Optional parameters of [`VolumeAttachment::create_storage_v1beta1_volume_attachment`](./struct.VolumeAttachment.html#method.create_storage_v1beta1_volume_attachment)
#[derive(Debug, Default)]
pub struct CreateStorageV1beta1VolumeAttachmentOptional<'a> {
...
impl crate::Response for CreateStorageV1beta1VolumeAttachmentResponse {
...
impl VolumeAttachment {
    ...
    pub fn delete_storage_v1beta1_collection_volume_attachment(
        optional: DeleteStorageV1beta1CollectionVolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteStorageV1beta1CollectionVolumeAttachmentOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`VolumeAttachment::delete_storage_v1beta1_collection_volume_attachment`](./struct.VolumeAttachment.html#method.delete_storage_v1beta1_collection_volume_attachment)
#[derive(Debug, Default)]
pub struct DeleteStorageV1beta1CollectionVolumeAttachmentOptional<'a> {
...
impl crate::Response for DeleteStorageV1beta1CollectionVolumeAttachmentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl VolumeAttachment {
    ...
    pub fn delete_storage_v1beta1_volume_attachment(
        name: &str,
        optional: DeleteStorageV1beta1VolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteStorageV1beta1VolumeAttachmentOptional {
            dry_run,
...
/// Optional parameters of [`VolumeAttachment::delete_storage_v1beta1_volume_attachment`](./struct.VolumeAttachment.html#method.delete_storage_v1beta1_volume_attachment)
#[derive(Debug, Default)]
pub struct DeleteStorageV1beta1VolumeAttachmentOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
...
impl crate::Response for DeleteStorageV1beta1VolumeAttachmentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result: serde_json::Map<String, serde_json::Value> = match serde_json::from_slice(buf) {
...
impl VolumeAttachment {
    ...
    pub fn list_storage_v1beta1_volume_attachment(
        optional: ListStorageV1beta1VolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListStorageV1beta1VolumeAttachmentOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`VolumeAttachment::list_storage_v1beta1_volume_attachment`](./struct.VolumeAttachment.html#method.list_storage_v1beta1_volume_attachment)
#[derive(Debug, Default)]
pub struct ListStorageV1beta1VolumeAttachmentOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl crate::Response for ListStorageV1beta1VolumeAttachmentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl VolumeAttachment {
    ...
    pub fn patch_storage_v1beta1_volume_attachment(
        ...
        optional: PatchStorageV1beta1VolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchStorageV1beta1VolumeAttachmentOptional {
            dry_run,
            pretty,
        } = optional;
        let __url = format!("/apis/storage.k8s.io/v1beta1/volumeattachments/{name}?", name = name);
...
/// Optional parameters of [`VolumeAttachment::patch_storage_v1beta1_volume_attachment`](./struct.VolumeAttachment.html#method.patch_storage_v1beta1_volume_attachment)
#[derive(Debug, Default)]
pub struct PatchStorageV1beta1VolumeAttachmentOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl crate::Response for PatchStorageV1beta1VolumeAttachmentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl VolumeAttachment {
    ...
    pub fn read_storage_v1beta1_volume_attachment(
        name: &str,
        optional: ReadStorageV1beta1VolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadStorageV1beta1VolumeAttachmentOptional {
            exact,
            export,
            pretty,
        } = optional;
...
/// Optional parameters of [`VolumeAttachment::read_storage_v1beta1_volume_attachment`](./struct.VolumeAttachment.html#method.read_storage_v1beta1_volume_attachment)
#[derive(Debug, Default)]
pub struct ReadStorageV1beta1VolumeAttachmentOptional<'a> {
...
impl crate::Response for ReadStorageV1beta1VolumeAttachmentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl VolumeAttachment {
    ...
    pub fn replace_storage_v1beta1_volume_attachment(
        name: &str,
        body: &crate::v1_13::api::storage::v1beta1::VolumeAttachment,
        optional: ReplaceStorageV1beta1VolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceStorageV1beta1VolumeAttachmentOptional {
            dry_run,
            pretty,
        } = optional;
        let __url = format!("/apis/storage.k8s.io/v1beta1/volumeattachments/{name}?", name = name);
...
/// Optional parameters of [`VolumeAttachment::replace_storage_v1beta1_volume_attachment`](./struct.VolumeAttachment.html#method.replace_storage_v1beta1_volume_attachment)
#[derive(Debug, Default)]
pub struct ReplaceStorageV1beta1VolumeAttachmentOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl crate::Response for ReplaceStorageV1beta1VolumeAttachmentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl VolumeAttachment {
    ...
    pub fn watch_storage_v1beta1_volume_attachment(
        name: &str,
        optional: WatchStorageV1beta1VolumeAttachmentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchStorageV1beta1VolumeAttachmentOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`VolumeAttachment::watch_storage_v1beta1_volume_attachment`](./struct.VolumeAttachment.html#method.watch_storage_v1beta1_volume_attachment)
#[derive(Debug, Default)]
pub struct WatchStorageV1beta1VolumeAttachmentOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl crate::Response for WatchStorageV1beta1VolumeAttachmentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl VolumeAttachment {
    ...
    pub fn watch_storage_v1beta1_volume_attachment_list(
        optional: WatchStorageV1beta1VolumeAttachmentListOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchStorageV1beta1VolumeAttachmentListOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`VolumeAttachment::watch_storage_v1beta1_volume_attachment_list`](./struct.VolumeAttachment.html#method.watch_storage_v1beta1_volume_attachment_list)
#[derive(Debug, Default)]
pub struct WatchStorageV1beta1VolumeAttachmentListOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl crate::Response for WatchStorageV1beta1VolumeAttachmentListResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
