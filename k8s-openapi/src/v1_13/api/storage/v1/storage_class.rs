...
impl StorageClass {
    ...
    pub fn create_storage_v1_storage_class(
        body: &::v1_13::api::storage::v1::StorageClass,
        dry_run: Option<&str>,
...
pub enum CreateStorageV1StorageClassResponse {
    Ok(::v1_13::api::storage::v1::StorageClass),
    Created(::v1_13::api::storage::v1::StorageClass),
    Accepted(::v1_13::api::storage::v1::StorageClass),
    Unauthorized,
    Other,
}
...
pub enum DeleteStorageV1CollectionStorageClassResponse {
    ...
    OkValue(::v1_13::api::storage::v1::StorageClass),
    Unauthorized,
    Other,
}
...
pub enum ListStorageV1StorageClassResponse {
    Ok(::v1_13::api::storage::v1::StorageClassList),
    Unauthorized,
    Other,
}
