...
pub struct LocalSubjectAccessReview {
    ...
    pub spec: ::v1_13::api::authorization::v1beta1::SubjectAccessReviewSpec,
...
impl LocalSubjectAccessReview {
    ...
    pub fn create_authorization_v1beta1_namespaced_local_subject_access_review(
        namespace: &str,
        body: &::v1_13::api::authorization::v1beta1::LocalSubjectAccessReview,
        dry_run: Option<&str>,
...
pub enum CreateAuthorizationV1beta1NamespacedLocalSubjectAccessReviewResponse {
    Ok(::v1_13::api::authorization::v1beta1::LocalSubjectAccessReview),
    Created(::v1_13::api::authorization::v1beta1::LocalSubjectAccessReview),
    Accepted(::v1_13::api::authorization::v1beta1::LocalSubjectAccessReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_13::api::authorization::v1beta1::SubjectAccessReviewSpec> = None;
