...
pub struct SelfSubjectRulesReview {
    ...
    pub spec: ::v1_13::api::authorization::v1::SelfSubjectRulesReviewSpec,

    /// Status is filled in by the server and indicates the set of actions a user can perform.
    pub status: Option<::v1_13::api::authorization::v1::SubjectRulesReviewStatus>,
}
...
impl SelfSubjectRulesReview {
    ...
    pub fn create_authorization_v1_self_subject_rules_review(
        body: &::v1_13::api::authorization::v1::SelfSubjectRulesReview,
        dry_run: Option<&str>,
...
pub enum CreateAuthorizationV1SelfSubjectRulesReviewResponse {
    Ok(::v1_13::api::authorization::v1::SelfSubjectRulesReview),
    Created(::v1_13::api::authorization::v1::SelfSubjectRulesReview),
    Accepted(::v1_13::api::authorization::v1::SelfSubjectRulesReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_13::api::authorization::v1::SelfSubjectRulesReviewSpec> = None;
                let mut value_status: Option<::v1_13::api::authorization::v1::SubjectRulesReviewStatus> = None;
