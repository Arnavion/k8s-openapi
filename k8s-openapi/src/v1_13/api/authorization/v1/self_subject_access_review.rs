...
pub struct SelfSubjectAccessReview {
    ...
    pub spec: ::v1_13::api::authorization::v1::SelfSubjectAccessReviewSpec,

    /// Status is filled in by the server and indicates whether the request is allowed or not
    pub status: Option<::v1_13::api::authorization::v1::SubjectAccessReviewStatus>,
}
...
impl SelfSubjectAccessReview {
    ...
    pub fn create_authorization_v1_self_subject_access_review(
        body: &::v1_13::api::authorization::v1::SelfSubjectAccessReview,
        dry_run: Option<&str>,
...
pub enum CreateAuthorizationV1SelfSubjectAccessReviewResponse {
    Ok(::v1_13::api::authorization::v1::SelfSubjectAccessReview),
    Created(::v1_13::api::authorization::v1::SelfSubjectAccessReview),
    Accepted(::v1_13::api::authorization::v1::SelfSubjectAccessReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_13::api::authorization::v1::SelfSubjectAccessReviewSpec> = None;
                let mut value_status: Option<::v1_13::api::authorization::v1::SubjectAccessReviewStatus> = None;
