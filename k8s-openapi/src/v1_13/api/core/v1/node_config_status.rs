...
pub struct NodeConfigStatus {
    ...
    pub last_known_good: Option<::v1_13::api::core::v1::NodeConfigSource>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_active: Option<::v1_13::api::core::v1::NodeConfigSource> = None;
                let mut value_assigned: Option<::v1_13::api::core::v1::NodeConfigSource> = None;
                let mut value_error: Option<String> = None;
                let mut value_last_known_good: Option<::v1_13::api::core::v1::NodeConfigSource> = None;
