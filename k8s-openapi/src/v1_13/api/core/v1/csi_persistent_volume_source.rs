...
pub struct CSIPersistentVolumeSource {
    ...
    pub controller_publish_secret_ref: Option<::v1_13::api::core::v1::SecretReference>,
    ...
    pub node_publish_secret_ref: Option<::v1_13::api::core::v1::SecretReference>,

    /// NodeStageSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodeStageVolume and NodeStageVolume and NodeUnstageVolume calls. This field is optional, and may be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed.
    pub node_stage_secret_ref: Option<::v1_13::api::core::v1::SecretReference>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_controller_publish_secret_ref: Option<::v1_13::api::core::v1::SecretReference> = None;
                let mut value_driver: Option<String> = None;
                let mut value_fs_type: Option<String> = None;
                let mut value_node_publish_secret_ref: Option<::v1_13::api::core::v1::SecretReference> = None;
                let mut value_node_stage_secret_ref: Option<::v1_13::api::core::v1::SecretReference> = None;
