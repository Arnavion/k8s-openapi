...
impl ConfigMap {
    ...
    pub fn create_core_v1_namespaced_config_map(
        namespace: &str,
        body: &::v1_13::api::core::v1::ConfigMap,
        dry_run: Option<&str>,
...
pub enum CreateCoreV1NamespacedConfigMapResponse {
    Ok(::v1_13::api::core::v1::ConfigMap),
    Created(::v1_13::api::core::v1::ConfigMap),
    Accepted(::v1_13::api::core::v1::ConfigMap),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNamespacedConfigMapResponse {
    ...
    OkValue(::v1_13::api::core::v1::ConfigMap),
    Unauthorized,
    Other,
}
...
pub enum ListCoreV1ConfigMapForAllNamespacesResponse {
    Ok(::v1_13::api::core::v1::ConfigMapList),
    Unauthorized,
    Other,
}
