...
pub struct ContainerStateTerminated {
    ...
    pub finished_at: Option<crate::v1_13::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    pub started_at: Option<crate::v1_13::apimachinery::pkg::apis::meta::v1::Time>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_finished_at: Option<crate::v1_13::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_message: Option<String> = None;
                let mut value_reason: Option<String> = None;
                let mut value_signal: Option<i32> = None;
                let mut value_started_at: Option<crate::v1_13::apimachinery::pkg::apis::meta::v1::Time> = None;
