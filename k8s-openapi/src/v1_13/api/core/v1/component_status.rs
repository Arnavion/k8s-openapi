...
pub struct ComponentStatus {
    ...
    pub conditions: Option<Vec<::v1_13::api::core::v1::ComponentCondition>>,
...
pub enum ListCoreV1ComponentStatusResponse {
    Ok(::v1_13::api::core::v1::ComponentStatusList),
    Unauthorized,
    Other,
}
...
pub enum ReadCoreV1ComponentStatusResponse {
    Ok(::v1_13::api::core::v1::ComponentStatus),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_conditions: Option<Vec<::v1_13::api::core::v1::ComponentCondition>> = None;
