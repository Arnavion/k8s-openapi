...
pub struct Pod {
    ...
    pub spec: Option<::v1_13::api::core::v1::PodSpec>,

    /// Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<::v1_13::api::core::v1::PodStatus>,
}
...
pub enum CreateCoreV1NamespacedPodResponse {
    Ok(::v1_13::api::core::v1::Pod),
    Created(::v1_13::api::core::v1::Pod),
    Accepted(::v1_13::api::core::v1::Pod),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<::v1_13::api::core::v1::PodSpec> = None;
                let mut value_status: Option<::v1_13::api::core::v1::PodStatus> = None;
