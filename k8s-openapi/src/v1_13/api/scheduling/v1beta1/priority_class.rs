...
impl PriorityClass {
    ...
    pub fn create_scheduling_v1beta1_priority_class(
        body: &::v1_13::api::scheduling::v1beta1::PriorityClass,
        dry_run: Option<&str>,
...
pub enum CreateSchedulingV1beta1PriorityClassResponse {
    Ok(::v1_13::api::scheduling::v1beta1::PriorityClass),
    Created(::v1_13::api::scheduling::v1beta1::PriorityClass),
    Accepted(::v1_13::api::scheduling::v1beta1::PriorityClass),
    Unauthorized,
    Other,
}
...
pub enum DeleteSchedulingV1beta1CollectionPriorityClassResponse {
    ...
    OkValue(::v1_13::api::scheduling::v1beta1::PriorityClass),
    Unauthorized,
    Other,
}
...
pub enum ListSchedulingV1beta1PriorityClassResponse {
    Ok(::v1_13::api::scheduling::v1beta1::PriorityClassList),
    Unauthorized,
    Other,
}
