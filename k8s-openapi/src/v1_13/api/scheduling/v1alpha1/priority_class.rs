...
impl PriorityClass {
    ...
    pub fn create_scheduling_v1alpha1_priority_class(
        body: &::v1_13::api::scheduling::v1alpha1::PriorityClass,
        dry_run: Option<&str>,
...
pub enum CreateSchedulingV1alpha1PriorityClassResponse {
    Ok(::v1_13::api::scheduling::v1alpha1::PriorityClass),
    Created(::v1_13::api::scheduling::v1alpha1::PriorityClass),
    Accepted(::v1_13::api::scheduling::v1alpha1::PriorityClass),
    Unauthorized,
    Other,
}
...
pub enum DeleteSchedulingV1alpha1CollectionPriorityClassResponse {
    ...
    OkValue(::v1_13::api::scheduling::v1alpha1::PriorityClass),
    Unauthorized,
    Other,
}
...
pub enum ListSchedulingV1alpha1PriorityClassResponse {
    Ok(::v1_13::api::scheduling::v1alpha1::PriorityClassList),
    Unauthorized,
    Other,
}
