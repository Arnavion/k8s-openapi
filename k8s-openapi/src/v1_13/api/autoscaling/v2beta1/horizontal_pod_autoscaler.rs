...
// Generated from operation watchAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesList
...
impl HorizontalPodAutoscaler {
    ...
    pub fn watch_horizontal_pod_autoscaler_list_for_all_namespaces(
        ...
        let __url = "/apis/autoscaling/v2beta1/watch/horizontalpodautoscalers?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
