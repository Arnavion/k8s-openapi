...
pub struct ObjectMetricStatus {
    ...
    pub average_value: Option<::v1_13::apimachinery::pkg::api::resource::Quantity>,

    /// currentValue is the current value of the metric (as a quantity).
    pub current_value: ::v1_13::apimachinery::pkg::api::resource::Quantity,
    ...
    pub target: ::v1_13::api::autoscaling::v2beta1::CrossVersionObjectReference,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_average_value: Option<::v1_13::apimachinery::pkg::api::resource::Quantity> = None;
                let mut value_current_value: Option<::v1_13::apimachinery::pkg::api::resource::Quantity> = None;
                ...
                let mut value_target: Option<::v1_13::api::autoscaling::v2beta1::CrossVersionObjectReference> = None;
