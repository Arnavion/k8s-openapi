...
pub struct HorizontalPodAutoscalerSpec {
    ...
    pub metrics: Option<Vec<crate::v1_13::api::autoscaling::v2beta1::MetricSpec>>,

    /// minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down. It defaults to 1 pod.
    pub min_replicas: Option<i32>,

    /// scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.
    pub scale_target_ref: crate::v1_13::api::autoscaling::v2beta1::CrossVersionObjectReference,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_metrics: Option<Vec<crate::v1_13::api::autoscaling::v2beta1::MetricSpec>> = None;
                let mut value_min_replicas: Option<i32> = None;
                let mut value_scale_target_ref: Option<crate::v1_13::api::autoscaling::v2beta1::CrossVersionObjectReference> = None;
