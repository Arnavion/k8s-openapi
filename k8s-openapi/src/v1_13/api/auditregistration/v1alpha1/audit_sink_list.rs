...
pub struct AuditSinkList {
    ...
    pub items: Vec<::v1_13::api::auditregistration::v1alpha1::AuditSink>,

    pub metadata: Option<::v1_13::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl ::Resource for AuditSinkList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<::v1_13::api::auditregistration::v1alpha1::AuditSink>> = None;
