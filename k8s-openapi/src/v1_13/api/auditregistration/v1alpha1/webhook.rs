...
pub struct Webhook {
    ...
    pub client_config: crate::v1_13::api::auditregistration::v1alpha1::WebhookClientConfig,

    /// Throttle holds the options for throttling the webhook
    pub throttle: Option<crate::v1_13::api::auditregistration::v1alpha1::WebhookThrottleConfig>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_client_config: Option<crate::v1_13::api::auditregistration::v1alpha1::WebhookClientConfig> = None;
                let mut value_throttle: Option<crate::v1_13::api::auditregistration::v1alpha1::WebhookThrottleConfig> = None;
