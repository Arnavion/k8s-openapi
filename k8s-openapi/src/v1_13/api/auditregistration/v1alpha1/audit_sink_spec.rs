...
pub struct AuditSinkSpec {
    ...
    pub policy: ::v1_13::api::auditregistration::v1alpha1::Policy,

    /// Webhook to send events required
    pub webhook: ::v1_13::api::auditregistration::v1alpha1::Webhook,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_policy: Option<::v1_13::api::auditregistration::v1alpha1::Policy> = None;
                let mut value_webhook: Option<::v1_13::api::auditregistration::v1alpha1::Webhook> = None;
