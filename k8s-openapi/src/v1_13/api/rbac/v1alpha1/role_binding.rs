...
impl RoleBinding {
    ...
    pub fn create_rbac_authorization_v1alpha1_namespaced_role_binding(
        namespace: &str,
        body: &::v1_13::api::rbac::v1alpha1::RoleBinding,
        dry_run: Option<&str>,
...
pub enum CreateRbacAuthorizationV1alpha1NamespacedRoleBindingResponse {
    Ok(::v1_13::api::rbac::v1alpha1::RoleBinding),
    Created(::v1_13::api::rbac::v1alpha1::RoleBinding),
    Accepted(::v1_13::api::rbac::v1alpha1::RoleBinding),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingResponse {
    ...
    OkValue(::v1_13::api::rbac::v1alpha1::RoleBinding),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1alpha1NamespacedRoleBindingResponse {
    Ok(::v1_13::api::rbac::v1alpha1::RoleBindingList),
    Unauthorized,
    Other,
}
