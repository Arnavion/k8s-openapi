...
impl Role {
    ...
    pub fn create_rbac_authorization_v1alpha1_namespaced_role(
        namespace: &str,
        body: &::v1_13::api::rbac::v1alpha1::Role,
        dry_run: Option<&str>,
...
pub enum CreateRbacAuthorizationV1alpha1NamespacedRoleResponse {
    Ok(::v1_13::api::rbac::v1alpha1::Role),
    Created(::v1_13::api::rbac::v1alpha1::Role),
    Accepted(::v1_13::api::rbac::v1alpha1::Role),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleResponse {
    ...
    OkValue(::v1_13::api::rbac::v1alpha1::Role),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1alpha1NamespacedRoleResponse {
    Ok(::v1_13::api::rbac::v1alpha1::RoleList),
    Unauthorized,
    Other,
}
