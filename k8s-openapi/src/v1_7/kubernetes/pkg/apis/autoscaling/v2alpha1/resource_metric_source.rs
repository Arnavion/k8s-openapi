// Generated from definition io.k8s.kubernetes.pkg.apis.autoscaling.v2alpha1.ResourceMetricSource
...
pub struct ResourceMetricSource {
    ...
    pub target_average_value: Option<crate::v1_7::apimachinery::pkg::api::resource::Quantity>,
}
...
impl<'de> serde::Deserialize<'de> for ResourceMetricSource {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct ResourceMetricSource")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_name: Option<String> = None;
                let mut value_target_average_utilization: Option<i32> = None;
                let mut value_target_average_value: Option<crate::v1_7::apimachinery::pkg::api::resource::Quantity> = None;
