...
pub struct HorizontalPodAutoscaler {
    ...
    pub spec: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscalerSpec>,

    /// status is the current information about the autoscaler.
    pub status: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscalerStatus>,
}
...
impl HorizontalPodAutoscaler {
    ...
    pub fn create_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscaler,
        optional: CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional {
            pretty,
        } = optional;
...
/// Optional parameters of [`HorizontalPodAutoscaler::create_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.create_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'a> {
...
pub enum CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscaler),
    Unauthorized,
    Other,
}

impl crate::Response for CreateAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn delete_autoscaling_v2alpha1_collection_namespaced_horizontal_pod_autoscaler(
        namespace: &str,
        optional: DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerOptional {
            field_selector,
...
/// Optional parameters of [`HorizontalPodAutoscaler::delete_autoscaling_v2alpha1_collection_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.delete_autoscaling_v2alpha1_collection_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerOptional<'a> {
...
pub enum DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscaler),
    Unauthorized,
    Other,
}

impl crate::Response for DeleteAutoscalingV2alpha1CollectionNamespacedHorizontalPodAutoscalerResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn delete_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler(
        name: &str,
        namespace: &str,
        optional: DeleteAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional {
...
/// Optional parameters of [`HorizontalPodAutoscaler::delete_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.delete_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct DeleteAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'a> {
...
impl crate::Response for DeleteAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result: serde_json::Map<String, serde_json::Value> = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn list_autoscaling_v2alpha1_horizontal_pod_autoscaler_for_all_namespaces(
        optional: ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`HorizontalPodAutoscaler::list_autoscaling_v2alpha1_horizontal_pod_autoscaler_for_all_namespaces`](./struct.HorizontalPodAutoscaler.html#method.list_autoscaling_v2alpha1_horizontal_pod_autoscaler_for_all_namespaces)
#[derive(Debug, Default)]
pub struct ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
pub enum ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscalerList),
    Unauthorized,
    Other,
}

impl crate::Response for ListAutoscalingV2alpha1HorizontalPodAutoscalerForAllNamespacesResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn list_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler(
        namespace: &str,
        optional: ListAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`HorizontalPodAutoscaler::list_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.list_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct ListAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for ListAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn patch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler(
        ...
        optional: PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`HorizontalPodAutoscaler::patch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.patch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn patch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status(
        ...
        namespace: &str,
        body: &crate::v1_7::apimachinery::pkg::apis::meta::v1::Patch,
        optional: PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional {
            pretty,
        } = optional;
...
/// Optional parameters of [`HorizontalPodAutoscaler::patch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status`](./struct.HorizontalPodAutoscaler.html#method.patch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status)
#[derive(Debug, Default)]
pub struct PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for PatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn read_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler(
        name: &str,
        namespace: &str,
        optional: ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional {
            exact,
            export,
            pretty,
        } = optional;
...
/// Optional parameters of [`HorizontalPodAutoscaler::read_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.read_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'a> {
...
impl crate::Response for ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn read_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status(
        name: &str,
        namespace: &str,
        optional: ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`HorizontalPodAutoscaler::read_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status`](./struct.HorizontalPodAutoscaler.html#method.read_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status)
#[derive(Debug, Default)]
pub struct ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReadAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn replace_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler(
        ...
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscaler,
        optional: ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`HorizontalPodAutoscaler::replace_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.replace_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn replace_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status(
        ...
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscaler,
        optional: ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`HorizontalPodAutoscaler::replace_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status`](./struct.HorizontalPodAutoscaler.html#method.replace_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_status)
#[derive(Debug, Default)]
pub struct ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReplaceAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerStatusResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn watch_autoscaling_v2alpha1_horizontal_pod_autoscaler_list_for_all_namespaces(
        optional: WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`HorizontalPodAutoscaler::watch_autoscaling_v2alpha1_horizontal_pod_autoscaler_list_for_all_namespaces`](./struct.HorizontalPodAutoscaler.html#method.watch_autoscaling_v2alpha1_horizontal_pod_autoscaler_list_for_all_namespaces)
#[derive(Debug, Default)]
pub struct WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchAutoscalingV2alpha1HorizontalPodAutoscalerListForAllNamespacesResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl HorizontalPodAutoscaler {
    ...
    pub fn watch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler(
        name: &str,
        namespace: &str,
        optional: WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`HorizontalPodAutoscaler::watch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler`](./struct.HorizontalPodAutoscaler.html#method.watch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler)
#[derive(Debug, Default)]
pub struct WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
...
impl HorizontalPodAutoscaler {
    ...
    pub fn watch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_list(
        namespace: &str,
        optional: WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`HorizontalPodAutoscaler::watch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_list`](./struct.HorizontalPodAutoscaler.html#method.watch_autoscaling_v2alpha1_namespaced_horizontal_pod_autoscaler_list)
#[derive(Debug, Default)]
pub struct WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchAutoscalingV2alpha1NamespacedHorizontalPodAutoscalerListResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscalerSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v2alpha1::HorizontalPodAutoscalerStatus> = None;
