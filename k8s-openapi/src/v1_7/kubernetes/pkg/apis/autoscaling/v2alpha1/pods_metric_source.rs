// Generated from definition io.k8s.kubernetes.pkg.apis.autoscaling.v2alpha1.PodsMetricSource
...
pub struct PodsMetricSource {
    ...
    pub target_average_value: crate::v1_7::apimachinery::pkg::api::resource::Quantity,
}
