...
pub struct HorizontalPodAutoscaler {
    ...
    pub spec: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscalerSpec>,

    /// current information about the autoscaler.
    pub status: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscalerStatus>,
}
...
impl HorizontalPodAutoscaler {
    ...
    pub fn create_autoscaling_v1_namespaced_horizontal_pod_autoscaler(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscaler,
...
pub enum CreateAutoscalingV1NamespacedHorizontalPodAutoscalerResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscaler),
    Unauthorized,
    Other,
}
...
pub enum DeleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscalerResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscaler),
    Unauthorized,
    Other,
}
...
pub enum ListAutoscalingV1HorizontalPodAutoscalerForAllNamespacesResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscalerList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscalerSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::apis::autoscaling::v1::HorizontalPodAutoscalerStatus> = None;
