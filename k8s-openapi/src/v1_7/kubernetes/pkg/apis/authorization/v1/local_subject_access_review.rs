...
pub struct LocalSubjectAccessReview {
    ...
    pub spec: crate::v1_7::kubernetes::pkg::apis::authorization::v1::SubjectAccessReviewSpec,
...
impl LocalSubjectAccessReview {
    ...
    pub fn create_authorization_v1_namespaced_local_subject_access_review(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::authorization::v1::LocalSubjectAccessReview,
        pretty: Option<&str>,
...
pub enum CreateAuthorizationV1NamespacedLocalSubjectAccessReviewResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::authorization::v1::LocalSubjectAccessReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::apis::authorization::v1::SubjectAccessReviewSpec> = None;
