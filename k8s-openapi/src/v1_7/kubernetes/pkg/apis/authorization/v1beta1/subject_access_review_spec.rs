...
pub struct SubjectAccessReviewSpec {
    ...
    pub resource_attributes: Option<::v1_7::kubernetes::pkg::apis::authorization::v1beta1::ResourceAttributes>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_non_resource_attributes: Option<::v1_7::kubernetes::pkg::apis::authorization::v1beta1::NonResourceAttributes> = None;
                let mut value_resource_attributes: Option<::v1_7::kubernetes::pkg::apis::authorization::v1beta1::ResourceAttributes> = None;
