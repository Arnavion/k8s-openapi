...
pub struct LocalSubjectAccessReview {
    ...
    pub spec: crate::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReviewSpec,

    /// Status is filled in by the server and indicates whether the request is allowed or not
    pub status: Option<crate::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReviewStatus>,
}
...
impl LocalSubjectAccessReview {
    ...
    pub fn create_authorization_v1beta1_namespaced_local_subject_access_review(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::authorization::v1beta1::LocalSubjectAccessReview,
        optional: CreateAuthorizationV1beta1NamespacedLocalSubjectAccessReviewOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let CreateAuthorizationV1beta1NamespacedLocalSubjectAccessReviewOptional {
            pretty,
        } = optional;
...
/// Optional parameters of [`LocalSubjectAccessReview::create_authorization_v1beta1_namespaced_local_subject_access_review`](./struct.LocalSubjectAccessReview.html#method.create_authorization_v1beta1_namespaced_local_subject_access_review)
#[derive(Debug, Default)]
pub struct CreateAuthorizationV1beta1NamespacedLocalSubjectAccessReviewOptional<'a> {
...
pub enum CreateAuthorizationV1beta1NamespacedLocalSubjectAccessReviewResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::authorization::v1beta1::LocalSubjectAccessReview),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReviewSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::apis::authorization::v1beta1::SubjectAccessReviewStatus> = None;
