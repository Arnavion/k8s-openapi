...
impl Role {
    ...
    pub fn create_rbac_authorization_v1beta1_namespaced_role(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::rbac::v1beta1::Role,
...
pub enum CreateRbacAuthorizationV1beta1NamespacedRoleResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::rbac::v1beta1::Role),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1beta1CollectionNamespacedRoleResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::rbac::v1beta1::Role),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1beta1NamespacedRoleResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::rbac::v1beta1::RoleList),
    Unauthorized,
    Other,
}
