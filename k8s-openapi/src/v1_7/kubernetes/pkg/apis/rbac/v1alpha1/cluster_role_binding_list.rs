...
pub struct ClusterRoleBindingList {
    ...
    pub items: Vec<crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBinding>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBinding>> = None;
