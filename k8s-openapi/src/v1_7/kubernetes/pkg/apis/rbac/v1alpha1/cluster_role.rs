...
impl ClusterRole {
    ...
    pub fn create_rbac_authorization_v1alpha1_cluster_role(
        body: &crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRole,
        optional: CreateRbacAuthorizationV1alpha1ClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let CreateRbacAuthorizationV1alpha1ClusterRoleOptional {
            pretty,
        } = optional;
...
/// Optional parameters of [`ClusterRole::create_rbac_authorization_v1alpha1_cluster_role`](./struct.ClusterRole.html#method.create_rbac_authorization_v1alpha1_cluster_role)
#[derive(Debug, Default)]
pub struct CreateRbacAuthorizationV1alpha1ClusterRoleOptional<'a> {
...
pub enum CreateRbacAuthorizationV1alpha1ClusterRoleResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRole),
    Unauthorized,
    Other,
}

impl crate::Response for CreateRbacAuthorizationV1alpha1ClusterRoleResponse {
...
impl ClusterRole {
    ...
    pub fn delete_rbac_authorization_v1alpha1_cluster_role(
        name: &str,
        optional: DeleteRbacAuthorizationV1alpha1ClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteRbacAuthorizationV1alpha1ClusterRoleOptional {
...
/// Optional parameters of [`ClusterRole::delete_rbac_authorization_v1alpha1_cluster_role`](./struct.ClusterRole.html#method.delete_rbac_authorization_v1alpha1_cluster_role)
#[derive(Debug, Default)]
pub struct DeleteRbacAuthorizationV1alpha1ClusterRoleOptional<'a> {
...
pub enum DeleteRbacAuthorizationV1alpha1ClusterRoleResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRole),
    Unauthorized,
    Other,
}

impl crate::Response for DeleteRbacAuthorizationV1alpha1ClusterRoleResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl ClusterRole {
    ...
    pub fn delete_rbac_authorization_v1alpha1_collection_cluster_role(
        optional: DeleteRbacAuthorizationV1alpha1CollectionClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteRbacAuthorizationV1alpha1CollectionClusterRoleOptional {
            field_selector,
...
/// Optional parameters of [`ClusterRole::delete_rbac_authorization_v1alpha1_collection_cluster_role`](./struct.ClusterRole.html#method.delete_rbac_authorization_v1alpha1_collection_cluster_role)
#[derive(Debug, Default)]
pub struct DeleteRbacAuthorizationV1alpha1CollectionClusterRoleOptional<'a> {
...
impl crate::Response for DeleteRbacAuthorizationV1alpha1CollectionClusterRoleResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result: serde_json::Map<String, serde_json::Value> = match serde_json::from_slice(buf) {
...
impl ClusterRole {
    ...
    pub fn list_rbac_authorization_v1alpha1_cluster_role(
        optional: ListRbacAuthorizationV1alpha1ClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListRbacAuthorizationV1alpha1ClusterRoleOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`ClusterRole::list_rbac_authorization_v1alpha1_cluster_role`](./struct.ClusterRole.html#method.list_rbac_authorization_v1alpha1_cluster_role)
#[derive(Debug, Default)]
pub struct ListRbacAuthorizationV1alpha1ClusterRoleOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
pub enum ListRbacAuthorizationV1alpha1ClusterRoleResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleList),
    Unauthorized,
    Other,
}

impl crate::Response for ListRbacAuthorizationV1alpha1ClusterRoleResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl ClusterRole {
    ...
    pub fn patch_rbac_authorization_v1alpha1_cluster_role(
        ...
        optional: PatchRbacAuthorizationV1alpha1ClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchRbacAuthorizationV1alpha1ClusterRoleOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}?", name = name);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`ClusterRole::patch_rbac_authorization_v1alpha1_cluster_role`](./struct.ClusterRole.html#method.patch_rbac_authorization_v1alpha1_cluster_role)
#[derive(Debug, Default)]
pub struct PatchRbacAuthorizationV1alpha1ClusterRoleOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for PatchRbacAuthorizationV1alpha1ClusterRoleResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl ClusterRole {
    ...
    pub fn read_rbac_authorization_v1alpha1_cluster_role(
        name: &str,
        optional: ReadRbacAuthorizationV1alpha1ClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadRbacAuthorizationV1alpha1ClusterRoleOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}?", name = name);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`ClusterRole::read_rbac_authorization_v1alpha1_cluster_role`](./struct.ClusterRole.html#method.read_rbac_authorization_v1alpha1_cluster_role)
#[derive(Debug, Default)]
pub struct ReadRbacAuthorizationV1alpha1ClusterRoleOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReadRbacAuthorizationV1alpha1ClusterRoleResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl ClusterRole {
    ...
    pub fn replace_rbac_authorization_v1alpha1_cluster_role(
        name: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRole,
        optional: ReplaceRbacAuthorizationV1alpha1ClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceRbacAuthorizationV1alpha1ClusterRoleOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}?", name = name);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`ClusterRole::replace_rbac_authorization_v1alpha1_cluster_role`](./struct.ClusterRole.html#method.replace_rbac_authorization_v1alpha1_cluster_role)
#[derive(Debug, Default)]
pub struct ReplaceRbacAuthorizationV1alpha1ClusterRoleOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReplaceRbacAuthorizationV1alpha1ClusterRoleResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl ClusterRole {
    ...
    pub fn watch_rbac_authorization_v1alpha1_cluster_role(
        name: &str,
        optional: WatchRbacAuthorizationV1alpha1ClusterRoleOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchRbacAuthorizationV1alpha1ClusterRoleOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`ClusterRole::watch_rbac_authorization_v1alpha1_cluster_role`](./struct.ClusterRole.html#method.watch_rbac_authorization_v1alpha1_cluster_role)
#[derive(Debug, Default)]
pub struct WatchRbacAuthorizationV1alpha1ClusterRoleOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchRbacAuthorizationV1alpha1ClusterRoleResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl ClusterRole {
    ...
    pub fn watch_rbac_authorization_v1alpha1_cluster_role_list(
        optional: WatchRbacAuthorizationV1alpha1ClusterRoleListOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchRbacAuthorizationV1alpha1ClusterRoleListOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`ClusterRole::watch_rbac_authorization_v1alpha1_cluster_role_list`](./struct.ClusterRole.html#method.watch_rbac_authorization_v1alpha1_cluster_role_list)
#[derive(Debug, Default)]
pub struct WatchRbacAuthorizationV1alpha1ClusterRoleListOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchRbacAuthorizationV1alpha1ClusterRoleListResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
