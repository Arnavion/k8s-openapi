...
impl ClusterRoleBinding {
    ...
    pub fn create_rbac_authorization_v1alpha1_cluster_role_binding(
        body: &crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBinding,
        pretty: Option<&str>,
...
pub enum CreateRbacAuthorizationV1alpha1ClusterRoleBindingResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBinding),
    Unauthorized,
    Other,
}
...
pub enum DeleteRbacAuthorizationV1alpha1ClusterRoleBindingResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBinding),
    Unauthorized,
    Other,
}
...
pub enum ListRbacAuthorizationV1alpha1ClusterRoleBindingResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::rbac::v1alpha1::ClusterRoleBindingList),
    Unauthorized,
    Other,
}
