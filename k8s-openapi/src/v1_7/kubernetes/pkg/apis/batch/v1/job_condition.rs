// Generated from definition io.k8s.kubernetes.pkg.apis.batch.v1.JobCondition

/// JobCondition describes current state of a job.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct JobCondition {
    /// Last time the condition was checked.
    pub last_probe_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time>,
...
impl<'de> serde::Deserialize<'de> for JobCondition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct JobCondition")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_last_probe_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time> = None;
...
impl serde::Serialize for JobCondition {
