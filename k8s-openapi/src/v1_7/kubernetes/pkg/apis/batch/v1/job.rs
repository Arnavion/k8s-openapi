...
pub struct Job {
    ...
    pub spec: Option<crate::v1_7::kubernetes::pkg::apis::batch::v1::JobSpec>,

    /// Current status of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_7::kubernetes::pkg::apis::batch::v1::JobStatus>,
}
...
impl Job {
    ...
    pub fn create_batch_v1_namespaced_job(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::batch::v1::Job,
        pretty: Option<&str>,
...
pub enum CreateBatchV1NamespacedJobResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::batch::v1::Job),
    Unauthorized,
    Other,
}
...
pub enum DeleteBatchV1CollectionNamespacedJobResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::batch::v1::Job),
    Unauthorized,
    Other,
}
...
pub enum ListBatchV1JobForAllNamespacesResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::batch::v1::JobList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::apis::batch::v1::JobSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::apis::batch::v1::JobStatus> = None;
