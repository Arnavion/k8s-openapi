...
pub struct InitializerConfiguration {
    ...
    pub initializers: Option<Vec<crate::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::Initializer>>,
...
pub enum CreateAdmissionregistrationV1alpha1InitializerConfigurationResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::InitializerConfiguration),
    Unauthorized,
    Other,
}
...
pub enum DeleteAdmissionregistrationV1alpha1CollectionInitializerConfigurationResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::InitializerConfiguration),
    Unauthorized,
    Other,
}
...
pub enum ListAdmissionregistrationV1alpha1InitializerConfigurationResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::InitializerConfigurationList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_initializers: Option<Vec<crate::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::Initializer>> = None;
