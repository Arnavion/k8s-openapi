// Generated from definition io.k8s.kubernetes.pkg.apis.admissionregistration.v1alpha1.AdmissionHookClientConfig
...
pub struct AdmissionHookClientConfig {
    ...
    pub service: crate::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::ServiceReference,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_service: Option<crate::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::ServiceReference> = None;
