    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_client_config: Option<::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::AdmissionHookClientConfig> = None;
                let mut value_failure_policy: Option<String> = None;
                let mut value_name: Option<String> = None;
                let mut value_rules: Option<Vec<::v1_7::kubernetes::pkg::apis::admissionregistration::v1alpha1::RuleWithOperations>> = None;
