...
pub struct ReplicaSetList {
    ...
    pub items: Vec<crate::v1_7::kubernetes::pkg::apis::extensions::v1beta1::ReplicaSet>,

    /// Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
    pub metadata: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for ReplicaSetList {
...
impl crate::Metadata for ReplicaSetList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::v1_7::kubernetes::pkg::apis::extensions::v1beta1::ReplicaSet>> = None;
