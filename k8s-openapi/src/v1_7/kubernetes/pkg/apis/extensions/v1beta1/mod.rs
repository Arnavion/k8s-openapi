...
mod third_party_resource;
pub use self::third_party_resource::ThirdPartyResource;

mod third_party_resource_list;
pub use self::third_party_resource_list::ThirdPartyResourceList;
