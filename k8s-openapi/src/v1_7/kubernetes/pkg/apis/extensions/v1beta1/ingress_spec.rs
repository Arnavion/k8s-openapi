// Generated from definition io.k8s.kubernetes.pkg.apis.extensions.v1beta1.IngressSpec

/// IngressSpec describes the Ingress the user wishes to exist.
#[derive(Debug, Default)]
pub struct IngressSpec {
    /// A default backend capable of servicing requests that don't match any rule. At least one of 'backend' or 'rules' must be specified. This field is optional to allow the loadbalancer controller or defaulting logic to specify a global default.
    pub backend: Option<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::IngressBackend>,

    /// A list of host rules used to configure the Ingress. If unspecified, or no rule matches, all traffic is sent to the default backend.
    pub rules: Option<Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::IngressRule>>,

    /// TLS configuration. Currently the Ingress only supports a single TLS port, 443. If multiple members of this list specify different hosts, they will be multiplexed on the same port according to the hostname specified through the SNI TLS extension, if the ingress controller fulfilling the ingress supports SNI.
    pub tls: Option<Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::IngressTLS>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_backend: Option<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::IngressBackend> = None;
                let mut value_rules: Option<Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::IngressRule>> = None;
                let mut value_tls: Option<Vec<::v1_7::kubernetes::pkg::apis::extensions::v1beta1::IngressTLS>> = None;
...
impl ::serde::Serialize for IngressSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: ::serde::Serializer {
        let mut state = serializer.serialize_struct(
            "IngressSpec",
            0 +
            (if self.backend.is_some() { 1 } else { 0 }) +
            (if self.rules.is_some() { 1 } else { 0 }) +
            (if self.tls.is_some() { 1 } else { 0 }),
        )?;
