// Generated from definition io.k8s.kubernetes.pkg.apis.extensions.v1beta1.RollingUpdateDeployment
...
pub struct RollingUpdateDeployment {
    ...
    pub max_surge: Option<::v1_7::apimachinery::pkg::util::intstr::IntOrString>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_max_surge: Option<::v1_7::apimachinery::pkg::util::intstr::IntOrString> = None;
...
impl ::serde::Serialize for RollingUpdateDeployment {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: ::serde::Serializer {
        let mut state = serializer.serialize_struct(
            "RollingUpdateDeployment",
            0 +
            (if self.max_surge.is_some() { 1 } else { 0 }) +
