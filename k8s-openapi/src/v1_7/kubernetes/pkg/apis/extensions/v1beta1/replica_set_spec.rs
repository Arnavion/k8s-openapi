// Generated from definition io.k8s.kubernetes.pkg.apis.extensions.v1beta1.ReplicaSetSpec
...
pub struct ReplicaSetSpec {
    ...
    pub template: Option<crate::v1_7::kubernetes::pkg::api::v1::PodTemplateSpec>,
}
