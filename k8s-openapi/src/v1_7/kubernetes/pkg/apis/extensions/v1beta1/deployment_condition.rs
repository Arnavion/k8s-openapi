// Generated from definition io.k8s.kubernetes.pkg.apis.extensions.v1beta1.DeploymentCondition
...
pub struct DeploymentCondition {
    ...
    pub last_update_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time>,
...
impl<'de> serde::Deserialize<'de> for DeploymentCondition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
                write!(f, "struct DeploymentCondition")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_last_transition_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_last_update_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time> = None;
