...
pub struct DeploymentRollback {
    ...
    pub rollback_to: crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::RollbackConfig,
...
impl DeploymentRollback {
    ...
    pub fn create_apps_v1beta1_namespaced_deployment_rollback(
        name: &str,
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::DeploymentRollback,
        pretty: Option<&str>,
...
pub enum CreateAppsV1beta1NamespacedDeploymentRollbackResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::DeploymentRollback),
    Unauthorized,
    Other,
}
