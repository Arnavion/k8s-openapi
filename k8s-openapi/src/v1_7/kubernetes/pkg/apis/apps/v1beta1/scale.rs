...
pub struct Scale {
    ...
    pub spec: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::ScaleSpec>,

    /// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. Read-only.
    pub status: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::ScaleStatus>,
}
...
pub enum PatchAppsV1beta1NamespacedDeploymentScaleResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::Scale),
    Unauthorized,
    Other,
}
...
impl Scale {
    ...
    pub fn replace_apps_v1beta1_namespaced_deployment_scale(
        name: &str,
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::Scale,
        pretty: Option<&str>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}/scale?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::ScaleSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::ScaleStatus> = None;
