...
pub struct Deployment {
    ...
    pub spec: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::DeploymentStatus>,
}
...
impl Deployment {
    ...
    pub fn create_apps_v1beta1_namespaced_deployment(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::Deployment,
        optional: CreateAppsV1beta1NamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let CreateAppsV1beta1NamespacedDeploymentOptional {
            pretty,
        } = optional;
...
/// Optional parameters of [`Deployment::create_apps_v1beta1_namespaced_deployment`](./struct.Deployment.html#method.create_apps_v1beta1_namespaced_deployment)
#[derive(Debug, Default)]
pub struct CreateAppsV1beta1NamespacedDeploymentOptional<'a> {
...
pub enum CreateAppsV1beta1NamespacedDeploymentResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::Deployment),
    Unauthorized,
    Other,
}

impl crate::Response for CreateAppsV1beta1NamespacedDeploymentResponse {
...
impl Deployment {
    ...
    pub fn delete_apps_v1beta1_collection_namespaced_deployment(
        namespace: &str,
        optional: DeleteAppsV1beta1CollectionNamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteAppsV1beta1CollectionNamespacedDeploymentOptional {
            field_selector,
...
/// Optional parameters of [`Deployment::delete_apps_v1beta1_collection_namespaced_deployment`](./struct.Deployment.html#method.delete_apps_v1beta1_collection_namespaced_deployment)
#[derive(Debug, Default)]
pub struct DeleteAppsV1beta1CollectionNamespacedDeploymentOptional<'a> {
...
pub enum DeleteAppsV1beta1CollectionNamespacedDeploymentResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::Deployment),
    Unauthorized,
    Other,
}

impl crate::Response for DeleteAppsV1beta1CollectionNamespacedDeploymentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl Deployment {
    ...
    pub fn delete_apps_v1beta1_namespaced_deployment(
        name: &str,
        namespace: &str,
        optional: DeleteAppsV1beta1NamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteAppsV1beta1NamespacedDeploymentOptional {
...
/// Optional parameters of [`Deployment::delete_apps_v1beta1_namespaced_deployment`](./struct.Deployment.html#method.delete_apps_v1beta1_namespaced_deployment)
#[derive(Debug, Default)]
pub struct DeleteAppsV1beta1NamespacedDeploymentOptional<'a> {
...
impl crate::Response for DeleteAppsV1beta1NamespacedDeploymentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result: serde_json::Map<String, serde_json::Value> = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn list_apps_v1beta1_deployment_for_all_namespaces(
        optional: ListAppsV1beta1DeploymentForAllNamespacesOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListAppsV1beta1DeploymentForAllNamespacesOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`Deployment::list_apps_v1beta1_deployment_for_all_namespaces`](./struct.Deployment.html#method.list_apps_v1beta1_deployment_for_all_namespaces)
#[derive(Debug, Default)]
pub struct ListAppsV1beta1DeploymentForAllNamespacesOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
pub enum ListAppsV1beta1DeploymentForAllNamespacesResponse {
    Ok(crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::DeploymentList),
    Unauthorized,
    Other,
}

impl crate::Response for ListAppsV1beta1DeploymentForAllNamespacesResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn list_apps_v1beta1_namespaced_deployment(
        namespace: &str,
        optional: ListAppsV1beta1NamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListAppsV1beta1NamespacedDeploymentOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`Deployment::list_apps_v1beta1_namespaced_deployment`](./struct.Deployment.html#method.list_apps_v1beta1_namespaced_deployment)
#[derive(Debug, Default)]
pub struct ListAppsV1beta1NamespacedDeploymentOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for ListAppsV1beta1NamespacedDeploymentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn patch_apps_v1beta1_namespaced_deployment(
        ...
        optional: PatchAppsV1beta1NamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchAppsV1beta1NamespacedDeploymentOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`Deployment::patch_apps_v1beta1_namespaced_deployment`](./struct.Deployment.html#method.patch_apps_v1beta1_namespaced_deployment)
#[derive(Debug, Default)]
pub struct PatchAppsV1beta1NamespacedDeploymentOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for PatchAppsV1beta1NamespacedDeploymentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn patch_apps_v1beta1_namespaced_deployment_status(
        ...
        namespace: &str,
        body: &crate::v1_7::apimachinery::pkg::apis::meta::v1::Patch,
        optional: PatchAppsV1beta1NamespacedDeploymentStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchAppsV1beta1NamespacedDeploymentStatusOptional {
            pretty,
        } = optional;
...
/// Optional parameters of [`Deployment::patch_apps_v1beta1_namespaced_deployment_status`](./struct.Deployment.html#method.patch_apps_v1beta1_namespaced_deployment_status)
#[derive(Debug, Default)]
pub struct PatchAppsV1beta1NamespacedDeploymentStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for PatchAppsV1beta1NamespacedDeploymentStatusResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn read_apps_v1beta1_namespaced_deployment(
        name: &str,
        namespace: &str,
        optional: ReadAppsV1beta1NamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadAppsV1beta1NamespacedDeploymentOptional {
            exact,
            export,
            pretty,
        } = optional;
...
/// Optional parameters of [`Deployment::read_apps_v1beta1_namespaced_deployment`](./struct.Deployment.html#method.read_apps_v1beta1_namespaced_deployment)
#[derive(Debug, Default)]
pub struct ReadAppsV1beta1NamespacedDeploymentOptional<'a> {
...
impl crate::Response for ReadAppsV1beta1NamespacedDeploymentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn read_apps_v1beta1_namespaced_deployment_status(
        name: &str,
        namespace: &str,
        optional: ReadAppsV1beta1NamespacedDeploymentStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadAppsV1beta1NamespacedDeploymentStatusOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}/status?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`Deployment::read_apps_v1beta1_namespaced_deployment_status`](./struct.Deployment.html#method.read_apps_v1beta1_namespaced_deployment_status)
#[derive(Debug, Default)]
pub struct ReadAppsV1beta1NamespacedDeploymentStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReadAppsV1beta1NamespacedDeploymentStatusResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn replace_apps_v1beta1_namespaced_deployment(
        ...
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::Deployment,
        optional: ReplaceAppsV1beta1NamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceAppsV1beta1NamespacedDeploymentOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`Deployment::replace_apps_v1beta1_namespaced_deployment`](./struct.Deployment.html#method.replace_apps_v1beta1_namespaced_deployment)
#[derive(Debug, Default)]
pub struct ReplaceAppsV1beta1NamespacedDeploymentOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReplaceAppsV1beta1NamespacedDeploymentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn replace_apps_v1beta1_namespaced_deployment_status(
        ...
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::Deployment,
        optional: ReplaceAppsV1beta1NamespacedDeploymentStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceAppsV1beta1NamespacedDeploymentStatusOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}/status?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`Deployment::replace_apps_v1beta1_namespaced_deployment_status`](./struct.Deployment.html#method.replace_apps_v1beta1_namespaced_deployment_status)
#[derive(Debug, Default)]
pub struct ReplaceAppsV1beta1NamespacedDeploymentStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl crate::Response for ReplaceAppsV1beta1NamespacedDeploymentStatusResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl Deployment {
    ...
    pub fn watch_apps_v1beta1_deployment_list_for_all_namespaces(
        optional: WatchAppsV1beta1DeploymentListForAllNamespacesOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAppsV1beta1DeploymentListForAllNamespacesOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`Deployment::watch_apps_v1beta1_deployment_list_for_all_namespaces`](./struct.Deployment.html#method.watch_apps_v1beta1_deployment_list_for_all_namespaces)
#[derive(Debug, Default)]
pub struct WatchAppsV1beta1DeploymentListForAllNamespacesOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchAppsV1beta1DeploymentListForAllNamespacesResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl Deployment {
    ...
    pub fn watch_apps_v1beta1_namespaced_deployment(
        name: &str,
        namespace: &str,
        optional: WatchAppsV1beta1NamespacedDeploymentOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAppsV1beta1NamespacedDeploymentOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`Deployment::watch_apps_v1beta1_namespaced_deployment`](./struct.Deployment.html#method.watch_apps_v1beta1_namespaced_deployment)
#[derive(Debug, Default)]
pub struct WatchAppsV1beta1NamespacedDeploymentOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchAppsV1beta1NamespacedDeploymentResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
...
impl Deployment {
    ...
    pub fn watch_apps_v1beta1_namespaced_deployment_list(
        namespace: &str,
        optional: WatchAppsV1beta1NamespacedDeploymentListOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAppsV1beta1NamespacedDeploymentListOptional {
            field_selector,
            include_uninitialized,
            label_selector,
            pretty,
...
/// Optional parameters of [`Deployment::watch_apps_v1beta1_namespaced_deployment_list`](./struct.Deployment.html#method.watch_apps_v1beta1_namespaced_deployment_list)
#[derive(Debug, Default)]
pub struct WatchAppsV1beta1NamespacedDeploymentListOptional<'a> {
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything.
    pub field_selector: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
impl crate::Response for WatchAppsV1beta1NamespacedDeploymentListResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::DeploymentSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::apis::apps::v1beta1::DeploymentStatus> = None;
