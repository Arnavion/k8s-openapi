...
pub struct StorageClassList {
    ...
    pub items: Vec<crate::v1_7::kubernetes::pkg::apis::storage::v1beta1::StorageClass>,

    /// Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    pub metadata: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::ListMeta>,
}

impl crate::Resource for StorageClassList {
...
impl crate::Metadata for StorageClassList {
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_items: Option<Vec<crate::v1_7::kubernetes::pkg::apis::storage::v1beta1::StorageClass>> = None;
