...
pub struct PersistentVolume {
    ...
    pub spec: Option<crate::v1_7::kubernetes::pkg::api::v1::PersistentVolumeSpec>,

    /// Status represents the current information/status for the persistent volume. Populated by the system. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
    pub status: Option<crate::v1_7::kubernetes::pkg::api::v1::PersistentVolumeStatus>,
}
...
pub enum CreateCoreV1PersistentVolumeResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::PersistentVolume),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionPersistentVolumeResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::api::v1::PersistentVolume),
    Unauthorized,
    Other,
}
...
pub enum ListCoreV1PersistentVolumeResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::PersistentVolumeList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::api::v1::PersistentVolumeSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::api::v1::PersistentVolumeStatus> = None;
