// Generated from definition io.k8s.kubernetes.pkg.api.v1.PodAffinity
...
pub struct PodAffinity {
    ...
    pub preferred_during_scheduling_ignored_during_execution: Option<Vec<crate::v1_7::kubernetes::pkg::api::v1::WeightedPodAffinityTerm>>,
    ...
    pub required_during_scheduling_ignored_during_execution: Option<Vec<crate::v1_7::kubernetes::pkg::api::v1::PodAffinityTerm>>,
}
...
impl<'de> serde::Deserialize<'de> for PodAffinity {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
                write!(f, "struct PodAffinity")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_preferred_during_scheduling_ignored_during_execution: Option<Vec<crate::v1_7::kubernetes::pkg::api::v1::WeightedPodAffinityTerm>> = None;
                let mut value_required_during_scheduling_ignored_during_execution: Option<Vec<crate::v1_7::kubernetes::pkg::api::v1::PodAffinityTerm>> = None;
