// Generated from definition io.k8s.kubernetes.pkg.api.v1.SecretVolumeSource
...
pub struct SecretVolumeSource {
    ...
    pub items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::KeyToPath>>,
...
impl<'de> ::serde::Deserialize<'de> for SecretVolumeSource {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "struct SecretVolumeSource")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_default_mode: Option<i32> = None;
                let mut value_items: Option<Vec<::v1_7::kubernetes::pkg::api::v1::KeyToPath>> = None;
...
impl ::serde::Serialize for SecretVolumeSource {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: ::serde::Serializer {
        let mut state = serializer.serialize_struct(
            ...
            (if self.secret_name.is_some() { 1 } else { 0 }),
        )?;
