...
impl PodTemplate {
    ...
    pub fn create_core_v1_namespaced_pod_template(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::api::v1::PodTemplate,
...
pub enum CreateCoreV1NamespacedPodTemplateResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::PodTemplate),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNamespacedPodTemplateResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::api::v1::PodTemplate),
    Unauthorized,
    Other,
}
...
pub enum ListCoreV1NamespacedPodTemplateResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::PodTemplateList),
    Unauthorized,
    Other,
}
