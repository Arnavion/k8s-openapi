...
pub struct ContainerStatus {
    ...
    pub last_state: Option<::v1_7::kubernetes::pkg::api::v1::ContainerState>,
    ...
    pub state: Option<::v1_7::kubernetes::pkg::api::v1::ContainerState>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_last_state: Option<::v1_7::kubernetes::pkg::api::v1::ContainerState> = None;
                let mut value_name: Option<String> = None;
                let mut value_ready: Option<bool> = None;
                let mut value_restart_count: Option<i32> = None;
                let mut value_state: Option<::v1_7::kubernetes::pkg::api::v1::ContainerState> = None;
