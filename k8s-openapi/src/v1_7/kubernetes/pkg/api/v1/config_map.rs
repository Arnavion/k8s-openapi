...
impl ConfigMap {
    ...
    pub fn create_core_v1_namespaced_config_map(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::api::v1::ConfigMap,
        pretty: Option<&str>,
...
pub enum CreateCoreV1NamespacedConfigMapResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::ConfigMap),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNamespacedConfigMapResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::api::v1::ConfigMap),
    Unauthorized,
    Other,
}
...
pub enum ListCoreV1ConfigMapForAllNamespacesResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::ConfigMapList),
    Unauthorized,
    Other,
}
