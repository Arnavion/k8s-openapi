// Generated from definition io.k8s.kubernetes.pkg.api.v1.StorageOSPersistentVolumeSource
...
pub struct StorageOSPersistentVolumeSource {
    ...
    pub secret_ref: Option<crate::v1_7::kubernetes::pkg::api::v1::ObjectReference>,
...
impl<'de> serde::Deserialize<'de> for StorageOSPersistentVolumeSource {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
                write!(f, "struct StorageOSPersistentVolumeSource")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_fs_type: Option<String> = None;
                let mut value_read_only: Option<bool> = None;
                let mut value_secret_ref: Option<crate::v1_7::kubernetes::pkg::api::v1::ObjectReference> = None;
