// Generated from definition io.k8s.kubernetes.pkg.api.v1.DownwardAPIVolumeSource
...
pub struct DownwardAPIVolumeSource {
    ...
    pub items: Option<Vec<crate::v1_7::kubernetes::pkg::api::v1::DownwardAPIVolumeFile>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_items: Option<Vec<crate::v1_7::kubernetes::pkg::api::v1::DownwardAPIVolumeFile>> = None;
