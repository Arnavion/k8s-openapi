...
pub struct ContainerState {
    ...
    pub running: Option<crate::v1_7::kubernetes::pkg::api::v1::ContainerStateRunning>,

    /// Details about a terminated container
    pub terminated: Option<crate::v1_7::kubernetes::pkg::api::v1::ContainerStateTerminated>,

    /// Details about a waiting container
    pub waiting: Option<crate::v1_7::kubernetes::pkg::api::v1::ContainerStateWaiting>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_running: Option<crate::v1_7::kubernetes::pkg::api::v1::ContainerStateRunning> = None;
                let mut value_terminated: Option<crate::v1_7::kubernetes::pkg::api::v1::ContainerStateTerminated> = None;
                let mut value_waiting: Option<crate::v1_7::kubernetes::pkg::api::v1::ContainerStateWaiting> = None;
