// Generated from definition io.k8s.kubernetes.pkg.api.v1.CephFSVolumeSource
...
pub struct CephFSVolumeSource {
    ...
    pub secret_ref: Option<crate::v1_7::kubernetes::pkg::api::v1::LocalObjectReference>,
...
impl<'de> serde::Deserialize<'de> for CephFSVolumeSource {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
                write!(f, "struct CephFSVolumeSource")
            }
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_secret_ref: Option<crate::v1_7::kubernetes::pkg::api::v1::LocalObjectReference> = None;
