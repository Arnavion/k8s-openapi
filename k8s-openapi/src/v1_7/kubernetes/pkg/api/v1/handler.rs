...
pub struct Handler {
    ...
    pub exec: Option<::v1_7::kubernetes::pkg::api::v1::ExecAction>,

    /// HTTPGet specifies the http request to perform.
    pub http_get: Option<::v1_7::kubernetes::pkg::api::v1::HTTPGetAction>,

    /// TCPSocket specifies an action involving a TCP port. TCP hooks not yet supported
    pub tcp_socket: Option<::v1_7::kubernetes::pkg::api::v1::TCPSocketAction>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_exec: Option<::v1_7::kubernetes::pkg::api::v1::ExecAction> = None;
                let mut value_http_get: Option<::v1_7::kubernetes::pkg::api::v1::HTTPGetAction> = None;
                let mut value_tcp_socket: Option<::v1_7::kubernetes::pkg::api::v1::TCPSocketAction> = None;
