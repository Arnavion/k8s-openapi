// Generated from definition io.k8s.kubernetes.pkg.api.v1.Lifecycle
...
pub struct Lifecycle {
    ...
    pub post_start: Option<crate::v1_7::kubernetes::pkg::api::v1::Handler>,

    /// PreStop is called immediately before a container is terminated. The container is terminated after the handler completes. The reason for termination is passed to the handler. Regardless of the outcome of the handler, the container is eventually terminated. Other management of the container blocks until the hook completes. More info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks
    pub pre_stop: Option<crate::v1_7::kubernetes::pkg::api::v1::Handler>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_post_start: Option<crate::v1_7::kubernetes::pkg::api::v1::Handler> = None;
                let mut value_pre_stop: Option<crate::v1_7::kubernetes::pkg::api::v1::Handler> = None;
