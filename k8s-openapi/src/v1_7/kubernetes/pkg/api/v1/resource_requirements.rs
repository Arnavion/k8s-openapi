...
pub struct ResourceRequirements {
    ...
    pub requests: Option<::std::collections::BTreeMap<String, ::v1_7::apimachinery::pkg::api::resource::Quantity>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_limits: Option<::std::collections::BTreeMap<String, ::v1_7::apimachinery::pkg::api::resource::Quantity>> = None;
                let mut value_requests: Option<::std::collections::BTreeMap<String, ::v1_7::apimachinery::pkg::api::resource::Quantity>> = None;
