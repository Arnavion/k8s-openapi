...
pub struct NodeCondition {
    ...
    pub last_heartbeat_time: Option<::v1_7::apimachinery::pkg::apis::meta::v1::Time>,

    /// Last time the condition transit from one status to another.
    pub last_transition_time: Option<::v1_7::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_last_heartbeat_time: Option<::v1_7::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_last_transition_time: Option<::v1_7::apimachinery::pkg::apis::meta::v1::Time> = None;
