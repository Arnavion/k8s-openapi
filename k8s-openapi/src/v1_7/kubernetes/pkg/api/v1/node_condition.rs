// Generated from definition io.k8s.kubernetes.pkg.api.v1.NodeCondition

/// NodeCondition contains condition information for a node.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct NodeCondition {
    /// Last time we got an update on a given condition.
    pub last_heartbeat_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time>,

    /// Last time the condition transit from one status to another.
    pub last_transition_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time>,
...
impl<'de> serde::Deserialize<'de> for NodeCondition {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
                write!(f, "struct NodeCondition")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_last_heartbeat_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_last_transition_time: Option<crate::v1_7::apimachinery::pkg::apis::meta::v1::Time> = None;
                ...
                while let Some(key) = serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_last_heartbeat_time => value_last_heartbeat_time = serde::de::MapAccess::next_value(&mut map)?,
