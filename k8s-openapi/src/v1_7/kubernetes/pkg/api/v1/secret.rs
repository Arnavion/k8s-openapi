...
impl Secret {
    ...
    pub fn create_core_v1_namespaced_secret(
        namespace: &str,
        body: &crate::v1_7::kubernetes::pkg::api::v1::Secret,
        pretty: Option<&str>,
...
pub enum CreateCoreV1NamespacedSecretResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::Secret),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNamespacedSecretResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::api::v1::Secret),
    Unauthorized,
    Other,
}
...
pub enum ListCoreV1NamespacedSecretResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::SecretList),
    Unauthorized,
    Other,
}
