...
pub struct Node {
    ...
    pub spec: Option<crate::v1_7::kubernetes::pkg::api::v1::NodeSpec>,

    /// Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
    pub status: Option<crate::v1_7::kubernetes::pkg::api::v1::NodeStatus>,
}
...
pub enum CreateCoreV1NodeResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::Node),
    Unauthorized,
    Other,
}
...
pub enum DeleteCoreV1CollectionNodeResponse {
    ...
    OkValue(crate::v1_7::kubernetes::pkg::api::v1::Node),
    Unauthorized,
    Other,
}
...
pub enum ListCoreV1NodeResponse {
    Ok(crate::v1_7::kubernetes::pkg::api::v1::NodeList),
    Unauthorized,
    Other,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::v1_7::kubernetes::pkg::api::v1::NodeSpec> = None;
                let mut value_status: Option<crate::v1_7::kubernetes::pkg::api::v1::NodeStatus> = None;
