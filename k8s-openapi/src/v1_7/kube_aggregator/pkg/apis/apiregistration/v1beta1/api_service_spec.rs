...
pub struct APIServiceSpec {
    ...
    pub service: ::v1_7::kube_aggregator::pkg::apis::apiregistration::v1beta1::ServiceReference,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_service: Option<::v1_7::kube_aggregator::pkg::apis::apiregistration::v1beta1::ServiceReference> = None;
