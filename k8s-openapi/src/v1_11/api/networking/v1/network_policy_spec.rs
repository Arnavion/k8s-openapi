...
pub struct NetworkPolicySpec {
    ...
    pub egress: Option<Vec<crate::v1_11::api::networking::v1::NetworkPolicyEgressRule>>,

    /// List of ingress rules to be applied to the selected pods. Traffic is allowed to a pod if there are no NetworkPolicies selecting the pod (and cluster policy otherwise allows the traffic), OR if the traffic source is the pod's local node, OR if the traffic matches at least one ingress rule across all of the NetworkPolicy objects whose podSelector matches the pod. If this field is empty then this NetworkPolicy does not allow any traffic (and serves solely to ensure that the pods it selects are isolated by default)
    pub ingress: Option<Vec<crate::v1_11::api::networking::v1::NetworkPolicyIngressRule>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_egress: Option<Vec<crate::v1_11::api::networking::v1::NetworkPolicyEgressRule>> = None;
                let mut value_ingress: Option<Vec<crate::v1_11::api::networking::v1::NetworkPolicyIngressRule>> = None;
