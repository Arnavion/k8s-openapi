...
pub struct SubjectRulesReviewStatus {
    ...
    pub non_resource_rules: Vec<::v1_11::api::authorization::v1beta1::NonResourceRule>,

    /// ResourceRules is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
    pub resource_rules: Vec<::v1_11::api::authorization::v1beta1::ResourceRule>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_non_resource_rules: Option<Vec<::v1_11::api::authorization::v1beta1::NonResourceRule>> = None;
                let mut value_resource_rules: Option<Vec<::v1_11::api::authorization::v1beta1::ResourceRule>> = None;
