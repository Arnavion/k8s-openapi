...
pub struct CronJobStatus {
    ...
    pub active: Option<Vec<::v1_11::api::core::v1::ObjectReference>>,

    /// Information when was the last time the job was successfully scheduled.
    pub last_schedule_time: Option<::v1_11::apimachinery::pkg::apis::meta::v1::Time>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_active: Option<Vec<::v1_11::api::core::v1::ObjectReference>> = None;
                let mut value_last_schedule_time: Option<::v1_11::apimachinery::pkg::apis::meta::v1::Time> = None;
