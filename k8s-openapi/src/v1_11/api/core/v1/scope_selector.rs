...
pub struct ScopeSelector {
    ...
    pub match_expressions: Option<Vec<crate::v1_11::api::core::v1::ScopedResourceSelectorRequirement>>,
}
...
impl<'de> serde::Deserialize<'de> for ScopeSelector {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct ScopeSelector")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_match_expressions: Option<Vec<crate::v1_11::api::core::v1::ScopedResourceSelectorRequirement>> = None;
