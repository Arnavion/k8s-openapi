...
pub struct Probe {
    ...
    pub exec: Option<::v1_11::api::core::v1::ExecAction>,

    /// Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1.
    pub failure_threshold: Option<i32>,

    /// HTTPGet specifies the http request to perform.
    pub http_get: Option<::v1_11::api::core::v1::HTTPGetAction>,
    ...
    pub tcp_socket: Option<::v1_11::api::core::v1::TCPSocketAction>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_exec: Option<::v1_11::api::core::v1::ExecAction> = None;
                let mut value_failure_threshold: Option<i32> = None;
                let mut value_http_get: Option<::v1_11::api::core::v1::HTTPGetAction> = None;
                ...
                let mut value_tcp_socket: Option<::v1_11::api::core::v1::TCPSocketAction> = None;
