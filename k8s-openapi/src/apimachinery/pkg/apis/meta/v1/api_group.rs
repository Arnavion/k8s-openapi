...
pub struct APIGroup {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub preferred_version: Option<::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery>,
    ...
    pub versions: Vec<::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery>,
}
