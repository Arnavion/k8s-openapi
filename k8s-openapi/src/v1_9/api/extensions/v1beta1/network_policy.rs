    ...
    pub fn create_extensions_v1beta1_namespaced_network_policy<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1NamespacedNetworkPolicyResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1NamespacedNetworkPolicyResponse::Accepted(result)
            },
...
impl NetworkPolicy {
    ...
    pub fn replace_extensions_v1beta1_namespaced_network_policy<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceExtensionsV1beta1NamespacedNetworkPolicyResponse::Created(result)
            },
