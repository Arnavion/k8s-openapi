    ...
    pub fn create_extensions_v1beta1_pod_security_policy<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1PodSecurityPolicyResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1PodSecurityPolicyResponse::Accepted(result)
            },
...
impl PodSecurityPolicy {
    ...
    pub fn replace_extensions_v1beta1_pod_security_policy<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceExtensionsV1beta1PodSecurityPolicyResponse::Created(result)
            },
