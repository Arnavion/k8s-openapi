...
#[derive(Debug)]
pub enum CreateStorageV1StorageClassResponse<R> where R: ::std::io::Read {
...
impl StorageClass {
    ...
    pub fn create_storage_v1_storage_class<C>(
        __client: &C,
        body: &::v1_9::api::storage::v1::StorageClass,
        // If 'true', then the output is pretty printed.
        pretty: Option<&str>,
    ) -> Result<CreateStorageV1StorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/storageclasses")).map_err(::Error::URL)?;
        {
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                ...
                CreateStorageV1StorageClassResponse::Ok(result)
            },
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateStorageV1StorageClassResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateStorageV1StorageClassResponse::Accepted(result)
            },
            ::http::StatusCode::UNAUTHORIZED => CreateStorageV1StorageClassResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum DeleteStorageV1CollectionStorageClassResponse<R> where R: ::std::io::Read {
...
impl StorageClass {
    ...
    pub fn delete_storage_v1_collection_storage_class<C>(
        __client: &C,
        ...
        watch: Option<bool>,
    ) -> Result<DeleteStorageV1CollectionStorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/storageclasses")).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                DeleteStorageV1CollectionStorageClassResponse::Ok(result)
            },
            ::http::StatusCode::UNAUTHORIZED => DeleteStorageV1CollectionStorageClassResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum DeleteStorageV1StorageClassResponse<R> where R: ::std::io::Read {
    Ok(::v1_9::apimachinery::pkg::apis::meta::v1::Status),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
impl StorageClass {
    ...
    pub fn delete_storage_v1_storage_class<C>(
        __client: &C,
    ...
    ) -> Result<DeleteStorageV1StorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/storageclasses/{name}", name = name)).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                DeleteStorageV1StorageClassResponse::Ok(result)
            },
            ::http::StatusCode::UNAUTHORIZED => DeleteStorageV1StorageClassResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum ListStorageV1StorageClassResponse<R> where R: ::std::io::Read {
...
impl StorageClass {
    ...
    pub fn list_storage_v1_storage_class<C>(
        __client: &C,
        // The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server the server will respond with a 410 ResourceExpired error indicating the client must restart their list without the continue field. This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
        continue_: Option<&str>,
        // A selector to restrict the list of returned objects by their fields. Defaults to everything.
        ...
        // Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
        watch: Option<bool>,
    ) -> Result<ListStorageV1StorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/storageclasses")).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
            if let Some(continue_) = continue_ {
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ListStorageV1StorageClassResponse::Ok(result)
            },
            ::http::StatusCode::UNAUTHORIZED => ListStorageV1StorageClassResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum PatchStorageV1StorageClassResponse<R> where R: ::std::io::Read {
    Ok(::v1_9::api::storage::v1::StorageClass),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
impl StorageClass {
    ...
    pub fn patch_storage_v1_storage_class<C>(
        __client: &C,
        // name of the StorageClass
        name: &str,
        ...
        // If 'true', then the output is pretty printed.
        pretty: Option<&str>,
    ) -> Result<PatchStorageV1StorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/storageclasses/{name}", name = name)).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
            if let Some(pretty) = pretty {
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                PatchStorageV1StorageClassResponse::Ok(result)
            },
            ::http::StatusCode::UNAUTHORIZED => PatchStorageV1StorageClassResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum ReadStorageV1StorageClassResponse<R> where R: ::std::io::Read {
    Ok(::v1_9::api::storage::v1::StorageClass),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
impl StorageClass {
    ...
    pub fn read_storage_v1_storage_class<C>(
        __client: &C,
        // name of the StorageClass
        name: &str,
        ...
        // If 'true', then the output is pretty printed.
        pretty: Option<&str>,
    ) -> Result<ReadStorageV1StorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/storageclasses/{name}", name = name)).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReadStorageV1StorageClassResponse::Ok(result)
            },
            ::http::StatusCode::UNAUTHORIZED => ReadStorageV1StorageClassResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum ReplaceStorageV1StorageClassResponse<R> where R: ::std::io::Read {
    Ok(::v1_9::api::storage::v1::StorageClass),
    Created(::v1_9::api::storage::v1::StorageClass),
    Unauthorized(R),
    Other(::http::StatusCode, R),
...
impl StorageClass {
    ...
    pub fn replace_storage_v1_storage_class<C>(
        __client: &C,
        // name of the StorageClass
        name: &str,
        body: &::v1_9::api::storage::v1::StorageClass,
        // If 'true', then the output is pretty printed.
        pretty: Option<&str>,
    ) -> Result<ReplaceStorageV1StorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/storageclasses/{name}", name = name)).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
            if let Some(pretty) = pretty {
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceStorageV1StorageClassResponse::Ok(result)
            },
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceStorageV1StorageClassResponse::Created(result)
            },
            ::http::StatusCode::UNAUTHORIZED => ReplaceStorageV1StorageClassResponse::Unauthorized(response),
...
pub enum WatchStorageV1StorageClassResponse<R> where R: ::std::io::Read {
...
impl StorageClass {
    ...
    pub fn watch_storage_v1_storage_class<C>(
        __client: &C,
        // name of the StorageClass
        name: &str,
        // The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server the server will respond with a 410 ResourceExpired error indicating the client must restart their list without the continue field. This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
        ...
        // Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
        watch: Option<bool>,
    ) -> Result<WatchStorageV1StorageClassResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/watch/storageclasses/{name}", name = name)).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
            if let Some(continue_) = continue_ {
                __query_pairs.append_pair("continue", &continue_);
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                ...
                WatchStorageV1StorageClassResponse::Ok(result)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchStorageV1StorageClassResponse::Unauthorized(response),
...
pub enum WatchStorageV1StorageClassListResponse<R> where R: ::std::io::Read {
    Ok(::serde_json::StreamDeserializer<'static, ::serde_json::de::IoRead<R>, ::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent>),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
impl StorageClass {
    ...
    pub fn watch_storage_v1_storage_class_list<C>(
        __client: &C,
        // The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server the server will respond with a 410 ResourceExpired error indicating the client must restart their list without the continue field. This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
        continue_: Option<&str>,
        // A selector to restrict the list of returned objects by their fields. Defaults to everything.
        ...
        // Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
        watch: Option<bool>,
    ) -> Result<WatchStorageV1StorageClassListResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
        let mut __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1/watch/storageclasses")).map_err(::Error::URL)?;
        {
            let mut __query_pairs = __url.query_pairs_mut();
            if let Some(continue_) = continue_ {
                __query_pairs.append_pair("continue", &continue_);
        ...
        Ok(match ::Response::status_code(&response) {
            ::http::StatusCode::OK => {
                let result = ::serde_json::Deserializer::from_reader(response).into_iter();
                WatchStorageV1StorageClassListResponse::Ok(result)
            },
            ::http::StatusCode::UNAUTHORIZED => WatchStorageV1StorageClassListResponse::Unauthorized(response),
