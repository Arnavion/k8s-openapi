    ...
    pub fn create_apps_v1beta1_namespaced_stateful_set<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAppsV1beta1NamespacedStatefulSetResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAppsV1beta1NamespacedStatefulSetResponse::Accepted(result)
            },
...
impl StatefulSet {
    ...
    pub fn replace_apps_v1beta1_namespaced_stateful_set<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceAppsV1beta1NamespacedStatefulSetResponse::Created(result)
            },
...
impl StatefulSet {
    ...
    pub fn replace_apps_v1beta1_namespaced_stateful_set_status<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceAppsV1beta1NamespacedStatefulSetStatusResponse::Created(result)
            },
