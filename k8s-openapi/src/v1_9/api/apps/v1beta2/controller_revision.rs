    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                ...
                Ok((DeleteAppsV1beta2CollectionNamespacedControllerRevisionResponse::Ok(result), buf.len()))
            },
    ...
    fn try_from_parts(status_code: ::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), ::ResponseError> {
        match status_code {
            ::http::StatusCode::OK => {
                ...
                Ok((DeleteAppsV1beta2NamespacedControllerRevisionResponse::Ok(result), buf.len()))
            },
