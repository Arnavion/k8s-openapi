    ...
    pub fn create_admissionregistration_v1alpha1_initializer_configuration<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAdmissionregistrationV1alpha1InitializerConfigurationResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAdmissionregistrationV1alpha1InitializerConfigurationResponse::Accepted(result)
            },
...
impl InitializerConfiguration {
    ...
    pub fn replace_admissionregistration_v1alpha1_initializer_configuration<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceAdmissionregistrationV1alpha1InitializerConfigurationResponse::Created(result)
            },
