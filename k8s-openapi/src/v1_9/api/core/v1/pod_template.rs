...
impl PodTemplate {
    ...
    pub fn list_pod_template_for_all_namespaces(
        ...
        let __url = "/api/v1/podtemplates?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
...
impl PodTemplate {
    ...
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`WatchNamespacedPodTemplateListResponse`]`>` constructor, or [`WatchNamespacedPodTemplateListResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `namespace`
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<WatchNamespacedPodTemplateListResponse>), crate::RequestError> {
...
/// Optional parameters of [`PodTemplate::watch_namespaced_pod_template_list`]
#[derive(Clone, Copy, Debug, Default)]
...
/// Use `<WatchNamespacedPodTemplateListResponse as Response>::try_from_parts` to parse the HTTP response body of [`PodTemplate::watch_namespaced_pod_template_list`]
#[derive(Debug)]
...
impl PodTemplate {
    ...
    pub fn watch_pod_template_for_all_namespaces(
        field_selector: &str,
        optional: WatchPodTemplateForAllNamespacesOptional<'_>,
        ...
        let WatchPodTemplateForAllNamespacesOptional {
            continue_,
            include_uninitialized,
            label_selector,
            limit,
...
#[derive(Clone, Copy, Debug, Default)]
pub struct WatchPodTemplateForAllNamespacesOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server the server will respond with a 410 ResourceExpired error indicating the client must restart their list without the continue field. This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
// Generated from operation watchCoreV1PodTemplateForAllNamespacesList
...
impl PodTemplate {
    ...
    /// This operation only supports watching a list of items for changes.
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`WatchPodTemplateForAllNamespacesListResponse`]`>` constructor, or [`WatchPodTemplateForAllNamespacesListResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `optional`
    ///
    ///     Optional parameters. Use `Default::default()` to not pass any.
    pub fn watch_pod_template_for_all_namespaces_list(
        optional: WatchPodTemplateForAllNamespacesListOptional<'_>,
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<WatchPodTemplateForAllNamespacesListResponse>), crate::RequestError> {
        let WatchPodTemplateForAllNamespacesListOptional {
            continue_,
            include_uninitialized,
            label_selector,
            limit,
...
/// Optional parameters of [`PodTemplate::watch_pod_template_for_all_namespaces_list`]
#[derive(Clone, Copy, Debug, Default)]
pub struct WatchPodTemplateForAllNamespacesListOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server the server will respond with a 410 ResourceExpired error indicating the client must restart their list without the continue field. This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
    /// If true, partially initialized resources are included in the response.
    pub include_uninitialized: Option<bool>,
...
/// Use `<WatchPodTemplateForAllNamespacesListResponse as Response>::try_from_parts` to parse the HTTP response body of [`PodTemplate::watch_pod_template_for_all_namespaces_list`]
#[derive(Debug)]
pub enum WatchPodTemplateForAllNamespacesListResponse {
    Ok(crate::v1_9::apimachinery::pkg::apis::meta::v1::WatchEvent),
    Unauthorized,
    Other,
}

impl crate::Response for WatchPodTemplateForAllNamespacesListResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
                ...
                Ok((WatchPodTemplateForAllNamespacesListResponse::Ok(result), byte_offset))
            },
            http::StatusCode::UNAUTHORIZED => Ok((WatchPodTemplateForAllNamespacesListResponse::Unauthorized, 0)),
            _ => Ok((WatchPodTemplateForAllNamespacesListResponse::Other, 0)),
        }
    }
}
...
impl PodTemplate {
    ...
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`WatchPodTemplateListForAllNamespacesResponse`]`>` constructor, or [`WatchPodTemplateListForAllNamespacesResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `optional`
    ...
    pub fn watch_pod_template_list_for_all_namespaces(
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<WatchPodTemplateListForAllNamespacesResponse>), crate::RequestError> {
        ...
        let __url = "/api/v1/watch/podtemplates?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
...
/// Optional parameters of [`PodTemplate::watch_pod_template_list_for_all_namespaces`]
#[derive(Clone, Copy, Debug, Default)]
...
/// Use `<WatchPodTemplateListForAllNamespacesResponse as Response>::try_from_parts` to parse the HTTP response body of [`PodTemplate::watch_pod_template_list_for_all_namespaces`]
#[derive(Debug)]
