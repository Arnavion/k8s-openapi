...
pub struct NodeSpec {
    ...
    pub config_source: Option<::v1_9::api::core::v1::NodeConfigSource>,
    ...
    pub taints: Option<Vec<::v1_9::api::core::v1::Taint>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_config_source: Option<::v1_9::api::core::v1::NodeConfigSource> = None;
                ...
                let mut value_taints: Option<Vec<::v1_9::api::core::v1::Taint>> = None;
