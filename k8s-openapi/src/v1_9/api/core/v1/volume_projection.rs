...
pub struct VolumeProjection {
    ...
    pub config_map: Option<crate::v1_9::api::core::v1::ConfigMapProjection>,

    /// information about the downwardAPI data to project
    pub downward_api: Option<crate::v1_9::api::core::v1::DownwardAPIProjection>,

    /// information about the secret data to project
    pub secret: Option<crate::v1_9::api::core::v1::SecretProjection>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_config_map: Option<crate::v1_9::api::core::v1::ConfigMapProjection> = None;
                let mut value_downward_api: Option<crate::v1_9::api::core::v1::DownwardAPIProjection> = None;
                let mut value_secret: Option<crate::v1_9::api::core::v1::SecretProjection> = None;
