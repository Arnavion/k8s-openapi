...
pub struct Affinity {
    ...
    pub node_affinity: Option<::v1_9::api::core::v1::NodeAffinity>,

    /// Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s)).
    pub pod_affinity: Option<::v1_9::api::core::v1::PodAffinity>,

    /// Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s)).
    pub pod_anti_affinity: Option<::v1_9::api::core::v1::PodAntiAffinity>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_node_affinity: Option<::v1_9::api::core::v1::NodeAffinity> = None;
                let mut value_pod_affinity: Option<::v1_9::api::core::v1::PodAffinity> = None;
                let mut value_pod_anti_affinity: Option<::v1_9::api::core::v1::PodAntiAffinity> = None;
