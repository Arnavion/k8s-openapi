    ...
    pub fn create_core_v1_namespaced_persistent_volume_claim<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateCoreV1NamespacedPersistentVolumeClaimResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateCoreV1NamespacedPersistentVolumeClaimResponse::Accepted(result)
            },
...
impl PersistentVolumeClaim {
    ...
    pub fn replace_core_v1_namespaced_persistent_volume_claim<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceCoreV1NamespacedPersistentVolumeClaimResponse::Created(result)
            },
...
impl PersistentVolumeClaim {
    ...
    pub fn replace_core_v1_namespaced_persistent_volume_claim_status<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceCoreV1NamespacedPersistentVolumeClaimStatusResponse::Created(result)
            },
