...
pub struct ObjectMeta {
    ...
    pub creation_timestamp: Option<::v1_9::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    pub deletion_timestamp: Option<::v1_9::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    pub initializers: Option<::v1_9::apimachinery::pkg::apis::meta::v1::Initializers>,
    ...
    pub owner_references: Option<Vec<::v1_9::apimachinery::pkg::apis::meta::v1::OwnerReference>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_creation_timestamp: Option<::v1_9::apimachinery::pkg::apis::meta::v1::Time> = None;
                let mut value_deletion_grace_period_seconds: Option<i64> = None;
                let mut value_deletion_timestamp: Option<::v1_9::apimachinery::pkg::apis::meta::v1::Time> = None;
                ...
                let mut value_initializers: Option<::v1_9::apimachinery::pkg::apis::meta::v1::Initializers> = None;
                let mut value_labels: Option<::std::collections::BTreeMap<String, String>> = None;
                let mut value_name: Option<String> = None;
                let mut value_namespace: Option<String> = None;
                let mut value_owner_references: Option<Vec<::v1_9::apimachinery::pkg::apis::meta::v1::OwnerReference>> = None;
