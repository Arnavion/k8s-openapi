...
pub struct APIGroup {
    ...
    pub server_address_by_client_cid_rs: Vec<::v1_9::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_server_address_by_client_cid_rs: Option<Vec<::v1_9::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR>> = None;
