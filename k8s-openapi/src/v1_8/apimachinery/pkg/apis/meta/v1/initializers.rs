...
pub struct Initializers {
    ...
    pub pending: Vec<crate::v1_8::apimachinery::pkg::apis::meta::v1::Initializer>,

    /// If result is set with the Failure field, the object will be persisted to storage and then deleted, ensuring that other clients can observe the deletion.
    pub result: Option<crate::v1_8::apimachinery::pkg::apis::meta::v1::Status>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_pending: Option<Vec<crate::v1_8::apimachinery::pkg::apis::meta::v1::Initializer>> = None;
                let mut value_result: Option<crate::v1_8::apimachinery::pkg::apis::meta::v1::Status> = None;
