...
pub struct VolumeProjection {
    ...
    pub downward_api: Option<::v1_8::api::core::v1::DownwardAPIProjection>,

    /// information about the secret data to project
    pub secret: Option<::v1_8::api::core::v1::SecretProjection>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_config_map: Option<::v1_8::api::core::v1::ConfigMapProjection> = None;
                let mut value_downward_api: Option<::v1_8::api::core::v1::DownwardAPIProjection> = None;
                let mut value_secret: Option<::v1_8::api::core::v1::SecretProjection> = None;
