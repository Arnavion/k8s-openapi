...
pub struct NetworkPolicyIngressRule {
    ...
    pub from: Option<Vec<crate::v1_8::api::extensions::v1beta1::NetworkPolicyPeer>>,

    /// List of ports which should be made accessible on the pods selected for this rule. Each item in this list is combined using a logical OR. If this field is empty or missing, this rule matches all ports (traffic not restricted by port). If this field is present and contains at least one item, then this rule allows traffic only if the traffic matches at least one port in the list.
    pub ports: Option<Vec<crate::v1_8::api::extensions::v1beta1::NetworkPolicyPort>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_from: Option<Vec<crate::v1_8::api::extensions::v1beta1::NetworkPolicyPeer>> = None;
                let mut value_ports: Option<Vec<crate::v1_8::api::extensions::v1beta1::NetworkPolicyPort>> = None;
