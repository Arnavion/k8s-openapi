...
pub struct APIServiceStatus {
    ...
    pub conditions: Option<Vec<::v1_8::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceCondition>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_conditions: Option<Vec<::v1_8::kube_aggregator::pkg::apis::apiregistration::v1beta1::APIServiceCondition>> = None;
