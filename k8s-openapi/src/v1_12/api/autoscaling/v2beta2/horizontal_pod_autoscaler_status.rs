...
pub struct HorizontalPodAutoscalerStatus {
    ...
    pub conditions: Vec<crate::v1_12::api::autoscaling::v2beta2::HorizontalPodAutoscalerCondition>,

    /// currentMetrics is the last read state of the metrics used by this autoscaler.
    pub current_metrics: Option<Vec<crate::v1_12::api::autoscaling::v2beta2::MetricStatus>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_conditions: Option<Vec<crate::v1_12::api::autoscaling::v2beta2::HorizontalPodAutoscalerCondition>> = None;
                let mut value_current_metrics: Option<Vec<crate::v1_12::api::autoscaling::v2beta2::MetricStatus>> = None;
