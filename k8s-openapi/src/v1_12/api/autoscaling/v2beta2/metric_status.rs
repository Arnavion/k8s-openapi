...
pub struct MetricStatus {
    ...
    pub external: Option<crate::v1_12::api::autoscaling::v2beta2::ExternalMetricStatus>,

    /// object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).
    pub object: Option<crate::v1_12::api::autoscaling::v2beta2::ObjectMetricStatus>,

    /// pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.
    pub pods: Option<crate::v1_12::api::autoscaling::v2beta2::PodsMetricStatus>,

    /// resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source.
    pub resource: Option<crate::v1_12::api::autoscaling::v2beta2::ResourceMetricStatus>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_external: Option<crate::v1_12::api::autoscaling::v2beta2::ExternalMetricStatus> = None;
                let mut value_object: Option<crate::v1_12::api::autoscaling::v2beta2::ObjectMetricStatus> = None;
                let mut value_pods: Option<crate::v1_12::api::autoscaling::v2beta2::PodsMetricStatus> = None;
                let mut value_resource: Option<crate::v1_12::api::autoscaling::v2beta2::ResourceMetricStatus> = None;
