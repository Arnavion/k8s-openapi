...
pub struct HorizontalPodAutoscalerStatus {
    ...
    pub conditions: Vec<crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerCondition>,

    /// currentMetrics is the last read state of the metrics used by this autoscaler.
    pub current_metrics: Option<Vec<crate::v1_12::api::autoscaling::v2beta1::MetricStatus>>,
    ...
    pub last_scale_time: Option<crate::v1_12::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_conditions: Option<Vec<crate::v1_12::api::autoscaling::v2beta1::HorizontalPodAutoscalerCondition>> = None;
                let mut value_current_metrics: Option<Vec<crate::v1_12::api::autoscaling::v2beta1::MetricStatus>> = None;
                let mut value_current_replicas: Option<i32> = None;
                let mut value_desired_replicas: Option<i32> = None;
                let mut value_last_scale_time: Option<crate::v1_12::apimachinery::pkg::apis::meta::v1::Time> = None;
