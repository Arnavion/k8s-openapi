...
impl ReplicaSet {
    ...
    pub fn create_apps_v1_namespaced_replica_set(
        ...
        optional: CreateAppsV1NamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let CreateAppsV1NamespacedReplicaSetOptional {
            dry_run,
...
/// Optional parameters of [`ReplicaSet::create_apps_v1_namespaced_replica_set`](./struct.ReplicaSet.html#method.create_apps_v1_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct CreateAppsV1NamespacedReplicaSetOptional<'a> {
...
impl ReplicaSet {
    ...
    pub fn delete_apps_v1_collection_namespaced_replica_set(
        namespace: &str,
        optional: DeleteAppsV1CollectionNamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteAppsV1CollectionNamespacedReplicaSetOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`ReplicaSet::delete_apps_v1_collection_namespaced_replica_set`](./struct.ReplicaSet.html#method.delete_apps_v1_collection_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct DeleteAppsV1CollectionNamespacedReplicaSetOptional<'a> {
...
impl ReplicaSet {
    ...
    pub fn delete_apps_v1_namespaced_replica_set(
        name: &str,
        namespace: &str,
        optional: DeleteAppsV1NamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteAppsV1NamespacedReplicaSetOptional {
            dry_run,
...
/// Optional parameters of [`ReplicaSet::delete_apps_v1_namespaced_replica_set`](./struct.ReplicaSet.html#method.delete_apps_v1_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct DeleteAppsV1NamespacedReplicaSetOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn list_apps_v1_namespaced_replica_set(
        namespace: &str,
        optional: ListAppsV1NamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListAppsV1NamespacedReplicaSetOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`ReplicaSet::list_apps_v1_namespaced_replica_set`](./struct.ReplicaSet.html#method.list_apps_v1_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct ListAppsV1NamespacedReplicaSetOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn list_apps_v1_replica_set_for_all_namespaces(
        optional: ListAppsV1ReplicaSetForAllNamespacesOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListAppsV1ReplicaSetForAllNamespacesOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`ReplicaSet::list_apps_v1_replica_set_for_all_namespaces`](./struct.ReplicaSet.html#method.list_apps_v1_replica_set_for_all_namespaces)
#[derive(Debug, Default)]
pub struct ListAppsV1ReplicaSetForAllNamespacesOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn patch_apps_v1_namespaced_replica_set(
        ...
        optional: PatchAppsV1NamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchAppsV1NamespacedReplicaSetOptional {
            dry_run,
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1/namespaces/{namespace}/replicasets/{name}?", name = name, namespace = namespace);
...
/// Optional parameters of [`ReplicaSet::patch_apps_v1_namespaced_replica_set`](./struct.ReplicaSet.html#method.patch_apps_v1_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct PatchAppsV1NamespacedReplicaSetOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn patch_apps_v1_namespaced_replica_set_status(
        ...
        namespace: &str,
        body: &crate::v1_12::apimachinery::pkg::apis::meta::v1::Patch,
        optional: PatchAppsV1NamespacedReplicaSetStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchAppsV1NamespacedReplicaSetStatusOptional {
            dry_run,
            pretty,
        } = optional;
...
/// Optional parameters of [`ReplicaSet::patch_apps_v1_namespaced_replica_set_status`](./struct.ReplicaSet.html#method.patch_apps_v1_namespaced_replica_set_status)
#[derive(Debug, Default)]
pub struct PatchAppsV1NamespacedReplicaSetStatusOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn read_apps_v1_namespaced_replica_set(
        name: &str,
        namespace: &str,
        optional: ReadAppsV1NamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadAppsV1NamespacedReplicaSetOptional {
            exact,
            export,
            pretty,
        } = optional;
...
/// Optional parameters of [`ReplicaSet::read_apps_v1_namespaced_replica_set`](./struct.ReplicaSet.html#method.read_apps_v1_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct ReadAppsV1NamespacedReplicaSetOptional<'a> {
...
impl ReplicaSet {
    ...
    pub fn read_apps_v1_namespaced_replica_set_status(
        name: &str,
        namespace: &str,
        optional: ReadAppsV1NamespacedReplicaSetStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadAppsV1NamespacedReplicaSetStatusOptional {
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1/namespaces/{namespace}/replicasets/{name}/status?", name = name, namespace = namespace);
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
...
/// Optional parameters of [`ReplicaSet::read_apps_v1_namespaced_replica_set_status`](./struct.ReplicaSet.html#method.read_apps_v1_namespaced_replica_set_status)
#[derive(Debug, Default)]
pub struct ReadAppsV1NamespacedReplicaSetStatusOptional<'a> {
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
}
...
impl ReplicaSet {
    ...
    pub fn replace_apps_v1_namespaced_replica_set(
        ...
        namespace: &str,
        body: &crate::v1_12::api::apps::v1::ReplicaSet,
        optional: ReplaceAppsV1NamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceAppsV1NamespacedReplicaSetOptional {
            dry_run,
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1/namespaces/{namespace}/replicasets/{name}?", name = name, namespace = namespace);
...
/// Optional parameters of [`ReplicaSet::replace_apps_v1_namespaced_replica_set`](./struct.ReplicaSet.html#method.replace_apps_v1_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct ReplaceAppsV1NamespacedReplicaSetOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn replace_apps_v1_namespaced_replica_set_status(
        ...
        namespace: &str,
        body: &crate::v1_12::api::apps::v1::ReplicaSet,
        optional: ReplaceAppsV1NamespacedReplicaSetStatusOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceAppsV1NamespacedReplicaSetStatusOptional {
            dry_run,
            pretty,
        } = optional;
        let __url = format!("/apis/apps/v1/namespaces/{namespace}/replicasets/{name}/status?", name = name, namespace = namespace);
...
/// Optional parameters of [`ReplicaSet::replace_apps_v1_namespaced_replica_set_status`](./struct.ReplicaSet.html#method.replace_apps_v1_namespaced_replica_set_status)
#[derive(Debug, Default)]
pub struct ReplaceAppsV1NamespacedReplicaSetStatusOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn watch_apps_v1_namespaced_replica_set(
        name: &str,
        namespace: &str,
        optional: WatchAppsV1NamespacedReplicaSetOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAppsV1NamespacedReplicaSetOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`ReplicaSet::watch_apps_v1_namespaced_replica_set`](./struct.ReplicaSet.html#method.watch_apps_v1_namespaced_replica_set)
#[derive(Debug, Default)]
pub struct WatchAppsV1NamespacedReplicaSetOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn watch_apps_v1_namespaced_replica_set_list(
        namespace: &str,
        optional: WatchAppsV1NamespacedReplicaSetListOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAppsV1NamespacedReplicaSetListOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`ReplicaSet::watch_apps_v1_namespaced_replica_set_list`](./struct.ReplicaSet.html#method.watch_apps_v1_namespaced_replica_set_list)
#[derive(Debug, Default)]
pub struct WatchAppsV1NamespacedReplicaSetListOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl ReplicaSet {
    ...
    pub fn watch_apps_v1_replica_set_list_for_all_namespaces(
        optional: WatchAppsV1ReplicaSetListForAllNamespacesOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchAppsV1ReplicaSetListForAllNamespacesOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`ReplicaSet::watch_apps_v1_replica_set_list_for_all_namespaces`](./struct.ReplicaSet.html#method.watch_apps_v1_replica_set_list_for_all_namespaces)
#[derive(Debug, Default)]
pub struct WatchAppsV1ReplicaSetListForAllNamespacesOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
