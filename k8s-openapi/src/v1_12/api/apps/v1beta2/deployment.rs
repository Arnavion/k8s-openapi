...
impl Deployment {
    ...
    pub fn list_deployment_for_all_namespaces(
        ...
        let __url = "/apis/apps/v1beta2/deployments?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
...
// Generated from operation watchAppsV1beta2DeploymentForAllNamespacesList
...
impl Deployment {
    ...
    pub fn watch_deployment_list_for_all_namespaces(
        ...
        let __url = "/apis/apps/v1beta2/watch/deployments?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
