...
impl PriorityClass {
    ...
    pub fn create_scheduling_v1beta1_priority_class(
        ...
        optional: CreateSchedulingV1beta1PriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let CreateSchedulingV1beta1PriorityClassOptional {
            dry_run,
...
/// Optional parameters of [`PriorityClass::create_scheduling_v1beta1_priority_class`](./struct.PriorityClass.html#method.create_scheduling_v1beta1_priority_class)
#[derive(Debug, Default)]
pub struct CreateSchedulingV1beta1PriorityClassOptional<'a> {
...
impl crate::Response for CreateSchedulingV1beta1PriorityClassResponse {
...
impl PriorityClass {
    ...
    pub fn delete_scheduling_v1beta1_collection_priority_class(
        optional: DeleteSchedulingV1beta1CollectionPriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteSchedulingV1beta1CollectionPriorityClassOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`PriorityClass::delete_scheduling_v1beta1_collection_priority_class`](./struct.PriorityClass.html#method.delete_scheduling_v1beta1_collection_priority_class)
#[derive(Debug, Default)]
pub struct DeleteSchedulingV1beta1CollectionPriorityClassOptional<'a> {
...
impl crate::Response for DeleteSchedulingV1beta1CollectionPriorityClassResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl PriorityClass {
    ...
    pub fn delete_scheduling_v1beta1_priority_class(
        name: &str,
        optional: DeleteSchedulingV1beta1PriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let DeleteSchedulingV1beta1PriorityClassOptional {
            dry_run,
...
/// Optional parameters of [`PriorityClass::delete_scheduling_v1beta1_priority_class`](./struct.PriorityClass.html#method.delete_scheduling_v1beta1_priority_class)
#[derive(Debug, Default)]
pub struct DeleteSchedulingV1beta1PriorityClassOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
...
impl crate::Response for DeleteSchedulingV1beta1PriorityClassResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result: serde_json::Map<String, serde_json::Value> = match serde_json::from_slice(buf) {
...
impl PriorityClass {
    ...
    pub fn list_scheduling_v1beta1_priority_class(
        optional: ListSchedulingV1beta1PriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ListSchedulingV1beta1PriorityClassOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`PriorityClass::list_scheduling_v1beta1_priority_class`](./struct.PriorityClass.html#method.list_scheduling_v1beta1_priority_class)
#[derive(Debug, Default)]
pub struct ListSchedulingV1beta1PriorityClassOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl crate::Response for ListSchedulingV1beta1PriorityClassResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl PriorityClass {
    ...
    pub fn patch_scheduling_v1beta1_priority_class(
        ...
        optional: PatchSchedulingV1beta1PriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let PatchSchedulingV1beta1PriorityClassOptional {
            dry_run,
            pretty,
        } = optional;
        let __url = format!("/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}?", name = name);
...
/// Optional parameters of [`PriorityClass::patch_scheduling_v1beta1_priority_class`](./struct.PriorityClass.html#method.patch_scheduling_v1beta1_priority_class)
#[derive(Debug, Default)]
pub struct PatchSchedulingV1beta1PriorityClassOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl crate::Response for PatchSchedulingV1beta1PriorityClassResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl PriorityClass {
    ...
    pub fn read_scheduling_v1beta1_priority_class(
        name: &str,
        optional: ReadSchedulingV1beta1PriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReadSchedulingV1beta1PriorityClassOptional {
            exact,
            export,
            pretty,
        } = optional;
...
/// Optional parameters of [`PriorityClass::read_scheduling_v1beta1_priority_class`](./struct.PriorityClass.html#method.read_scheduling_v1beta1_priority_class)
#[derive(Debug, Default)]
pub struct ReadSchedulingV1beta1PriorityClassOptional<'a> {
...
impl crate::Response for ReadSchedulingV1beta1PriorityClassResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl PriorityClass {
    ...
    pub fn replace_scheduling_v1beta1_priority_class(
        name: &str,
        body: &crate::v1_12::api::scheduling::v1beta1::PriorityClass,
        optional: ReplaceSchedulingV1beta1PriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let ReplaceSchedulingV1beta1PriorityClassOptional {
            dry_run,
            pretty,
        } = optional;
        let __url = format!("/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}?", name = name);
...
/// Optional parameters of [`PriorityClass::replace_scheduling_v1beta1_priority_class`](./struct.PriorityClass.html#method.replace_scheduling_v1beta1_priority_class)
#[derive(Debug, Default)]
pub struct ReplaceSchedulingV1beta1PriorityClassOptional<'a> {
    /// When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    pub dry_run: Option<&'a str>,
    /// If 'true', then the output is pretty printed.
    pub pretty: Option<&'a str>,
...
impl crate::Response for ReplaceSchedulingV1beta1PriorityClassResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let result = match serde_json::from_slice(buf) {
...
impl PriorityClass {
    ...
    pub fn watch_scheduling_v1beta1_priority_class(
        name: &str,
        optional: WatchSchedulingV1beta1PriorityClassOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchSchedulingV1beta1PriorityClassOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`PriorityClass::watch_scheduling_v1beta1_priority_class`](./struct.PriorityClass.html#method.watch_scheduling_v1beta1_priority_class)
#[derive(Debug, Default)]
pub struct WatchSchedulingV1beta1PriorityClassOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl crate::Response for WatchSchedulingV1beta1PriorityClassResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
...
impl PriorityClass {
    ...
    pub fn watch_scheduling_v1beta1_priority_class_list(
        optional: WatchSchedulingV1beta1PriorityClassListOptional<'_>,
    ) -> Result<http::Request<Vec<u8>>, crate::RequestError> {
        let WatchSchedulingV1beta1PriorityClassListOptional {
            continue_,
            field_selector,
            include_uninitialized,
            label_selector,
...
/// Optional parameters of [`PriorityClass::watch_scheduling_v1beta1_priority_class_list`](./struct.PriorityClass.html#method.watch_scheduling_v1beta1_priority_class_list)
#[derive(Debug, Default)]
pub struct WatchSchedulingV1beta1PriorityClassListOptional<'a> {
    /// The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
    ///
    /// This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    pub continue_: Option<&'a str>,
...
impl crate::Response for WatchSchedulingV1beta1PriorityClassListResponse {
    fn try_from_parts(status_code: http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            http::StatusCode::OK => {
                let mut deserializer = serde_json::Deserializer::from_slice(buf).into_iter();
