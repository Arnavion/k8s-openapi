...
pub struct EnvVarSource {
    ...
    pub config_map_key_ref: Option<crate::v1_12::api::core::v1::ConfigMapKeySelector>,
    ...
    pub secret_key_ref: Option<crate::v1_12::api::core::v1::SecretKeySelector>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_config_map_key_ref: Option<crate::v1_12::api::core::v1::ConfigMapKeySelector> = None;
                ...
                let mut value_secret_key_ref: Option<crate::v1_12::api::core::v1::SecretKeySelector> = None;
