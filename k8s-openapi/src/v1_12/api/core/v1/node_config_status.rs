...
pub struct NodeConfigStatus {
    ...
    pub active: Option<crate::v1_12::api::core::v1::NodeConfigSource>,

    /// Assigned reports the checkpointed config the node will try to use. When Node.Spec.ConfigSource is updated, the node checkpoints the associated config payload to local disk, along with a record indicating intended config. The node refers to this record to choose its config checkpoint, and reports this record in Assigned. Assigned only updates in the status after the record has been checkpointed to disk. When the Kubelet is restarted, it tries to make the Assigned config the Active config by loading and validating the checkpointed payload identified by Assigned.
    pub assigned: Option<crate::v1_12::api::core::v1::NodeConfigSource>,
    ...
    pub last_known_good: Option<crate::v1_12::api::core::v1::NodeConfigSource>,
}
...
impl<'de> serde::Deserialize<'de> for NodeConfigStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: serde::Deserializer<'de> {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                write!(f, "struct NodeConfigStatus")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                let mut value_active: Option<crate::v1_12::api::core::v1::NodeConfigSource> = None;
                let mut value_assigned: Option<crate::v1_12::api::core::v1::NodeConfigSource> = None;
                let mut value_error: Option<String> = None;
                let mut value_last_known_good: Option<crate::v1_12::api::core::v1::NodeConfigSource> = None;
