    ...
    pub fn create_rbac_authorization_v1alpha1_namespaced_role_binding<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateRbacAuthorizationV1alpha1NamespacedRoleBindingResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateRbacAuthorizationV1alpha1NamespacedRoleBindingResponse::Accepted(result)
            },
...
impl RoleBinding {
    ...
    pub fn replace_rbac_authorization_v1alpha1_namespaced_role_binding<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceRbacAuthorizationV1alpha1NamespacedRoleBindingResponse::Created(result)
            },
