    ...
    pub fn create_extensions_v1beta1_namespaced_replica_set<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1NamespacedReplicaSetResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1NamespacedReplicaSetResponse::Accepted(result)
            },
...
impl ReplicaSet {
    ...
    pub fn replace_extensions_v1beta1_namespaced_replica_set<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceExtensionsV1beta1NamespacedReplicaSetResponse::Created(result)
            },
...
impl ReplicaSet {
    ...
    pub fn replace_extensions_v1beta1_namespaced_replica_set_status<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceExtensionsV1beta1NamespacedReplicaSetStatusResponse::Created(result)
            },
