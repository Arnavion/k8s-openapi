...
pub struct NetworkPolicyEgressRule {
    ...
    pub ports: Option<Vec<::v1_10::api::extensions::v1beta1::NetworkPolicyPort>>,

    /// List of destinations for outgoing traffic of pods selected for this rule. Items in this list are combined using a logical OR operation. If this field is empty or missing, this rule matches all destinations (traffic not restricted by destination). If this field is present and contains at least one item, this rule allows traffic only if the traffic matches at least one item in the to list.
    pub to: Option<Vec<::v1_10::api::extensions::v1beta1::NetworkPolicyPeer>>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_ports: Option<Vec<::v1_10::api::extensions::v1beta1::NetworkPolicyPort>> = None;
                let mut value_to: Option<Vec<::v1_10::api::extensions::v1beta1::NetworkPolicyPeer>> = None;
