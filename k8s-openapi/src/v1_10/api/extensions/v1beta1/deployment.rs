    ...
    pub fn create_extensions_v1beta1_namespaced_deployment<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1NamespacedDeploymentResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateExtensionsV1beta1NamespacedDeploymentResponse::Accepted(result)
            },
...
impl Deployment {
    ...
    pub fn replace_extensions_v1beta1_namespaced_deployment<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceExtensionsV1beta1NamespacedDeploymentResponse::Created(result)
            },
...
impl Deployment {
    ...
    pub fn replace_extensions_v1beta1_namespaced_deployment_status<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceExtensionsV1beta1NamespacedDeploymentStatusResponse::Created(result)
            },
