...
impl StatefulSet {
    ...
    pub fn list_stateful_set_for_all_namespaces(
        ...
        let __url = "/apis/apps/v1/statefulsets?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
...
// Generated from operation watchAppsV1StatefulSetForAllNamespacesList
...
impl StatefulSet {
    ...
    pub fn watch_stateful_set_list_for_all_namespaces(
        ...
        let __url = "/apis/apps/v1/watch/statefulsets?".to_string();
        let mut __query_pairs = url::form_urlencoded::Serializer::new(__url);
        if let Some(continue_) = continue_ {
            __query_pairs.append_pair("continue", continue_);
        }
