...
pub enum CreateAppsV1beta1NamespacedDeploymentRollbackResponse<R> where R: ::std::io::Read {
    Ok(::v1_10::api::apps::v1beta1::DeploymentRollback),
    Created(::v1_10::api::apps::v1beta1::DeploymentRollback),
    Accepted(::v1_10::api::apps::v1beta1::DeploymentRollback),
    Unauthorized(R),
    ...
    pub fn create_apps_v1beta1_namespaced_deployment_rollback<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAppsV1beta1NamespacedDeploymentRollbackResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAppsV1beta1NamespacedDeploymentRollbackResponse::Accepted(result)
            },
