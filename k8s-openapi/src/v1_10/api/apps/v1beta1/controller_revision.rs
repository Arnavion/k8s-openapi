    ...
    pub fn create_apps_v1beta1_namespaced_controller_revision<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAppsV1beta1NamespacedControllerRevisionResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateAppsV1beta1NamespacedControllerRevisionResponse::Accepted(result)
            },
...
impl ControllerRevision {
    ...
    pub fn replace_apps_v1beta1_namespaced_controller_revision<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceAppsV1beta1NamespacedControllerRevisionResponse::Created(result)
            },
