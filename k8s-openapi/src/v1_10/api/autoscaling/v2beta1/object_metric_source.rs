...
pub struct ObjectMetricSource {
    ...
    pub target: ::v1_10::api::autoscaling::v2beta1::CrossVersionObjectReference,

    /// targetValue is the target value of the metric (as a quantity).
    pub target_value: ::v1_10::apimachinery::pkg::api::resource::Quantity,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_target: Option<::v1_10::api::autoscaling::v2beta1::CrossVersionObjectReference> = None;
                let mut value_target_value: Option<::v1_10::apimachinery::pkg::api::resource::Quantity> = None;
