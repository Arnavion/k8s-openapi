    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_external: Option<::v1_10::api::autoscaling::v2beta1::ExternalMetricStatus> = None;
                let mut value_object: Option<::v1_10::api::autoscaling::v2beta1::ObjectMetricStatus> = None;
                let mut value_pods: Option<::v1_10::api::autoscaling::v2beta1::PodsMetricStatus> = None;
                let mut value_resource: Option<::v1_10::api::autoscaling::v2beta1::ResourceMetricStatus> = None;
