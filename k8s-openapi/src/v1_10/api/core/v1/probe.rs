...
pub struct Probe {
    ...
    pub http_get: Option<::v1_10::api::core::v1::HTTPGetAction>,
    ...
    pub tcp_socket: Option<::v1_10::api::core::v1::TCPSocketAction>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_exec: Option<::v1_10::api::core::v1::ExecAction> = None;
                let mut value_failure_threshold: Option<i32> = None;
                let mut value_http_get: Option<::v1_10::api::core::v1::HTTPGetAction> = None;
                ...
                let mut value_tcp_socket: Option<::v1_10::api::core::v1::TCPSocketAction> = None;
