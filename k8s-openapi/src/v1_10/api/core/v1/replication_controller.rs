    ...
    pub fn create_core_v1_namespaced_replication_controller<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateCoreV1NamespacedReplicationControllerResponse::Created(result)
            },
            ::http::StatusCode::ACCEPTED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                CreateCoreV1NamespacedReplicationControllerResponse::Accepted(result)
            },
...
impl ReplicationController {
    ...
    pub fn replace_core_v1_namespaced_replication_controller<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceCoreV1NamespacedReplicationControllerResponse::Created(result)
            },
...
impl ReplicationController {
    ...
    pub fn replace_core_v1_namespaced_replication_controller_status<C>(
        ...
        Ok(match ::Response::status_code(&response) {
            ...
            ::http::StatusCode::CREATED => {
                let result = ::serde_json::from_reader(response).map_err(::Error::JSON)?;
                ReplaceCoreV1NamespacedReplicationControllerStatusResponse::Created(result)
            },
