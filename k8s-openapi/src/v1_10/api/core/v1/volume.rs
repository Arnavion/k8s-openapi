...
pub struct Volume {
    ...
    pub azure_file: Option<::v1_10::api::core::v1::AzureFileVolumeSource>,

    /// CephFS represents a Ceph FS mount on the host that shares a pod's lifetime
    pub cephfs: Option<::v1_10::api::core::v1::CephFSVolumeSource>,

    /// Cinder represents a cinder volume attached and mounted on kubelets host machine More info: https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md
    pub cinder: Option<::v1_10::api::core::v1::CinderVolumeSource>,

    /// ConfigMap represents a configMap that should populate this volume
    pub config_map: Option<::v1_10::api::core::v1::ConfigMapVolumeSource>,

    /// DownwardAPI represents downward API about the pod that should populate this volume
    pub downward_api: Option<::v1_10::api::core::v1::DownwardAPIVolumeSource>,

    /// EmptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir
    pub empty_dir: Option<::v1_10::api::core::v1::EmptyDirVolumeSource>,

    /// FC represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.
    pub fc: Option<::v1_10::api::core::v1::FCVolumeSource>,

    /// FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin.
    pub flex_volume: Option<::v1_10::api::core::v1::FlexVolumeSource>,
    ...
    pub git_repo: Option<::v1_10::api::core::v1::GitRepoVolumeSource>,
    ...
    pub iscsi: Option<::v1_10::api::core::v1::ISCSIVolumeSource>,
    ...
    pub persistent_volume_claim: Option<::v1_10::api::core::v1::PersistentVolumeClaimVolumeSource>,
    ...
    pub projected: Option<::v1_10::api::core::v1::ProjectedVolumeSource>,

    /// Quobyte represents a Quobyte mount on the host that shares a pod's lifetime
    pub quobyte: Option<::v1_10::api::core::v1::QuobyteVolumeSource>,

    /// RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md
    pub rbd: Option<::v1_10::api::core::v1::RBDVolumeSource>,

    /// ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes.
    pub scale_io: Option<::v1_10::api::core::v1::ScaleIOVolumeSource>,

    /// Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
    pub secret: Option<::v1_10::api::core::v1::SecretVolumeSource>,

    /// StorageOS represents a StorageOS volume attached and mounted on Kubernetes nodes.
    pub storageos: Option<::v1_10::api::core::v1::StorageOSVolumeSource>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_azure_file: Option<::v1_10::api::core::v1::AzureFileVolumeSource> = None;
                let mut value_cephfs: Option<::v1_10::api::core::v1::CephFSVolumeSource> = None;
                let mut value_cinder: Option<::v1_10::api::core::v1::CinderVolumeSource> = None;
                let mut value_config_map: Option<::v1_10::api::core::v1::ConfigMapVolumeSource> = None;
                let mut value_downward_api: Option<::v1_10::api::core::v1::DownwardAPIVolumeSource> = None;
                let mut value_empty_dir: Option<::v1_10::api::core::v1::EmptyDirVolumeSource> = None;
                let mut value_fc: Option<::v1_10::api::core::v1::FCVolumeSource> = None;
                let mut value_flex_volume: Option<::v1_10::api::core::v1::FlexVolumeSource> = None;
                ...
                let mut value_git_repo: Option<::v1_10::api::core::v1::GitRepoVolumeSource> = None;
                ...
                let mut value_iscsi: Option<::v1_10::api::core::v1::ISCSIVolumeSource> = None;
                let mut value_name: Option<String> = None;
                let mut value_nfs: Option<::v1_10::api::core::v1::NFSVolumeSource> = None;
                let mut value_persistent_volume_claim: Option<::v1_10::api::core::v1::PersistentVolumeClaimVolumeSource> = None;
                ...
                let mut value_projected: Option<::v1_10::api::core::v1::ProjectedVolumeSource> = None;
                let mut value_quobyte: Option<::v1_10::api::core::v1::QuobyteVolumeSource> = None;
                let mut value_rbd: Option<::v1_10::api::core::v1::RBDVolumeSource> = None;
                let mut value_scale_io: Option<::v1_10::api::core::v1::ScaleIOVolumeSource> = None;
                let mut value_secret: Option<::v1_10::api::core::v1::SecretVolumeSource> = None;
                let mut value_storageos: Option<::v1_10::api::core::v1::StorageOSVolumeSource> = None;
