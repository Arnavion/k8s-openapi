...
pub struct EnvFromSource {
    ...
    pub secret_ref: Option<::v1_10::api::core::v1::SecretEnvSource>,
}
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                let mut value_config_map_ref: Option<::v1_10::api::core::v1::ConfigMapEnvSource> = None;
                let mut value_prefix: Option<String> = None;
                let mut value_secret_ref: Option<::v1_10::api::core::v1::SecretEnvSource> = None;
