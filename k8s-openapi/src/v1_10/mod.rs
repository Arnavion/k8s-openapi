...
#[derive(Debug)]
pub enum GetAdmissionregistrationV1beta1APIResourcesResponse<R> where R: ::std::io::Read {
    Ok(::v1_10::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
/// get available resources
pub fn get_admissionregistration_v1beta1_api_resources<C>(
    __client: &C,
) -> Result<GetAdmissionregistrationV1beta1APIResourcesResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
    let __url = __client.base_url().join(&format!("/apis/admissionregistration.k8s.io/v1beta1/")).map_err(::Error::URL)?;
    ...
    Ok(match ::Response::status_code(&response) {
        ...
        ::http::StatusCode::UNAUTHORIZED => GetAdmissionregistrationV1beta1APIResourcesResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum GetApiregistrationV1APIResourcesResponse<R> where R: ::std::io::Read {
    Ok(::v1_10::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
/// get available resources
pub fn get_apiregistration_v1_api_resources<C>(
    __client: &C,
) -> Result<GetApiregistrationV1APIResourcesResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
    let __url = __client.base_url().join(&format!("/apis/apiregistration.k8s.io/v1/")).map_err(::Error::URL)?;
    ...
    Ok(match ::Response::status_code(&response) {
        ...
        ::http::StatusCode::UNAUTHORIZED => GetApiregistrationV1APIResourcesResponse::Unauthorized(response),
        other => GetApiregistrationV1APIResourcesResponse::Other(other, response),
    })
}
...
#[derive(Debug)]
pub enum GetAppsV1APIResourcesResponse<R> where R: ::std::io::Read {
    Ok(::v1_10::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
/// get available resources
pub fn get_apps_v1_api_resources<C>(
    __client: &C,
) -> Result<GetAppsV1APIResourcesResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
    let __url = __client.base_url().join(&format!("/apis/apps/v1/")).map_err(::Error::URL)?;
    ...
    Ok(match ::Response::status_code(&response) {
        ...
        ::http::StatusCode::UNAUTHORIZED => GetAppsV1APIResourcesResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum GetEventsAPIGroupResponse<R> where R: ::std::io::Read {
    Ok(::v1_10::apimachinery::pkg::apis::meta::v1::APIGroup),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
/// get information of a group
pub fn get_events_api_group<C>(
    __client: &C,
) -> Result<GetEventsAPIGroupResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
    let __url = __client.base_url().join(&format!("/apis/events.k8s.io/")).map_err(::Error::URL)?;
    ...
    Ok(match ::Response::status_code(&response) {
        ...
        ::http::StatusCode::UNAUTHORIZED => GetEventsAPIGroupResponse::Unauthorized(response),
        other => GetEventsAPIGroupResponse::Other(other, response),
    })
}
...
#[derive(Debug)]
pub enum GetEventsV1beta1APIResourcesResponse<R> where R: ::std::io::Read {
    Ok(::v1_10::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
/// get available resources
pub fn get_events_v1beta1_api_resources<C>(
    __client: &C,
) -> Result<GetEventsV1beta1APIResourcesResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
    let __url = __client.base_url().join(&format!("/apis/events.k8s.io/v1beta1/")).map_err(::Error::URL)?;
    ...
    Ok(match ::Response::status_code(&response) {
        ...
        ::http::StatusCode::UNAUTHORIZED => GetEventsV1beta1APIResourcesResponse::Unauthorized(response),
...
#[derive(Debug)]
pub enum GetStorageV1alpha1APIResourcesResponse<R> where R: ::std::io::Read {
    Ok(::v1_10::apimachinery::pkg::apis::meta::v1::APIResourceList),
    Unauthorized(R),
    Other(::http::StatusCode, R),
}
...
/// get available resources
pub fn get_storage_v1alpha1_api_resources<C>(
    __client: &C,
) -> Result<GetStorageV1alpha1APIResourcesResponse<C::Response>, ::Error<C::Error>> where C: ::Client {
    let __url = __client.base_url().join(&format!("/apis/storage.k8s.io/v1alpha1/")).map_err(::Error::URL)?;
    ...
    Ok(match ::Response::status_code(&response) {
        ...
        ::http::StatusCode::UNAUTHORIZED => GetStorageV1alpha1APIResourcesResponse::Unauthorized(response),
        other => GetStorageV1alpha1APIResourcesResponse::Other(other, response),
    })
}
